...
import dev.slne.surf.api.paper.inventory.framework.view.settings.ViewRows.Companion.byRows
import dev.slne.surf.api.paper.inventory.framework.view.settings.ViewRows.Companion.byRowsOrNull
...
enum class ViewRows(val glyph: Char) {
    ...
    companion object {
         ...
         */
        fun byRows(@Rows rows: Int): ViewRows =
            byRowsOrNull(rows) ?: error("Invalid layout value: $rows")
    }
}
