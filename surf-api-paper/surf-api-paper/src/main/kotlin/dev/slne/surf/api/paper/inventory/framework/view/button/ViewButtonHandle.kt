 ...
 * [BukkitItemComponentBuilder.button] inside a render callback.
 *
 ...
 * ```
 *
 * @receiver the [BukkitItemComponentBuilder] of the slot the button should occupy
 * @param handle the button declared in the view's DSL block
 * @return this builder for chaining
 */
fun <T> BukkitItemComponentBuilder.button(handle: ViewButtonHandle<T>): BukkitItemComponentBuilder {
    cancelOnClick()
