 ...
 * [cancelOnClick][dev.slne.surf.api.paper.inventory.framework.view.settings.SurfViewSettings.cancelOnClick]
 * settings).
 *
 * Typically used via the DSL helpers
 * [blockCell][dev.slne.surf.api.paper.inventory.framework.view.container.dsl.blockCell],
 * [blockSlot][dev.slne.surf.api.paper.inventory.framework.view.container.dsl.blockSlot],
 * [blockRow][dev.slne.surf.api.paper.inventory.framework.view.container.dsl.blockRow] or
 * [blockAllSlots][dev.slne.surf.api.paper.inventory.framework.view.container.dsl.blockAllSlots].
 *
