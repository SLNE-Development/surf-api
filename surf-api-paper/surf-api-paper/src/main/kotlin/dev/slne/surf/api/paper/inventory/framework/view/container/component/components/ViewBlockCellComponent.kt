 ...
 *
 * Typically used via the DSL helper [dev.slne.surf.api.paper.api.inventory.framework.view.container.dsl.blockCell]
 * or [dev.slne.surf.api.paper.api.inventory.framework.view.container.dsl.blockRow].
 *
