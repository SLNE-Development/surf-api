package dev.slne.surf.api.paper.server.nms.v26_3.listener.packets
...
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.clientbound.V26_3ClientboundDisconnectPacketImpl
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.clientbound.V26_3ClientboundSystemChatPacketImpl
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.serverbound.V26_3CommandSuggestionPacketImpl
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.serverbound.V26_3RenameItemPacketImpl
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.serverbound.V26_3ServerboundCustomPayloadPacketImpl
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.serverbound.V26_3SignUpdatePacketImpl
...
object V26_3PacketRegistry {
    ...
    init {
        // @formatter:off
        // Serverbound packets
        registerServerboundPacket(ServerboundSignUpdatePacket::class) { V26_3SignUpdatePacketImpl(it) }
        registerServerboundPacket(ServerboundRenameItemPacket::class) { V26_3RenameItemPacketImpl(it) }
        registerServerboundPacket(ServerboundCommandSuggestionPacket::class) { V26_3CommandSuggestionPacketImpl(it) }
        registerServerboundPacket(ServerboundCustomPayloadPacket::class, V26_3ServerboundCustomPayloadPacketImpl::accepts) { V26_3ServerboundCustomPayloadPacketImpl(it) }

        // Clientbound packets
        registerClientboundPacket(ClientboundDisconnectPacket::class) { V26_3ClientboundDisconnectPacketImpl(it) }
        registerClientboundPacket(ClientboundSystemChatPacket::class) { V26_3ClientboundSystemChatPacketImpl(it) }
        // @formatter:on
    }
