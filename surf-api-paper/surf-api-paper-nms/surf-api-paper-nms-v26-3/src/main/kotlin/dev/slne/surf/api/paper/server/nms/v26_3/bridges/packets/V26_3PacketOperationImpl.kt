...
@Suppress("ClassName")
class V26_3PacketOperationImpl : PacketOperation {
    ...
    override fun add(operation: PacketOperation): V26_3PacketOperationImpl {
        require(operation is V26_3PacketOperationImpl) { "operation must be an instance of V26_3PacketOperationImpl" }
    ...
    companion object {
        ...
        @JvmStatic
        fun empty(): V26_3PacketOperationImpl {
            return V26_3PacketOperationImpl()
        }

        @JvmStatic
        fun complex(operation: Operation): V26_3PacketOperationImpl {
        ...
        fun task(task: (Player) -> Unit): V26_3PacketOperationImpl {
            return V26_3PacketOperationImpl { player, packets ->
                task(player)
                packets
            }
