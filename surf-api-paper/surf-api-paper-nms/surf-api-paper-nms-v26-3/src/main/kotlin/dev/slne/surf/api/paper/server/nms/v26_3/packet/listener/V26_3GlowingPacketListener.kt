package dev.slne.surf.api.paper.server.nms.v26_3.packet.listener
...
@Suppress("ClassName")
object V26_3GlowingPacketListener : PacketListener {
    ...
    private fun updatePacketIfNeeded(
        ...
        val playerData = V26_3SurfGlowingApiImpl.getEntityPlayerData(player) ?: return packet
        ...
        val dataFlagsShared = V26_3NmsReflections.getEntityDataFlagsSharedId()
        ...
        for (dataValue in incoming) {
            if (dataValue.id == dataFlagsSharedId) {
                ...
                val withGlow: Byte = current or V26_3SurfGlowingApiImpl.glowingFlag
        ...
        if (!edited && !flagsFound) {
            val withGlow = glowingData.otherFlags or V26_3SurfGlowingApiImpl.glowingFlag
