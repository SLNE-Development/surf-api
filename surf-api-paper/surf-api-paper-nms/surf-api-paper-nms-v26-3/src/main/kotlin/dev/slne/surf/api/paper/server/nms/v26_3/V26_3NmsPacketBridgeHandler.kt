...
import dev.slne.surf.api.paper.server.nms.v26_3.listener.packets.V26_3PacketRegistry
import net.minecraft.network.protocol.Packet

@NmsUseWithCaution
@Suppress("ClassName")
object V26_3NmsPacketBridgeHandler : NmsPacketBridgeHandler {

    @Suppress("UNCHECKED_CAST")
    override fun wrapServerboundPacket(nmsPacket: Any): NmsServerboundPacket? {
        return V26_3PacketRegistry.createServerboundPacketOrNull(nmsPacket as Packet<*>)
    }

    @Suppress("UNCHECKED_CAST")
    override fun wrapClientboundPacket(nmsPacket: Any): NmsClientboundPacket? {
        return V26_3PacketRegistry.createClientboundPacketOrNull(nmsPacket as Packet<*>)
    }

    override fun unwrapPacket(apiPacket: NmsPacket): Any {
        return V26_3NmsPacketImpl.getFromApi(apiPacket).nmsPacket
    }
}
