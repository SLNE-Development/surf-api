...
@NmsUseWithCaution
@Suppress("ClassName")
class V26_3SurfPaperNmsPlayerChatPacketsImpl : SurfPaperNmsPlayerChatPackets {
    override fun sendPlayerChatMessagePacket(
    ...
    ): PacketOperation = V26_3PacketOperationImpl.simple { player ->
        ...
        ClientboundPlayerChatPacket(
            ...
            senderUuid,
            index,
            Optional.ofNullable(messageSignature),
            signedBody,
            Optional.ofNullable(unsignedContent?.toNms()),
