...
@NmsUseWithCaution
@Suppress("ClassName")
class V26_3SurfPaperNmsPlayerToastPacketsImpl : SurfPaperNmsPlayerToastPackets {
    override fun showToast(toast: Toast) = V26_3PacketOperationImpl.complex { _, packets ->
    ...
    private fun showPacket(id: Identifier, toast: Toast) =
        ClientboundUpdateAdvancementsPacket(
            false, listOf(PositionedAdvancement(createAdvancement(id, toast), 0f, 0f)), emptySet(), mapOf(
