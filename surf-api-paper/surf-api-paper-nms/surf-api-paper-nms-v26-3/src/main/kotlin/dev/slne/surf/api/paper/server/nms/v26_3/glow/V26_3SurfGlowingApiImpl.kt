...
import dev.slne.surf.api.paper.server.nms.v26_3.glow.block.BlockGlowingData
import dev.slne.surf.api.paper.server.nms.v26_3.glow.block.BlockPlayerData
import dev.slne.surf.api.paper.server.nms.v26_3.glow.entity.EntityPlayerData
import dev.slne.surf.api.paper.server.nms.v26_3.glow.entity.V26_3EntityGlowingData
...
@NmsUseWithCaution
@Suppress("ClassName")
object V26_3SurfGlowingApiImpl : SurfGlowingApi {
    ...
    val glowingFlag = 1 shl V26_3NmsReflections.getEntityFlagGlowing()
    ...
    override fun makeGlowing(
        ...
        makeGlowing(
            ...
            viewer,
            color,
            V26_3SurfPaperNmsGlowingBridgeImpl.getCurrentFlags(target)
        )
    }
    ...
    override fun makeGlowing(
        ...
        if (glowingData == null) {
            val newData = V26_3EntityGlowingData(
                playerData,
                targetId,
                teamId,
                nmsColor,
    ...
    fun removeAllGlowingOnQuit(player: Player) {
        ...
        V26_3TeamData.removeFromAll(uuid)
