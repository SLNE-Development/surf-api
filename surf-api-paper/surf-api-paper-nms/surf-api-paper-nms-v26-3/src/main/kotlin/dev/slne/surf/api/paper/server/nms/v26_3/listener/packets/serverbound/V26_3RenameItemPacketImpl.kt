...
@NmsUseWithCaution
@Suppress("ClassName")
class V26_3RenameItemPacketImpl(nmsPacket: ServerboundRenameItemPacket) :
    V26_3NmsServerboundPacketImpl<ServerboundRenameItemPacket>(nmsPacket), RenameItemPacket {
