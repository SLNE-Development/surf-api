...
import dev.slne.surf.api.paper.server.nms.v26_3.extensions.AdventureNBT
import dev.slne.surf.api.paper.server.nms.v26_3.extensions.toNms
import dev.slne.surf.api.paper.server.nms.v26_3.extensions.toNmsHolder
...
@NmsUseWithCaution
@Suppress("ClassName")
class V26_3SurfPaperNmsEntityBridgeImpl : SurfPaperNmsEntityBridge {
    ...
    companion object {
        private val VEHICLE_LOGGER = ComponentLogger.logger("V26_3SurfPaperNmsEntityBridgeImpl Vehicle")
    }
}
