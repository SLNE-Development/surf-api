package dev.slne.surf.api.paper.server.nms.v26_3.glow.block
...
class BlockGlowingData(
    ...
    fun spawn(): PacketOperation {
        ...
        val spawnOperation = V26_3PacketOperationImpl.simple {
        ...
        val invisibleOperation = V26_3SurfPaperNmsGlowingBridgeImpl.setEntityFlags(entityId, invisibleFlag)
    ...
    fun updateColor() {
        ...
        V26_3SurfGlowingApiImpl.makeGlowing(
            entityId,
            uuid.toString(),
            player,
            color,
    ...
    fun remove() {
        ...
        V26_3SurfGlowingApiImpl.removeGlowing(entityId, playerData.uuid)
    }
    ...
    companion object {
        val invisibleFlag = 1.toByte() shl V26_3NmsReflections.getEntityFlagInvisible()
    }
}
