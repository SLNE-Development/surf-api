...
@NmsUseWithCaution
@Suppress("ClassName")
class V26_2ServerboundCustomPayloadPacketImpl(
    nmsPacket: ServerboundCustomPayloadPacket
) : V26_2NmsServerboundPacketImpl<ServerboundCustomPayloadPacket>(nmsPacket),
    ...
    companion object {
        fun accepts(nmsPacket: ServerboundCustomPayloadPacket): Boolean {
            return nmsPacket.payload is BrandPayload || nmsPacket.payload is DiscardedPayload
        }
