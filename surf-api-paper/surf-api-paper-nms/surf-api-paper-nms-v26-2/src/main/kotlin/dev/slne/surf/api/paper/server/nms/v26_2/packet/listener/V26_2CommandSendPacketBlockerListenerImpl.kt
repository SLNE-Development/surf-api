...
class V26_2CommandSendPacketBlockerListenerImpl(blockedPlayers: Set<UUID>) :
    ...
    private val commandNodeInspector =
        object : ClientboundCommandsPacket.NodeInspector<CommandSourceStack> {
