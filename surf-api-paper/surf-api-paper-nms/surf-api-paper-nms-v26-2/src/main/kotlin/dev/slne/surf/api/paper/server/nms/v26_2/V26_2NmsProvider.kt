...
class V26_2NmsProvider(override val plugin: JavaPlugin) : NmsProvider {
    ...
    override fun createNmsBridge() = V26_2SurfPaperNmsBridgeImpl()
    ...
    override fun createGlowingBridge(): SurfPaperNmsGlowingBridge = V26_2SurfPaperNmsGlowingBridgeImpl
    override fun createStatsBridge(): SurfPaperNmsStatsBridge = V26_2SurfPaperNmsStatsBridgeImpl()
    override fun createLootTableBridge(): SurfPaperNmsLootTableBridge = V26_2SurfPaperNmsLootTableBridgeImpl()
    ...
    override fun createPacketBridges(): SurfPaperNmsPacketBridges = V26_2SurfPaperNmsPacketBridgesImpl()

    override fun createBlockPackets(): SurfPaperNmsBlockPackets = V26_2SurfPaperNmsBlockPacketsImpl()
    override fun createSpawnPackets(): SurfPaperNmsSpawnPackets = V26_2SurfPaperNmsSpawnPacketsImpl()
    override fun createPlayerPackets(): SurfPaperNmsPlayerPackets = V26_2SurfPaperNmsPlayerPacketsImpl()
    override fun createPlayerChatPackets(): SurfPaperNmsPlayerChatPackets = V26_2SurfPaperNmsPlayerChatPacketsImpl()
    override fun createPlayerToastPackets(): SurfPaperNmsPlayerToastPackets = V26_2SurfPaperNmsPlayerToastPacketsImpl()

    override fun createTickThreadGuard(): TickThreadGuard = V26_2TickThreadGuard()
    override fun getLibLoaderBridge(): LibLoaderBridge = V26_2LibLoaderBridgeImpl
    override fun getPacketBridgeHandler(): NmsPacketBridgeHandler = V26_2NmsPacketBridgeHandler
    ...
    override fun createCommandSendPacketBlockerListener(blockedPlayers: Set<UUID>): CommandSendPacketBlockerListener {
        return V26_2CommandSendPacketBlockerListenerImpl(blockedPlayers)
    }
