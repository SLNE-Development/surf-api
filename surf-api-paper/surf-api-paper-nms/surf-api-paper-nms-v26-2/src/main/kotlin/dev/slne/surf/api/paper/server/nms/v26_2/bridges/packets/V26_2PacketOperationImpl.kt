...
@Suppress("ClassName")
class V26_2PacketOperationImpl : PacketOperation {
    ...
    companion object {
        ...
        @JvmStatic
        fun empty(): V26_2PacketOperationImpl {
            return V26_2PacketOperationImpl()
        }

        @JvmStatic
        fun complex(operation: Operation): V26_2PacketOperationImpl {
        ...
        fun task(task: (Player) -> Unit): V26_2PacketOperationImpl {
            return V26_2PacketOperationImpl { player, packets ->
                task(player)
                packets
            }
