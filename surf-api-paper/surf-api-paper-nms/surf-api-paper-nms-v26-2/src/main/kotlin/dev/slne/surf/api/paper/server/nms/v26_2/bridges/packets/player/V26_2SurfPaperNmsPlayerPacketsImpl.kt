...
package dev.slne.surf.api.paper.server.nms.v26_2.bridges.packets.player
...
@NmsUseWithCaution
@Suppress("ClassName")
class V26_2SurfPaperNmsPlayerPacketsImpl : SurfPaperNmsPlayerPackets {

    override fun openSignEditor(
        position: BlockPosition,
        frontSide: Boolean,
    ) = V26_2PacketOperationImpl.simple { ClientboundOpenSignEditorPacket(position.toNms(), frontSide) }
    ...
    override fun removePlayerInfoUpdate(profileIds: List<UUID>): PacketOperation = V26_2PacketOperationImpl.simple {
