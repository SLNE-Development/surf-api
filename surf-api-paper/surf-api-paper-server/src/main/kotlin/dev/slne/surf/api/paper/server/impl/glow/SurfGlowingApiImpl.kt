...
import dev.slne.surf.api.paper.server.impl.glow.block.BlockGlowingData
import dev.slne.surf.api.paper.server.impl.glow.block.BlockPlayerData
import dev.slne.surf.api.paper.server.impl.glow.entity.EntityGlowingData
import dev.slne.surf.api.paper.server.impl.glow.entity.EntityPlayerData
...
class SurfGlowingApiImpl : SurfGlowingApi {
    ...
    override fun makeGlowing(
        ...
        makeGlowing(
            ...
            viewer,
            color,
            SurfPaperNmsGlowingBridge.getCurrentFlags(target)
        )
    }
    ...
    companion object {
        val INSTANCE get() = SurfGlowingApi.INSTANCE as SurfGlowingApiImpl
