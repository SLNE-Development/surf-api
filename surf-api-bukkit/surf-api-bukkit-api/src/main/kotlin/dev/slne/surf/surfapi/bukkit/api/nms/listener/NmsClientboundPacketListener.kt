...
@NmsUseWithCaution
interface NmsClientboundPacketListener<Packet : NmsClientboundPacket> : NmsPacketListener<Packet> {
    @ApiStatus.OverrideOnly
    fun handleClientboundPacket(packet: Packet, player: Player): PacketListenerResult
}
