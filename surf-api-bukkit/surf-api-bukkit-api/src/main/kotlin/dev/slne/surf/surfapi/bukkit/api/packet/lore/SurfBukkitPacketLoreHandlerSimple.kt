 ...
 *
 * This interface extends [SurfBukkitPacketLoreHandler] and provides a streamlined version
 ...
 */
fun interface SurfBukkitPacketLoreHandlerSimple : SurfBukkitPacketLoreHandler {
     ...
     * Example Usage:
     * ```
     * val handler = SurfBukkitPacketLoreHandlerSimple { lore ->
