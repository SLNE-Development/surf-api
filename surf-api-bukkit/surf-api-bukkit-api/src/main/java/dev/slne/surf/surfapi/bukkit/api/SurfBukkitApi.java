...
public interface SurfBukkitApi extends SurfCoreApi {
  ...
  SurfBukkitHookManager getHookManager();
   ...
   *                      implement the {@link SkipOperations.SkipOperation} functional interface.
   * @return A map associating each affected world with the result of the time skip operation. The
   * result is represented by the {@link Result<TimeSkipResult>} class.
   * @see SkipOperations
   */
