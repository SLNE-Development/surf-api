...
public enum TimeSkipResult {
    ...
    FAILED(false),
    /**
     * Represents the result of a time skip operation, indicating that the time skip operation was already in progress.
     */
     ...
     * <p>
     * This variable is a boolean value indicating whether the time skip operation was successful or not.
     * <p>
     * Example usage:
     * {@snippet : boolean success = TimeSkipResult.toBoolean();}
     */
     ...
     *
     * @return true if the TimeSkipResult represents a successful time skip operation, false otherwise.
     */
    @Contract(pure = true)
