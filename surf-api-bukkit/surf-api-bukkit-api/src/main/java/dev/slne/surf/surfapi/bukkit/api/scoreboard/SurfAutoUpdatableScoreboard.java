 ...
 * This scoreboard extends the SurfScoreboard interface and adds the ability to automatically update itself every 5 ticks (0.25 seconds).
...
public interface SurfAutoUpdatableScoreboard extends SurfScoreboard {
     ...
     * <p>
     * This method should not be called directly as it is called automatically every 5 ticks (0.25 seconds).
     *
