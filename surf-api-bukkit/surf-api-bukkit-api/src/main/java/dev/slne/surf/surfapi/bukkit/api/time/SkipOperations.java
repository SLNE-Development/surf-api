...
public final class SkipOperations {
   ...
   */
  public static final SkipOperation NEXT_SUNRISE = world -> normalizeTimeToAdd(
      calculateMargin(world, 22600L));
  /**
   * Represents a skip operator for calculating the time interval until the next sunset in a
   * Minecraft world. The value of this variable is a lambda expression that takes a World object as
   * input and calculates the time to add to the world.
   */
  public static final SkipOperation NEXT_SUNSET = world -> normalizeTimeToAdd(
      calculateMargin(world, 11800L));
  /**
   * Represents a skip operator for calculating the time interval until the next morning in a
   * Minecraft world. The value of this variable is a lambda expression that takes a World object as
   * input and calculates the time to add to the world.
   */
  public static final SkipOperation NEXT_DAY = world -> normalizeTimeToAdd(
      calculateMargin(world, 500L));
  /**
   ...
   */
  public static final SkipOperation NEXT_NOON = world -> normalizeTimeToAdd(
      calculateMargin(world, 6000L));
  /**
   * Represents a skip operator for calculating the time interval until the next afternoon in a
   * Minecraft world. The value of this variable is a lambda expression that takes a World object as
   * input and calculates the time to add to the world.
   */
  public static final SkipOperation NEXT_NIGHT = world -> normalizeTimeToAdd(
      calculateMargin(world, 13000L));
  /**
   * Represents a skip operator for calculating the time interval until the next midnight in a
   * Minecraft world. The value of this variable is a lambda expression that takes a World object as
   * input and calculates the time to add to the world.
   */
  public static final SkipOperation NEXT_MIDNIGHT = world -> normalizeTimeToAdd(
      calculateMargin(world, 18000L));
