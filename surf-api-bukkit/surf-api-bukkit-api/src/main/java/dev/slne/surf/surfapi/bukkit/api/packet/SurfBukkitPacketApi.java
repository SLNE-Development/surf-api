...
/**
 * SurfBukkitPacketApi interface extends SurfCorePacketApi interface and provides additional methods
 * for packet handling in Bukkit. It allows registering and unregistering packet lore listeners,
 * interacting with entities, and creating entities.
 */
...
public interface SurfBukkitPacketApi extends SurfCorePacketApi {
   ...
   */
  void registerPacketLoreListener(@NotNull NamespacedKey identifier,
      @NotNull SurfBukkitPacketLoreHandler listener);
   ...
   */
  void registerPacketLoreListenerGlobal(@NotNull Plugin plugin,
      @NotNull SurfBukkitPacketLoreHandler listener);
