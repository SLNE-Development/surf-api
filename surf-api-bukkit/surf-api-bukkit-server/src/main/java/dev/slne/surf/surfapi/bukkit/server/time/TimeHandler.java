...
public class TimeHandler {
  ...
  /**
   * The DEFAULT_SKIP_AMOUNT is a constant variable that specifies the default amount of time to
   * skip in the TimeHandler class. It is of type long and has a value of 100L.
   */
  public static final long DEFAULT_SKIP_AMOUNT = 100L;
  /**
   * The INSTANCE variable is a static final variable of type TimeHandler. It represents a singleton
   * instance of the TimeHandler class. The TimeHandler class provides methods for skipping time
   * smoothly in a Minecraft world.
   */
   ...
   * <p>
   * This list is used to keep track of worlds where the time is being skipped smoothly using the
   * {@link TimeHandler} class. Synchronization is ensured using
   * {@link Collections#synchronizedList(List)} to make it thread-safe.
   */
