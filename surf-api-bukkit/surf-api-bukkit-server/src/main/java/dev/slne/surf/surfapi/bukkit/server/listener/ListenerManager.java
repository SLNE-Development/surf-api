...
/**
 * The ListenerManager class is responsible for registering and unregistering listeners in the Bukkit plugin.
 * It provides methods to register and unregister listeners for specific events.
