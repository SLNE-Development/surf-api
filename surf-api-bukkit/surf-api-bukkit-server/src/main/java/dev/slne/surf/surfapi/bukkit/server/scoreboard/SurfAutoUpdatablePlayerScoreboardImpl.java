...
@ApiStatus.Internal
public class SurfAutoUpdatablePlayerScoreboardImpl extends
    SurfAutoUpdatableScoreboardImpl implements SurfAutoUpdatablePlayerScoreboard {

  public SurfAutoUpdatablePlayerScoreboardImpl(Component title, int maxLines,
      SidebarComponent sidebarComponent, List<SidebarAnimation<Component>> animations) {
  ...
  public void addViewer(Player viewer) {
    ComponentLogger.logger().warn(
        "You are not allowed to add viewers to this scoreboard. This Scoreboard automatically adds viewers.");
  }
