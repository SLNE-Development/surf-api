...
import dev.slne.surf.api.minestom.inventory.framework.view.container.component.components.ViewContainerBackHintComponent
 ...
 *
 * Added automatically when [SurfViewSettings.navigateBackOnOutsideClick][dev.slne.surf.api.minestom.api.inventory.framework.view.settings.SurfViewSettings.navigateBackOnOutsideClick]
 * is `true`.
 */
context(context: ViewContainerModificationContext)
fun backHint() {
...
/**
 * Sets a title header for the [ViewContainer][dev.slne.surf.api.minestom.api.inventory.framework.view.container.ViewContainer] by removing any existing title component
