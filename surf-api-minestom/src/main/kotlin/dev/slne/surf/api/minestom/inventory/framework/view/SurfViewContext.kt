...
import dev.slne.surf.api.minestom.inventory.framework.view.pagination.AbstractPaginatedSurfView
...
import dev.slne.surf.api.minestom.inventory.framework.view.state.StateRegistry
 ...
 *
 * @see surfView
 * @see dev.slne.surf.api.minestom.inventory.framework.view.settings.SimpleViewSettings
 */
@InventoryFrameworkDSL
class SurfViewContext @PublishedApi internal constructor() :
    AbstractSurfViewContext<SurfViewRef>() {
    @PublishedApi
 ...
 *
 * @see paginatedSurfView
 * @see dev.slne.surf.api.minestom.inventory.framework.view.settings.PaginatedViewSettings
 */
@InventoryFrameworkDSL
class PaginatedSurfViewContext @PublishedApi internal constructor() :
    AbstractSurfViewContext<PaginatedSurfViewRef>() {
    @PublishedApi
    ...
    @PublishedApi
    internal var paginationStateBuilder: ((AbstractPaginatedSurfView) -> PaginationStateBuilder<Context, MinestomItemComponentBuilder, *>)? =
        null
     ...
     *
     * @throws IllegalStateException if no pagination has been configured via [pagination][dev.slne.surf.api.minestom.inventory.framework.view.pagination.pagination]
     */
    fun getRegisteredPaginationStateBuilder(): (AbstractPaginatedSurfView) -> PaginationStateBuilder<Context, MinestomItemComponentBuilder, *> {
