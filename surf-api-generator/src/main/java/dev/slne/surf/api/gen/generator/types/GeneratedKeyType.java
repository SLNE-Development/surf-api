...
import dev.slne.surf.api.gen.generator.reflection.Reflection;
...
//          RegistrySetBuilder.RegistryStub::bootstrap));
  ...
  private static final Map<ResourceKey<? extends Registry<?>>, RegistryBootstrap<?>> VANILLA_REGISTRY_ENTRIES = Reflection.REGISTRY_SET_BUILDER.getEntries(
      Reflection.VANILLA_REGISTRIES.getBUILDER()).stream().collect(
      Collectors.toMap(Reflection.REGISTRY_STUB::key, Reflection.REGISTRY_STUB::bootstrap));
