...
import dev.slne.surf.surfapi.shared.internal.component.ComponentsConfig.json
    ...
    private fun processPostProcessors(resolver: Resolver, moduleName: String) {
        ...
        val postProcessorMetas = postProcessorClasses.mapNotNull { postProcessorClass ->
            try {
                ...
                logger.error("Failed to process post processor ${postProcessorClass.qualifiedName?.asString()}", postProcessorClass)
                null
            }
        }
