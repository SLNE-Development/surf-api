package dev.slne.surf.api.processor.component
...
import dev.slne.surf.api.shared.internal.hook.ComponentsConfig.COMPONENTS_DIRECTORY
import dev.slne.surf.api.shared.internal.hook.ComponentsConfig.json
...
class ComponentSymbolProcessor(environment: SymbolProcessorEnvironment) : SymbolProcessor {
    ...
    private val postProcessors =
        mutableMapOf<String, MutableSet<PluginComponentMeta.PostProcessor>>()
    ...
    private fun processComponent(
        ...
        val conditionalOnProperties =
            component.findAllAnnotationsRecursive(ClassNames.CONDITIONAL_ON_PROPERTY)
                .map { annotation ->
                    PluginComponentMeta.PropertyCondition(
                        ...
                        matchIfMissing = annotation.getArgumentValueAs<Boolean>("matchIfMissing")
                            ?: false,
