...
import dev.slne.surf.api.shared.api.annotation.AnnotationUtils
 ...
 * @see Priority
 */
abstract class AbstractComponent : SurfComponent {
    private val loaded = AtomicBoolean(false)
    private val enabled = AtomicBoolean(false)
    private val disabled = AtomicBoolean(false)

    init {
        AnnotationUtils.findAnnotation(javaClass, SurfComponentMeta::class.java)
