...
@Deprecated("abi", level = DeprecationLevel.HIDDEN)
fun SurfComponentBuilder.appendText(
    text: String,
    color: TextColor? = null,
): SurfComponentBuilder {
    return append(Component.text(text, color))
}
...
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
@Deprecated("abi", level = DeprecationLevel.HIDDEN)
fun SurfComponentBuilder.clickOpensUrl(
    url: String,
): SurfComponentBuilder {
...
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
@Deprecated("abi", level = DeprecationLevel.HIDDEN)
fun SurfComponentBuilder.clickRunsCommand(
    command: String,
): SurfComponentBuilder {
...
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
@Deprecated("abi", level = DeprecationLevel.HIDDEN)
fun SurfComponentBuilder.clickSuggestsCommand(
    command: String,
): SurfComponentBuilder {
...
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
@Deprecated("abi", level = DeprecationLevel.HIDDEN)
fun SurfComponentBuilder.clickCopiesToClipboard(
    value: String,
): SurfComponentBuilder {
    return clickEvent(ClickEvent.copyToClipboard(value))
}

@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
@Deprecated("abi", level = DeprecationLevel.HIDDEN)
fun SurfComponentBuilder.appendNewline(
    amount: Int,
): Unit = repeat(amount) {
    appendNewline()
}