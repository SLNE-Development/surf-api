 ...
 *   handler has already marked a [SurfCancellableEvent] as cancelled. Handlers
 *   with priority [SurfEventPriority.MONITOR] are always executed, regardless of
 *   this flag. Has no effect for events that do not implement
 *   [SurfCancellableEvent].
 */
