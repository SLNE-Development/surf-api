...
import dev.slne.surf.api.core.util.SurfTypeParameterMatcher.Companion.find
import dev.slne.surf.api.core.util.SurfTypeParameterMatcher.Companion.get
...
abstract class SurfTypeParameterMatcher {
    ...
    companion object {
        ...
        private fun resolveTypeFromInterfaces(
            ...
            for (interfaceType in currentClass.genericInterfaces) {
                ...
                if (interfaceType is Class<*>) {
                    val resolved =
                        resolveTypeFromInterfaces(interfaceType, parametrizedType, typeParamName)
        ...
        private fun resolveTypeFromGenericInfo(
            ...
            val typeParamIndex =
                parametrizedType.typeParameters.indexOfFirst { it.name == typeParamName }
