...
public abstract class PacketEntityImpl<T extends PacketEntity<T>> extends PacketEntityCommon implements PacketEntity<T>, SpawnVelocity, Shootable {
    ...
    public final Optional<Component> displayName() {
        return Optional.ofNullable(!get(CUSTOM_NAME_VISIBLE_INDEX, false) ? null : get(CUSTOM_NAME_INDEX, null));
    }
