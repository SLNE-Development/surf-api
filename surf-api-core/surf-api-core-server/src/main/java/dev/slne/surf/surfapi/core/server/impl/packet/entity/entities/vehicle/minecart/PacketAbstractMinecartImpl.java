...
public abstract class PacketAbstractMinecartImpl<Impl extends PacketAbstractMinecart<Impl>> extends PacketEntityImpl<Impl> implements PacketAbstractMinecart<Impl> {
    ...
    public PacketAbstractMinecartImpl(UUID uuid, EntityType type, int defaultBlockOffset, WrappedBlockState defaultBlockState) {
        super(uuid, type);
