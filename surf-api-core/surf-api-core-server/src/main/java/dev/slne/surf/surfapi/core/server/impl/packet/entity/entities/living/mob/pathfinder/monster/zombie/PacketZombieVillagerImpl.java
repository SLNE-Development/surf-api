...
public final class PacketZombieVillagerImpl extends
    PacketZombieImpl<PacketZombieVillager> implements PacketZombieVillager {

  private static final Supplier<VillagerData> DEFAULT_VILLAGER_DATA = () -> new VillagerData(
      VillagerTypes.PLAINS, VillagerProfessions.NONE, 1);
