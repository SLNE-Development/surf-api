...
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.BLOCK_POSITION;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.BOOLEAN;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.BYTE;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.FLOAT;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.INT;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.ITEMSTACK;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.OPTIONAL_BLOCK_POSITION;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.OPTIONAL_INT;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.OPTIONAL_UUID;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.PAINTING_VARIANT_TYPE;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.QUATERNION;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.ROTATION;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.STRING;
import static com.github.retrooper.packetevents.protocol.entity.data.EntityDataTypes.VECTOR3F;
...
public abstract class PacketEntityCommon implements EntityMetadataProvider {
  ...
  protected static void addSupportedVersion(
      @NotNull Int2ObjectMap<Int2ObjectMap<EntityData>> versionsMap,
  ...
  protected static org.spongepowered.math.vector.Vector3i fromPacketEvents(Vector3i packetEvents) {
    return new org.spongepowered.math.vector.Vector3i(packetEvents.x, packetEvents.y,
        packetEvents.z);
  }
  ...
  protected <Data> void setForVersions(ClientVersion from, ClientVersion to, int index,
      EntityDataType<Data> type, Data value) {
  ...
  protected <Data> void setForVersion(ClientVersion clientVersion, int index,
      EntityDataType<Data> type, Data value) {
    checkDeleted();
    protocolToDataVersion.computeIfPresent(clientVersion.getProtocolVersion(),
        (protocolVersion, indexToEntityDatas) -> {
  ...
  protected <Data> Data get(int index, @Nullable Data defaultReturnValue) {
    checkDeleted();
    final Int2ObjectMap<EntityData> map = protocolToDataVersion.get(
        LATEST_CLIENT_VERSION.getProtocolVersion());
  ...
  protected Vector4f get4f(int index, @NotNull Vector4f defaultReturnValue) {
    ...
    return pe == null ? defaultReturnValue
        : new Vector4f(pe.getX(), pe.getY(), pe.getZ(), pe.getW());
  }
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        .add("EntityData",
            protocolToDataVersion.get(LATEST_CLIENT_VERSION.getProtocolVersion()).toString())
        .add("type", type)
        .toString();
  }
}
