...
public final class PacketItemDisplayImpl extends PacketDisplayImpl<PacketItemDisplay> implements PacketItemDisplay {
    ...
    public ItemDisplayTransform itemDisplayTransform() {
        return ItemDisplayTransform.BY_ID.get(get(DISPLAY_TRANSFORM_INDEX, ItemDisplayTransform.NONE.id()));
    }
