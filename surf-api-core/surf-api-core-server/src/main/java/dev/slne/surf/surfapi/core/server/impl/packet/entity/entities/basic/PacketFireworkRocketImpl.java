...
public final class PacketFireworkRocketImpl extends PacketEntityImpl<PacketFireworkRocket> implements PacketFireworkRocket{
    ...
    public void shooterEntityId(int shooterEntityId) {
        ...
        setOptInt(SHOOTER_ENTITY_ID_INDEX, Optional.ofNullable(shooterEntityId == -1 ? null : shooterEntityId));
        afterSet();
    }
