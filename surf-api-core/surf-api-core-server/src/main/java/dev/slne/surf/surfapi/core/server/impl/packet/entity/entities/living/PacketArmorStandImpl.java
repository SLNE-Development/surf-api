...
public final class PacketArmorStandImpl extends PacketLivingEntityImpl<PacketArmorStand> implements
    PacketArmorStand {
  ...
  public PreciseRotation leftArmRotation() {
    return PreciseRotation.fromPacketEvents(
        get(LEFT_ARM_ROTATION_INDEX, new Vector3f(-10, 0, -10)));
  }

  @Override
  public void leftArmRotation(@NotNull PreciseRotation leftArmRotation) {
    set(LEFT_LEG_ROTATION_INDEX,
        checkNotNull(leftArmRotation, "Left arm rotation may not be null"));
    afterSet();
  }
  ...
  public PreciseRotation rightArmRotation() {
    return PreciseRotation.fromPacketEvents(
        get(RIGHT_ARM_ROTATION_INDEX, new Vector3f(-15, 0, -10)));
  }

  @Override
  public void rightArmRotation(@NotNull PreciseRotation rightArmRotation) {
    set(RIGHT_ARM_ROTATION_INDEX,
        checkNotNull(rightArmRotation, "Right arm rotation may not be null"));
    afterSet();
  }
  ...
  public void leftLegRotation(@NotNull PreciseRotation leftLegRotation) {
    set(LEFT_LEG_ROTATION_INDEX,
        checkNotNull(leftLegRotation, "Left leg rotation may not be null"));
    afterSet();
  }
  ...
  public void rightLegRotation(@NotNull PreciseRotation rightLegRotation) {
    set(RIGHT_LEG_ROTATION_INDEX,
        checkNotNull(rightLegRotation, "Right leg rotation may not be null"));
    afterSet();
  }
}
