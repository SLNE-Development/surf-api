...
public final class SurfInvocationHandler<T> implements InvocationHandler {
  ...
  private static java.lang.reflect.Constructor<?> findConstructor(Class<?> clazz, Method method)
  ...
  private Object invoke(Object2ObjectMap<Method, MethodHandle> cache, Method method,
      @CheckForNull Object[] args) throws Throwable {
