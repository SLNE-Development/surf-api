    ...
    private void cacheInterfaceMethods() {
        for (Method method : proxyClass.getDeclaredMethods()) {
            ...
            if (fieldAnnotation != null) {
                final MethodHandle methodHandle = sneaky(() -> lookup.unreflectGetter(findField(proxiedClass, getMethodName(method, nameAnnotation, fieldAnnotation, staticAnnotation, null))));
