...
public abstract class PacketAbstractMinecartContainerImpl<Impl extends PacketAbstractMinecartContainer<Impl>> extends
    PacketAbstractMinecartImpl<Impl> implements PacketAbstractMinecartContainer<Impl> {

  public PacketAbstractMinecartContainerImpl(UUID uuid, EntityType type, int defaultBlockOffset,
