...
public final class PacketTextDisplayImpl extends PacketDisplayImpl<PacketTextDisplay> implements
    PacketTextDisplay {
  ...
  public void alignment(TextAlignment alignment) {
    setMaskBit(TEXT_BIT_MASK_INDEX, ALIGNMENT_BIT,
        checkNotNull(alignment, "alignment may not be null").id());
    afterSet();
  }
}
