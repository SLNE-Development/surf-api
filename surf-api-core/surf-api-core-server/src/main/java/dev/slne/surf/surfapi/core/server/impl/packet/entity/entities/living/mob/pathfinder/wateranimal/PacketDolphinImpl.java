...
public class PacketDolphinImpl extends PacketWaterAnimalImpl<PacketDolphin> implements PacketDolphin {
    ...
    public void treasurePosition(@NotNull org.spongepowered.math.vector.Vector3i treasurePosition) {
        set(TREASURE_POSITION_INDEX, toPacketEvents(checkNotNull(treasurePosition, "treasurePosition")));
        afterSet();
    }
