...
public abstract class PacketAbstractArrowImpl<Impl extends PacketAbstractArrow<Impl>> extends PacketEntityImpl<Impl> implements PacketAbstractArrow<Impl> {
    ...
    public void piercingLevel(int piercingLevel) {
        checkArgument(0 <= piercingLevel && piercingLevel <= Byte.MAX_VALUE, "Piercing level (%s) out of range, expected 0 < level < 127", piercingLevel);
