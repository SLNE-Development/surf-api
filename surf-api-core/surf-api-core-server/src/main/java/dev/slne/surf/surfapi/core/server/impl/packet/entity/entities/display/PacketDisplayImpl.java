...
public abstract class PacketDisplayImpl<T extends PacketDisplay<T>> extends PacketEntityImpl<T> implements PacketDisplay<T> {
    ...
    public void billboardConstraints(@NotNull BillboardConstraints billboardConstraints) {
        setByte(BILLBOARD_CONSTRAINTS_INDEX, checkNotNull(billboardConstraints, "billboardConstraints").id());
        afterSet();
    }
