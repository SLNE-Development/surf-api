package dev.slne.surf.surfapi.core.server.environment

import dev.slne.surf.surfapi.core.api.util.emptyObject2ObjectMap
...
object EnvironmentAccessor {
    ...
    fun getEnv(key: String): String? {
        ...
        return dotenv[key]?.takeIf { it.isNotBlank() } ?: System.getenv(key)?.takeIf { it.isNotBlank() }
    }
