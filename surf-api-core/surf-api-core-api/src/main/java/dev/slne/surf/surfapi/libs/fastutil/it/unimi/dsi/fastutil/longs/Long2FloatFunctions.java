...
public final class Long2FloatFunctions {
	...
	public static Long2FloatFunction primitive(final java.util.function.Function<? super Long, ? extends Float> f) {
		...
		if (f instanceof java.util.function.LongToDoubleFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(((java.util.function.LongToDoubleFunction)f).applyAsDouble(key));
