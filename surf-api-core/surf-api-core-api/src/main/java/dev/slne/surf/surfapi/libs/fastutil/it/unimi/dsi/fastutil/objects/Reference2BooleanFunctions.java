...
public final class Reference2BooleanFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2BooleanFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2BooleanFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public boolean getOrDefault(final Object k, final boolean defaultValue) {
			return ((Reference2BooleanFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2BooleanFunction<K> unmodifiable(final Reference2BooleanFunction<? extends K> f) {
