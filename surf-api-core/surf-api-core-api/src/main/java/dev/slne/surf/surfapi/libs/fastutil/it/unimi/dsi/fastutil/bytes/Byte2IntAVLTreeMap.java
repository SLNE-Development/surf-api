	...
	*/
	...
	public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
			final Comparator<? super Byte2IntMap.Entry> comparator = (Byte2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2IntMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2IntMap.Entry>)(x, y) -> Byte2IntAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2IntAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2IntAVLTreeMap.this.compare(k, to) < 0);
		}
