...
public final class ByteSortedSets {
	...
	public static class Singleton extends ByteSets.Singleton implements ByteSortedSet, java.io.Serializable, Cloneable {
		...
		public ByteSpliterator spliterator() {
			return ByteSpliterators.singleton(element, comparator);
		}
		...
		public IntSpliterator intSpliterator() {
			return IntSpliterators.singleton(element, (int left, int right) -> comparator().compare(it.unimi.dsi.fastutil.SafeMath.safeIntToByte(left), it.unimi.dsi.fastutil.SafeMath.safeIntToByte(right)));
		}
