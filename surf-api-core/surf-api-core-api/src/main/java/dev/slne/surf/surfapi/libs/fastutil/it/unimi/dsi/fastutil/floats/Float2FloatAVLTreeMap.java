	...
	*/
	...
	public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
			final Comparator<? super Float2FloatMap.Entry> comparator = (Float2FloatAVLTreeMap.this.actualComparator == null ? (Comparator<Float2FloatMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2FloatMap.Entry>)(x, y) -> Float2FloatAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
			...
			public boolean remove(final Object o) {
				...
				if (!(e.getValue() instanceof Float)) return false;
				final Entry f = findKey(((Float)(e.getKey())).floatValue());
	...
	private final class Submap extends AbstractFloat2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2FloatAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
