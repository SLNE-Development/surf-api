...
public class Char2CharRBTreeMap extends AbstractChar2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2CharMap.Entry>() {
			final Comparator<? super Char2CharMap.Entry> comparator = (Char2CharRBTreeMap.this.actualComparator == null ? (Comparator<Char2CharMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2CharMap.Entry>)(x, y) -> Char2CharRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2CharRBTreeMap.this.compare(k, from) >= 0) && (top || Char2CharRBTreeMap.this.compare(k, to) < 0);
		}
