...
public final class Double2ShortFunctions {
	...
	public static Double2ShortFunction primitive(final java.util.function.Function<? super Double, ? extends Short> f) {
		...
		if (f instanceof java.util.function.DoubleToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.DoubleToIntFunction)f).applyAsInt(key));
