 ...
 */
@FunctionalInterface
public interface FloatBinaryOperator extends BinaryOperator<Float>, java.util.function.DoubleBinaryOperator {
	/**
	...
	default double applyAsDouble(final double x, final double y) {
		return apply(it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(x), it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(y));
	}
