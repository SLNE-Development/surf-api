 ...
 */
public class DoubleShortImmutablePair implements DoubleShortPair, java.io.Serializable {
	 ...
	 */
	public DoubleShortImmutablePair(final double left, final short right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static DoubleShortImmutablePair of(final double left, final short right) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof DoubleShortPair) {
			return left == ((DoubleShortPair)other).leftDouble() && right == ((DoubleShortPair)other).rightShort();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Double.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && java.util.Objects.equals(Short.valueOf(right), ((it.unimi.dsi.fastutil.Pair)other).right());
		}
		return false;
	}
