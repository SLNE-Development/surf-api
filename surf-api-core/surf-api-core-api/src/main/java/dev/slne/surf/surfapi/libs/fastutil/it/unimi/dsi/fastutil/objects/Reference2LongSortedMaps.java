...
public final class Reference2LongSortedMaps {
	...
	public static class Singleton<K> extends Reference2LongMaps.Singleton<K> implements Reference2LongSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2LongMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Reference2LongMaps.SynchronizedMap<K> implements Reference2LongSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.reference2LongEntrySet(), sync);
			return (ObjectSortedSet<Reference2LongMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2LongMaps.UnmodifiableMap<K> implements Reference2LongSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.reference2LongEntrySet());
			return (ObjectSortedSet<Reference2LongMap.Entry<K>>)entries;
		}
