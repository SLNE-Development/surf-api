...
public class Reference2ShortLinkedOpenHashMap<K> extends AbstractReference2ShortSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	public short putAndMoveToFirst(final K k, final short v) {
		...
		if (((k) == (null))) {
			...
			if (!((curr = key[pos = (it.unimi.dsi.fastutil.HashCommon.mix(System.identityHashCode(k))) & mask]) == (null))) {
				...
				while (!((curr = key[pos = (pos + 1) & mask]) == (null))) if (((curr) == (k))) {
					moveIndexToFirst(pos);
					return setValue(pos, v);
				}
			}
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ShortMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Reference2ShortMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	 ...
	 */
	private final class ValueIterator extends MapIterator<ShortConsumer> implements ShortListIterator {
		@Override
	...
	public ShortCollection values() {
		if (values == null) values = new AbstractShortCollection() {
			private static final int SPLITERATOR_CHARACTERISTICS = ShortSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.ORDERED;
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
