...
public class Byte2FloatRBTreeMap extends AbstractByte2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>() {
			final Comparator<? super Byte2FloatMap.Entry> comparator = (Byte2FloatRBTreeMap.this.actualComparator == null ? (Comparator<Byte2FloatMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2FloatMap.Entry>)(x, y) -> Byte2FloatRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2FloatRBTreeMap.this.compare(k, from) >= 0) && (top || Byte2FloatRBTreeMap.this.compare(k, to) < 0);
		}
