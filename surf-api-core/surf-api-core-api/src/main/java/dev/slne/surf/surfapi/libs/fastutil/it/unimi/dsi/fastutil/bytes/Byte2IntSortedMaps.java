...
public final class Byte2IntSortedMaps {
	...
	public static class Singleton extends Byte2IntMaps.Singleton implements Byte2IntSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2IntMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Byte2IntMaps.SynchronizedMap implements Byte2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2IntEntrySet(), sync);
			return (ObjectSortedSet<Byte2IntMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2IntMaps.UnmodifiableMap implements Byte2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2IntEntrySet());
			return (ObjectSortedSet<Byte2IntMap.Entry>)entries;
		}
