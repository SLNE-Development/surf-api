...
public class ReferenceLinkedOpenHashSet<K> extends AbstractReferenceSortedSet<K> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public static <K> ReferenceLinkedOpenHashSet<K> of(final K e) {
		ReferenceLinkedOpenHashSet<K> result = new ReferenceLinkedOpenHashSet<>(1, DEFAULT_LOAD_FACTOR);
		result.add(e);
		return result;
	}
	 ...
	 */
	public static <K> ReferenceLinkedOpenHashSet<K> of(final K e0, final K e1) {
		ReferenceLinkedOpenHashSet<K> result = new ReferenceLinkedOpenHashSet<>(2, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
	 ...
	 * @throws IllegalArgumentException if there were duplicate entries.
	 */
	public static <K> ReferenceLinkedOpenHashSet<K> of(final K e0, final K e1, final K e2) {
		ReferenceLinkedOpenHashSet<K> result = new ReferenceLinkedOpenHashSet<>(3, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
			throw new IllegalArgumentException("Duplicate element: " + e1);
		}
	 ...
	 */
	@SafeVarargs
	public static <K> ReferenceLinkedOpenHashSet<K> of(final K... a) {
		ReferenceLinkedOpenHashSet<K> result = new ReferenceLinkedOpenHashSet<>(a.length, DEFAULT_LOAD_FACTOR);
		for (K element : a) {
	...
	private static final Collector<Object, ?, ReferenceLinkedOpenHashSet<Object>> TO_SET_COLLECTOR = Collector.of(ReferenceLinkedOpenHashSet::new, ReferenceLinkedOpenHashSet::add, ReferenceLinkedOpenHashSet::combine);
	...
	public static <K> Collector<K, ?, ReferenceLinkedOpenHashSet<K>> toSetWithExpectedSize(int expectedSize) {
		...
		return Collector.of(new ReferenceCollections.SizeDecreasingSupplier<K, ReferenceLinkedOpenHashSet<K>>(expectedSize, (int size) -> size <= Hash.DEFAULT_INITIAL_SIZE ? new ReferenceLinkedOpenHashSet<K>() : new ReferenceLinkedOpenHashSet<K>(size)), ReferenceLinkedOpenHashSet::add, ReferenceLinkedOpenHashSet::combine);
	}
