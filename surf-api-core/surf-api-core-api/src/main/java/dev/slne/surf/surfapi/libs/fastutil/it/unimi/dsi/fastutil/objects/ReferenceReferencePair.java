 ...
 */
public interface ReferenceReferencePair<K, V> extends it.unimi.dsi.fastutil.Pair<K, V> {
	/**
	 ...
	 */
	public static <K, V> ReferenceReferencePair<K, V> of(final K left, final V right) {
