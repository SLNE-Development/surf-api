...
public class Reference2ObjectLinkedOpenHashMap<K, V> extends AbstractReference2ObjectSortedMap<K, V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ObjectMap.Entry<K, V>> implements FastSortedEntrySet<K, V> {
		...
		public ObjectSpliterator<Reference2ObjectMap.Entry<K, V>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2ObjectLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
