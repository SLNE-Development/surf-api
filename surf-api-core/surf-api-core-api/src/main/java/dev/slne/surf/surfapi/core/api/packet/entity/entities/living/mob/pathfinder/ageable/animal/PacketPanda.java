...
public interface PacketPanda extends PacketAnimal<PacketPanda>, Spawnable {
  ...
  /**
   * Sets the sneeze progress in this animation. This value counts up only if {@link #isSneezing()}
   * is true
   *
  ...
  enum Gene {
    ...
    /**
     * Gets whether this gene is recessive, i.e. required in both parents to propagate to children.
     *
