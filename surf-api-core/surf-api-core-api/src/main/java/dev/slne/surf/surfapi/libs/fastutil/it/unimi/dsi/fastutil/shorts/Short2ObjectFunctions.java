...
public final class Short2ObjectFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractShort2ObjectFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Short2ObjectFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final short k, final V defaultValue) {
			return ((Short2ObjectFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Short2ObjectFunction<V> unmodifiable(final Short2ObjectFunction<? extends V> f) {
