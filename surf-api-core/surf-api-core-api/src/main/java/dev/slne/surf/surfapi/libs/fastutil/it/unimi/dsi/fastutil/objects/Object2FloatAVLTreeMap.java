	...
	*/
	...
	public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
			final Comparator<? super Object2FloatMap.Entry<K>> comparator = (Object2FloatAVLTreeMap.this.actualComparator == null ? (Comparator<Object2FloatMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2FloatMap.Entry<K>>)(x, y) -> Object2FloatAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2FloatSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2FloatAVLTreeMap.this.compare(k, from) >= 0) && (top || Object2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
