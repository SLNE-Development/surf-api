...
public final class Char2IntMaps {
	...
	public static class EmptyMap extends Char2IntFunctions.EmptyFunction implements Char2IntMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Integer> consumer) {
		}
	...
	public static class Singleton extends Char2IntFunctions.Singleton implements Char2IntMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractChar2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2IntFunctions.SynchronizedFunction implements Char2IntMap, java.io.Serializable {
		...
		public ObjectSet<Char2IntMap.Entry> char2IntEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.char2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final char key, final java.util.function.IntFunction<? extends Integer> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsent(final char key, final Char2IntFunction mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Character key, final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer compute(final Character key, final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer merge(final Character key, final Integer value, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Char2IntFunctions.UnmodifiableFunction implements Char2IntMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.char2IntEntrySet());
			return entries;
		}
