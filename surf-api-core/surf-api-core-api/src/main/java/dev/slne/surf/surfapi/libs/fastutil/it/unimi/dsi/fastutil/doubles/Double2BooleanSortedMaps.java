...
public final class Double2BooleanSortedMaps {
	...
	public static class Singleton extends Double2BooleanMaps.Singleton implements Double2BooleanSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2BooleanMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Double2BooleanMaps.SynchronizedMap implements Double2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Double2BooleanMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2BooleanMaps.UnmodifiableMap implements Double2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2BooleanEntrySet());
			return (ObjectSortedSet<Double2BooleanMap.Entry>)entries;
		}
