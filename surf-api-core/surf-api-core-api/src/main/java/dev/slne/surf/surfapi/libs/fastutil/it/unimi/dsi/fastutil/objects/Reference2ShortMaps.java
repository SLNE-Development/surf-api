...
public final class Reference2ShortMaps {
	...
	public static class Singleton<K> extends Reference2ShortFunctions.Singleton<K> implements Reference2ShortMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractReference2ShortMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2ShortFunctions.SynchronizedFunction<K> implements Reference2ShortMap<K>, java.io.Serializable {
		...
		public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.reference2ShortEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Reference2ShortFunctions.UnmodifiableFunction<K> implements Reference2ShortMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Reference2ShortMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2ShortEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public short getOrDefault(final Object key, final short defaultValue) {
			return ((Reference2ShortMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2ShortMap<K> unmodifiable(final Reference2ShortMap<? extends K> m) {
