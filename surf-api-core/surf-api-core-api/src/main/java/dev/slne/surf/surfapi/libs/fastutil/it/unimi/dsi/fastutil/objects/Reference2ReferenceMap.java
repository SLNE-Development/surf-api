...
public interface Reference2ReferenceMap<K, V> extends Reference2ReferenceFunction<K, V>, Map<K, V> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super V> consumer) {
		final ObjectSet<Reference2ReferenceMap.Entry<K, V>> entrySet = reference2ReferenceEntrySet();
		final Consumer<Reference2ReferenceMap.Entry<K, V>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), (entry.getValue()));
	 ...
	 * @since 8.0.0
	 */
	default V computeIfAbsent(final K key, final Reference2ReferenceFunction<? super K, ? extends V> mappingFunction) {
	 ...
	 */
	@Deprecated
	default V computeReferenceIfAbsentPartial(final K key, final Reference2ReferenceFunction<? super K, ? extends V> mappingFunction) {
