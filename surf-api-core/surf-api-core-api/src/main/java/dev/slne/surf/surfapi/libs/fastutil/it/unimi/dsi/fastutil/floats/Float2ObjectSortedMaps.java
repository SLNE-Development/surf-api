...
public final class Float2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Float2ObjectMaps.Singleton<V> implements Float2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Float2ObjectMaps.SynchronizedMap<V> implements Float2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Float2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Float2ObjectMaps.UnmodifiableMap<V> implements Float2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Float2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2ObjectEntrySet());
			return (ObjectSortedSet<Float2ObjectMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Float2ObjectSortedMap<V> unmodifiable(final Float2ObjectSortedMap<? extends V> m) {
