...
public final class Int2BooleanSortedMaps {
	...
	public static class Singleton extends Int2BooleanMaps.Singleton implements Int2BooleanSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2BooleanMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2BooleanMaps.SynchronizedMap implements Int2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Int2BooleanMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2BooleanMaps.UnmodifiableMap implements Int2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2BooleanEntrySet());
			return (ObjectSortedSet<Int2BooleanMap.Entry>)entries;
		}
