	...
	*/
	...
	public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
			final Comparator<? super Byte2ByteMap.Entry> comparator = (Byte2ByteAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2ByteMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2ByteMap.Entry>)(x, y) -> Byte2ByteAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2ByteAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2ByteAVLTreeMap.this.compare(k, to) < 0);
		}
