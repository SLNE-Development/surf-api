	...
	*/
	...
	public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() {
			final Comparator<? super Double2ByteMap.Entry> comparator = (Double2ByteAVLTreeMap.this.actualComparator == null ? (Comparator<Double2ByteMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2ByteMap.Entry>)(x, y) -> Double2ByteAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ByteAVLTreeMap.this.compare(k, from) >= 0) && (top || Double2ByteAVLTreeMap.this.compare(k, to) < 0);
		}
