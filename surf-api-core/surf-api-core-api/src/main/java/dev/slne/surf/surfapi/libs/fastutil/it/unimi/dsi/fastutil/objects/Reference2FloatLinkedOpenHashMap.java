...
public class Reference2FloatLinkedOpenHashMap<K> extends AbstractReference2FloatSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2FloatMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Reference2FloatMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2FloatLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public FloatCollection values() {
		if (values == null) values = new AbstractFloatCollection() {
			...
			public FloatSpliterator spliterator() {
				return FloatSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2FloatLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
