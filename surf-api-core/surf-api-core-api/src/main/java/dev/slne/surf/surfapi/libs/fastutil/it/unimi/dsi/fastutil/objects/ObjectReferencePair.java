 ...
 */
public interface ObjectReferencePair<K, V> extends it.unimi.dsi.fastutil.Pair<K, V> {
	/**
	 ...
	 */
	public static <K, V> ObjectReferencePair<K, V> of(final K left, final V right) {
