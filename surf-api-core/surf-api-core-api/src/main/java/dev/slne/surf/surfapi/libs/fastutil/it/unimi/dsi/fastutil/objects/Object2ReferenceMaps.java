...
public final class Object2ReferenceMaps {
	...
	public static class Singleton<K, V> extends Object2ReferenceFunctions.Singleton<K, V> implements Object2ReferenceMap<K, V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K, V> extends Object2ReferenceFunctions.SynchronizedFunction<K, V> implements Object2ReferenceMap<K, V>, java.io.Serializable {
		...
		public ObjectSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K, V> extends Object2ReferenceFunctions.UnmodifiableFunction<K, V> implements Object2ReferenceMap<K, V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2ReferenceMap<? extends K, ? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2ReferenceEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final Object key, final V defaultValue) {
			return ((Object2ReferenceMap<K, V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K, V> Object2ReferenceMap<K, V> unmodifiable(final Object2ReferenceMap<? extends K, ? extends V> m) {
