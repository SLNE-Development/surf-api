 ...
 */
public interface FloatFloatPair extends it.unimi.dsi.fastutil.Pair<Float, Float> {
	/**
	 ...
	 */
	public default FloatFloatPair left(final float l) {
	 ...
	 */
	public default FloatFloatPair first(final float l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default FloatFloatPair key(final float l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default FloatFloatPair key(Float l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default FloatFloatPair right(final float r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default FloatFloatPair right(final Float l) {
	 ...
	 */
	public default FloatFloatPair second(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatFloatPair second(final Float l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default FloatFloatPair value(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatFloatPair value(final Float l) {
	 ...
	 */
	public static FloatFloatPair of(final float left, final float right) {
	...
	public static java.util.Comparator<FloatFloatPair> lexComparator() {
		return (x, y) -> {
