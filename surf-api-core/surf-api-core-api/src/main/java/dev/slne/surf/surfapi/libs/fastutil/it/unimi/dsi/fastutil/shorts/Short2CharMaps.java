...
public final class Short2CharMaps {
	...
	public static class EmptyMap extends Short2CharFunctions.EmptyFunction implements Short2CharMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Character> consumer) {
		}
	...
	public static class Singleton extends Short2CharFunctions.Singleton implements Short2CharMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2CharMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2CharFunctions.SynchronizedFunction implements Short2CharMap, java.io.Serializable {
		...
		public ObjectSet<Short2CharMap.Entry> short2CharEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Character> mappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Short key, final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character compute(final Short key, final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character merge(final Short key, final Character value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2CharFunctions.UnmodifiableFunction implements Short2CharMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2CharEntrySet());
			return entries;
		}
