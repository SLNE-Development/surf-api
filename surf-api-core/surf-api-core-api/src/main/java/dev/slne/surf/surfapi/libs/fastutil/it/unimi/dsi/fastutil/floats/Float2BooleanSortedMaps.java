...
public final class Float2BooleanSortedMaps {
	...
	public static class Singleton extends Float2BooleanMaps.Singleton implements Float2BooleanSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2BooleanMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Float2BooleanMaps.SynchronizedMap implements Float2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Float2BooleanMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2BooleanMaps.UnmodifiableMap implements Float2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2BooleanEntrySet());
			return (ObjectSortedSet<Float2BooleanMap.Entry>)entries;
		}
