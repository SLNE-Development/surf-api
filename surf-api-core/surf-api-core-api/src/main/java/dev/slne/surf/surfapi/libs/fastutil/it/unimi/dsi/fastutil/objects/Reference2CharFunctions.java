...
public final class Reference2CharFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2CharFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2CharFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public char getOrDefault(final Object k, final char defaultValue) {
			return ((Reference2CharFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2CharFunction<K> unmodifiable(final Reference2CharFunction<? extends K> f) {
	...
	public static <K> Reference2CharFunction<K> primitive(final java.util.function.Function<? super K, ? extends Character> f) {
		...
		if (f instanceof java.util.function.ToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToChar(((java.util.function.ToIntFunction<K>)f).applyAsInt((K)(key)));
