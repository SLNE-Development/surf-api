 ...
 */
public class ReferenceLongImmutablePair<K> implements ReferenceLongPair<K>, java.io.Serializable {
	 ...
	 */
	public ReferenceLongImmutablePair(final K left, final long right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ReferenceLongImmutablePair<K> of(final K left, final long right) {
