 ...
 */
@FunctionalInterface
public interface ShortBinaryOperator extends BinaryOperator<Short>, java.util.function.IntBinaryOperator {
	/**
	...
	default int applyAsInt(final int x, final int y) {
		return apply(it.unimi.dsi.fastutil.SafeMath.safeIntToShort(x), it.unimi.dsi.fastutil.SafeMath.safeIntToShort(y));
	}
