...
public final class Reference2FloatMaps {
	...
	public static class EmptyMap<K> extends Reference2FloatFunctions.EmptyFunction<K> implements Reference2FloatMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super K, ? super Float> consumer) {
		}
	...
	public static class Singleton<K> extends Reference2FloatFunctions.Singleton<K> implements Reference2FloatMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractReference2FloatMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2FloatFunctions.SynchronizedFunction<K> implements Reference2FloatMap<K>, java.io.Serializable {
		...
		public ObjectSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.reference2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super K, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsent(final K key, final java.util.function.ToDoubleFunction<? super K> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsent(final K key, final Reference2FloatFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Override
		public float merge(final K key, final float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Float computeIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Float compute(final K key, final java.util.function.BiFunction<? super K, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2FloatFunctions.UnmodifiableFunction<K> implements Reference2FloatMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Reference2FloatMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2FloatEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public float getOrDefault(final Object key, final float defaultValue) {
			return ((Reference2FloatMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2FloatMap<K> unmodifiable(final Reference2FloatMap<? extends K> m) {
