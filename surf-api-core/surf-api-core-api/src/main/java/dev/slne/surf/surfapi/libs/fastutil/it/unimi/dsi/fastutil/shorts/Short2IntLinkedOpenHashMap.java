...
public class Short2IntLinkedOpenHashMap extends AbstractShort2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2IntMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Short2IntMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractShortSortedSet {
		...
		public ShortSpliterator spliterator() {
			return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public IntCollection values() {
		if (values == null) values = new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
