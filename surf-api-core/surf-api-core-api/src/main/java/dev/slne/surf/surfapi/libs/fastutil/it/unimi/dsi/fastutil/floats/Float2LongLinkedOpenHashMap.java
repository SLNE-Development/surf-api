...
public class Float2LongLinkedOpenHashMap extends AbstractFloat2LongSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2LongMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Float2LongMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractFloatSortedSet {
		...
		public FloatSpliterator spliterator() {
			return FloatSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public LongCollection values() {
		if (values == null) values = new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
