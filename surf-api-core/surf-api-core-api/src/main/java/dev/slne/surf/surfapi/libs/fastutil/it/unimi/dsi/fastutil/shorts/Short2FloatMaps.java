...
public final class Short2FloatMaps {
	...
	public static class EmptyMap extends Short2FloatFunctions.EmptyFunction implements Short2FloatMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Float> consumer) {
		}
	...
	public static class Singleton extends Short2FloatFunctions.Singleton implements Short2FloatMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2FloatFunctions.SynchronizedFunction implements Short2FloatMap, java.io.Serializable {
		...
		public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Float> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Short2FloatFunctions.UnmodifiableFunction implements Short2FloatMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2FloatEntrySet());
			return entries;
		}
