 ...
 */
public interface FloatShortPair extends it.unimi.dsi.fastutil.Pair<Float, Short> {
	/**
	 ...
	 */
	public default FloatShortPair left(final float l) {
	 ...
	 */
	public default FloatShortPair first(final float l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default FloatShortPair key(final float l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default FloatShortPair key(Float l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default FloatShortPair right(final short r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default FloatShortPair right(final Short l) {
	 ...
	 */
	public default FloatShortPair second(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatShortPair second(final Short l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default FloatShortPair value(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatShortPair value(final Short l) {
	 ...
	 */
	public static FloatShortPair of(final float left, final short right) {
	...
	public static java.util.Comparator<FloatShortPair> lexComparator() {
		return (x, y) -> {
