...
public final class Short2ByteMaps {
	...
	public static class EmptyMap extends Short2ByteFunctions.EmptyFunction implements Short2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Byte> consumer) {
		}
	...
	public static class Singleton extends Short2ByteFunctions.Singleton implements Short2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2ByteFunctions.SynchronizedFunction implements Short2ByteMap, java.io.Serializable {
		...
		public ObjectSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Byte> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Short2ByteFunctions.UnmodifiableFunction implements Short2ByteMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2ByteEntrySet());
			return entries;
		}
