...
public final class Long2CharFunctions {
	...
	public static Long2CharFunction primitive(final java.util.function.Function<? super Long, ? extends Character> f) {
		...
		if (f instanceof java.util.function.LongToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToChar(((java.util.function.LongToIntFunction)f).applyAsInt(key));
