...
public class Long2ByteRBTreeMap extends AbstractLong2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() {
			final Comparator<? super Long2ByteMap.Entry> comparator = (Long2ByteRBTreeMap.this.actualComparator == null ? (Comparator<Long2ByteMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2ByteMap.Entry>)(x, y) -> Long2ByteRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ByteRBTreeMap.this.compare(k, from) >= 0) && (top || Long2ByteRBTreeMap.this.compare(k, to) < 0);
		}
