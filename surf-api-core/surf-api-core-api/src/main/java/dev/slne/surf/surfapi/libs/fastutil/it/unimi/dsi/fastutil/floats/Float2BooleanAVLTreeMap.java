	...
	*/
	...
	public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>() {
			final Comparator<? super Float2BooleanMap.Entry> comparator = (Float2BooleanAVLTreeMap.this.actualComparator == null ? (Comparator<Float2BooleanMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2BooleanMap.Entry>)(x, y) -> Float2BooleanAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
			...
			public boolean contains(final Object o) {
				...
				if (!(e.getKey() instanceof Float)) return false;
	...
	private final class Submap extends AbstractFloat2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2BooleanAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2BooleanAVLTreeMap.this.compare(k, to) < 0);
		}
