 ...
 */
public interface DoubleBooleanPair extends it.unimi.dsi.fastutil.Pair<Double, Boolean> {
	/**
	 ...
	 */
	public default DoubleBooleanPair left(final double l) {
	 ...
	 */
	public default DoubleBooleanPair first(final double l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default DoubleBooleanPair key(final double l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default DoubleBooleanPair key(Double l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default DoubleBooleanPair right(final boolean r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default DoubleBooleanPair right(final Boolean l) {
	 ...
	 */
	public default DoubleBooleanPair second(final boolean r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleBooleanPair second(final Boolean l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default DoubleBooleanPair value(final boolean r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleBooleanPair value(final Boolean l) {
	 ...
	 */
	public static DoubleBooleanPair of(final double left, final boolean right) {
	...
	public static java.util.Comparator<DoubleBooleanPair> lexComparator() {
		return (x, y) -> {
