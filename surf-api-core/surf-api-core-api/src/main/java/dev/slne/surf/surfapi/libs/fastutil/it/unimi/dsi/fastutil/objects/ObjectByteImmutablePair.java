 ...
 */
public class ObjectByteImmutablePair<K> implements ObjectBytePair<K>, java.io.Serializable {
	 ...
	 */
	public ObjectByteImmutablePair(final K left, final byte right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ObjectByteImmutablePair<K> of(final K left, final byte right) {
