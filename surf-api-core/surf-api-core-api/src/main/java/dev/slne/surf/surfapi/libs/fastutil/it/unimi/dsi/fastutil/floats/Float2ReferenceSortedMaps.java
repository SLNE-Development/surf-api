...
public final class Float2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Float2ReferenceMaps.Singleton<V> implements Float2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Float2ReferenceMaps.SynchronizedMap<V> implements Float2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Float2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Float2ReferenceMaps.UnmodifiableMap<V> implements Float2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Float2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2ReferenceEntrySet());
			return (ObjectSortedSet<Float2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Float2ReferenceSortedMap<V> unmodifiable(final Float2ReferenceSortedMap<? extends V> m) {
