...
public final class Long2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractLong2ReferenceFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Long2ReferenceFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final long k, final V defaultValue) {
			return ((Long2ReferenceFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Long2ReferenceFunction<V> unmodifiable(final Long2ReferenceFunction<? extends V> f) {
