 ...
 */
public class ReferenceFloatImmutablePair<K> implements ReferenceFloatPair<K>, java.io.Serializable {
	 ...
	 */
	public ReferenceFloatImmutablePair(final K left, final float right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ReferenceFloatImmutablePair<K> of(final K left, final float right) {
