 ...
 */
public interface DoubleShortPair extends it.unimi.dsi.fastutil.Pair<Double, Short> {
	/**
	 ...
	 */
	public default DoubleShortPair left(final double l) {
	 ...
	 */
	public default DoubleShortPair first(final double l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default DoubleShortPair key(final double l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default DoubleShortPair key(Double l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default DoubleShortPair right(final short r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default DoubleShortPair right(final Short l) {
	 ...
	 */
	public default DoubleShortPair second(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleShortPair second(final Short l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default DoubleShortPair value(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleShortPair value(final Short l) {
	 ...
	 */
	public static DoubleShortPair of(final double left, final short right) {
	...
	public static java.util.Comparator<DoubleShortPair> lexComparator() {
		return (x, y) -> {
