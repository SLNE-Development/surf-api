	...
	*/
	...
	public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>() {
			final Comparator<? super Short2DoubleMap.Entry> comparator = (Short2DoubleAVLTreeMap.this.actualComparator == null ? (Comparator<Short2DoubleMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2DoubleMap.Entry>)(x, y) -> Short2DoubleAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2DoubleAVLTreeMap.this.compare(k, from) >= 0) && (top || Short2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
