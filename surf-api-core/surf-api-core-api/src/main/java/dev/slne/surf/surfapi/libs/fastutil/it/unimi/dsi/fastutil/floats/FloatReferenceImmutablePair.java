 ...
 */
public class FloatReferenceImmutablePair<V> implements FloatReferencePair<V>, java.io.Serializable {
	 ...
	 */
	public FloatReferenceImmutablePair(final float left, final V right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <V> FloatReferenceImmutablePair<V> of(final float left, final V right) {
