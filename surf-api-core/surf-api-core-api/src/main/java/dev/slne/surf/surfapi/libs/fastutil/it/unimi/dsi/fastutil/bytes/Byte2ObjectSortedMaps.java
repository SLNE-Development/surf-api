...
public final class Byte2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Byte2ObjectMaps.Singleton<V> implements Byte2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Byte2ObjectMaps.SynchronizedMap<V> implements Byte2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Byte2ObjectMaps.UnmodifiableMap<V> implements Byte2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Byte2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2ObjectEntrySet());
			return (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Byte2ObjectSortedMap<V> unmodifiable(final Byte2ObjectSortedMap<? extends V> m) {
