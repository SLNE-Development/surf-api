...
public final class Byte2FloatSortedMaps {
	...
	public static class Singleton extends Byte2FloatMaps.Singleton implements Byte2FloatSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2FloatMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Byte2FloatMaps.SynchronizedMap implements Byte2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2FloatEntrySet(), sync);
			return (ObjectSortedSet<Byte2FloatMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2FloatMaps.UnmodifiableMap implements Byte2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2FloatEntrySet());
			return (ObjectSortedSet<Byte2FloatMap.Entry>)entries;
		}
