...
public interface Object2ReferenceMap<K, V> extends Object2ReferenceFunction<K, V>, Map<K, V> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super V> consumer) {
		final ObjectSet<Object2ReferenceMap.Entry<K, V>> entrySet = object2ReferenceEntrySet();
		final Consumer<Object2ReferenceMap.Entry<K, V>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), (entry.getValue()));
	 ...
	 * @since 8.0.0
	 */
	default V computeIfAbsent(final K key, final Object2ReferenceFunction<? super K, ? extends V> mappingFunction) {
	 ...
	 */
	@Deprecated
	default V computeReferenceIfAbsentPartial(final K key, final Object2ReferenceFunction<? super K, ? extends V> mappingFunction) {
