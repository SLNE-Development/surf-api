...
public final class Long2FloatSortedMaps {
	...
	public static class Singleton extends Long2FloatMaps.Singleton implements Long2FloatSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2FloatMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Long2FloatMaps.SynchronizedMap implements Long2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2FloatEntrySet(), sync);
			return (ObjectSortedSet<Long2FloatMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2FloatMaps.UnmodifiableMap implements Long2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2FloatEntrySet());
			return (ObjectSortedSet<Long2FloatMap.Entry>)entries;
		}
