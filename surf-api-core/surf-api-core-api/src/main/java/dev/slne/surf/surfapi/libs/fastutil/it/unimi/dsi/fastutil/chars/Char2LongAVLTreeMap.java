	...
	*/
	...
	public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2LongMap.Entry>() {
			final Comparator<? super Char2LongMap.Entry> comparator = (Char2LongAVLTreeMap.this.actualComparator == null ? (Comparator<Char2LongMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2LongMap.Entry>)(x, y) -> Char2LongAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2LongAVLTreeMap.this.compare(k, from) >= 0) && (top || Char2LongAVLTreeMap.this.compare(k, to) < 0);
		}
