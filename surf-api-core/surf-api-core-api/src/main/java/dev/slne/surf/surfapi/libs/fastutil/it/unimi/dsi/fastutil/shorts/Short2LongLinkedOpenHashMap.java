...
public class Short2LongLinkedOpenHashMap extends AbstractShort2LongSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2LongMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Short2LongMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractShortSortedSet {
		...
		public ShortSpliterator spliterator() {
			return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public LongCollection values() {
		if (values == null) values = new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
