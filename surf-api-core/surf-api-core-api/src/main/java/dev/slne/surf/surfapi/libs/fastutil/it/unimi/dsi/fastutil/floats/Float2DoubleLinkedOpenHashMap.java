...
public class Float2DoubleLinkedOpenHashMap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2DoubleMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Float2DoubleMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractFloatSortedSet {
		...
		public FloatSpliterator spliterator() {
			return FloatSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public DoubleCollection values() {
		if (values == null) values = new AbstractDoubleCollection() {
			...
			public DoubleSpliterator spliterator() {
				return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
