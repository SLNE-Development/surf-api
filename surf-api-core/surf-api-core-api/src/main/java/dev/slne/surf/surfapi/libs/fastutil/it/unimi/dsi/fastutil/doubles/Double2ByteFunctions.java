...
public final class Double2ByteFunctions {
	...
	public static Double2ByteFunction primitive(final java.util.function.Function<? super Double, ? extends Byte> f) {
		...
		if (f instanceof java.util.function.DoubleToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToByte(((java.util.function.DoubleToIntFunction)f).applyAsInt(key));
