...
public class Double2FloatRBTreeMap extends AbstractDouble2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>() {
			final Comparator<? super Double2FloatMap.Entry> comparator = (Double2FloatRBTreeMap.this.actualComparator == null ? (Comparator<Double2FloatMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2FloatMap.Entry>)(x, y) -> Double2FloatRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2FloatRBTreeMap.this.compare(k, from) >= 0) && (top || Double2FloatRBTreeMap.this.compare(k, to) < 0);
		}
