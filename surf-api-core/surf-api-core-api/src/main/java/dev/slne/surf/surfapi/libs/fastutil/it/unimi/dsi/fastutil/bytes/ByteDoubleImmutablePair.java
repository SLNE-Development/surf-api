 ...
 */
public class ByteDoubleImmutablePair implements ByteDoublePair, java.io.Serializable {
	 ...
	 */
	public ByteDoubleImmutablePair(final byte left, final double right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static ByteDoubleImmutablePair of(final byte left, final double right) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof ByteDoublePair) {
			return left == ((ByteDoublePair)other).leftByte() && right == ((ByteDoublePair)other).rightDouble();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Byte.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && java.util.Objects.equals(Double.valueOf(right), ((it.unimi.dsi.fastutil.Pair)other).right());
		}
		return false;
	}
