...
public record Pair<A, B>(A a, B b) implements Map.Entry<A, B> {
   ...
   *
   * <p>
   * The hash code is computed by combining the hash codes of the key and value using the following
   * formula:
   * </p>
   * <p>
   * {@snippet :
   ...
   * <p>
   * The string representation includes the values of the key and value elements of the Pair object
   * in the format "Pair[a=value, b=value]".
   *
