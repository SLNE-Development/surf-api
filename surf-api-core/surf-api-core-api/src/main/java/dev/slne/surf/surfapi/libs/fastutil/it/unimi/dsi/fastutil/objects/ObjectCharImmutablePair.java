 ...
 */
public class ObjectCharImmutablePair<K> implements ObjectCharPair<K>, java.io.Serializable {
	 ...
	 */
	public ObjectCharImmutablePair(final K left, final char right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ObjectCharImmutablePair<K> of(final K left, final char right) {
