...
public final class Reference2LongFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2LongFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2LongFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public long getOrDefault(final Object k, final long defaultValue) {
			return ((Reference2LongFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2LongFunction<K> unmodifiable(final Reference2LongFunction<? extends K> f) {
