...
public final class Double2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractDouble2ReferenceFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Double2ReferenceFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final double k, final V defaultValue) {
			return ((Double2ReferenceFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Double2ReferenceFunction<V> unmodifiable(final Double2ReferenceFunction<? extends V> f) {
