...
public final class Reference2ObjectSortedMaps {
	...
	public static class Singleton<K, V> extends Reference2ObjectMaps.Singleton<K, V> implements Reference2ObjectSortedMap<K, V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K, V> extends Reference2ObjectMaps.SynchronizedMap<K, V> implements Reference2ObjectSortedMap<K, V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.reference2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Reference2ObjectMap.Entry<K, V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K, V> extends Reference2ObjectMaps.UnmodifiableMap<K, V> implements Reference2ObjectSortedMap<K, V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Reference2ObjectSortedMap<K, ? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.reference2ObjectEntrySet());
			return (ObjectSortedSet<Reference2ObjectMap.Entry<K, V>>)entries;
		}
	 ...
	 */
	public static <K, V> Reference2ObjectSortedMap<K, V> unmodifiable(final Reference2ObjectSortedMap<K, ? extends V> m) {
