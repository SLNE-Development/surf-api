	...
	*/
	...
	public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>() {
			final Comparator<? super Byte2ShortMap.Entry> comparator = (Byte2ShortAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2ShortMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2ShortMap.Entry>)(x, y) -> Byte2ShortAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2ShortAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2ShortAVLTreeMap.this.compare(k, to) < 0);
		}
