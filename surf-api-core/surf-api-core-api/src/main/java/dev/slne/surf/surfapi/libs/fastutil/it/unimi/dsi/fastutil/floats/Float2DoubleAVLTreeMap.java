	...
	*/
	...
	public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>() {
			final Comparator<? super Float2DoubleMap.Entry> comparator = (Float2DoubleAVLTreeMap.this.actualComparator == null ? (Comparator<Float2DoubleMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2DoubleMap.Entry>)(x, y) -> Float2DoubleAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2DoubleAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
