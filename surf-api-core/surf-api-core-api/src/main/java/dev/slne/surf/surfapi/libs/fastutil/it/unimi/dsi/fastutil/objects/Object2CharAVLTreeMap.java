	...
	*/
	...
	public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
			final Comparator<? super Object2CharMap.Entry<K>> comparator = (Object2CharAVLTreeMap.this.actualComparator == null ? (Comparator<Object2CharMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2CharMap.Entry<K>>)(x, y) -> Object2CharAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2CharSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2CharAVLTreeMap.this.compare(k, from) >= 0) && (top || Object2CharAVLTreeMap.this.compare(k, to) < 0);
		}
