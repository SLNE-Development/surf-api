...
public class Short2ShortRBTreeMap extends AbstractShort2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>() {
			final Comparator<? super Short2ShortMap.Entry> comparator = (Short2ShortRBTreeMap.this.actualComparator == null ? (Comparator<Short2ShortMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2ShortMap.Entry>)(x, y) -> Short2ShortRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2ShortRBTreeMap.this.compare(k, from) >= 0) && (top || Short2ShortRBTreeMap.this.compare(k, to) < 0);
		}
