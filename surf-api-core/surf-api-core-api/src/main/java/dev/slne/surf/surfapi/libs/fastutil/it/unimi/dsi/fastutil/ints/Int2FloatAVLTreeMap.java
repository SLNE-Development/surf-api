	...
	*/
	...
	public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() {
			final Comparator<? super Int2FloatMap.Entry> comparator = (Int2FloatAVLTreeMap.this.actualComparator == null ? (Comparator<Int2FloatMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2FloatMap.Entry>)(x, y) -> Int2FloatAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2FloatAVLTreeMap.this.compare(k, from) >= 0) && (top || Int2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
