...
public final class ShortSortedSets {
	...
	public static class Singleton extends ShortSets.Singleton implements ShortSortedSet, java.io.Serializable, Cloneable {
		...
		public ShortSpliterator spliterator() {
			return ShortSpliterators.singleton(element, comparator);
		}
		...
		public IntSpliterator intSpliterator() {
			return IntSpliterators.singleton(element, (int left, int right) -> comparator().compare(it.unimi.dsi.fastutil.SafeMath.safeIntToShort(left), it.unimi.dsi.fastutil.SafeMath.safeIntToShort(right)));
		}
