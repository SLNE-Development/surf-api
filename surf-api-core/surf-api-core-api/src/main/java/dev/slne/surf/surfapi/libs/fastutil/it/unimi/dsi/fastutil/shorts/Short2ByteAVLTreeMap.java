	...
	*/
	...
	public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>() {
			final Comparator<? super Short2ByteMap.Entry> comparator = (Short2ByteAVLTreeMap.this.actualComparator == null ? (Comparator<Short2ByteMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2ByteMap.Entry>)(x, y) -> Short2ByteAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2ByteAVLTreeMap.this.compare(k, from) >= 0) && (top || Short2ByteAVLTreeMap.this.compare(k, to) < 0);
		}
