...
public interface Object2ShortMap<K> extends Object2ShortFunction<K>, Map<K, Short> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super Short> consumer) {
		final ObjectSet<Object2ShortMap.Entry<K>> entrySet = object2ShortEntrySet();
		final Consumer<Object2ShortMap.Entry<K>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), Short.valueOf(entry.getShortValue()));
