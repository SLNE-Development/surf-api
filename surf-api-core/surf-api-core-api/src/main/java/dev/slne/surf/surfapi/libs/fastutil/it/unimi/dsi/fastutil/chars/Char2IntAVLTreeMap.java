	...
	*/
	...
	public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
			final Comparator<? super Char2IntMap.Entry> comparator = (Char2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Char2IntMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2IntMap.Entry>)(x, y) -> Char2IntAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2IntAVLTreeMap.this.compare(k, from) >= 0) && (top || Char2IntAVLTreeMap.this.compare(k, to) < 0);
		}
