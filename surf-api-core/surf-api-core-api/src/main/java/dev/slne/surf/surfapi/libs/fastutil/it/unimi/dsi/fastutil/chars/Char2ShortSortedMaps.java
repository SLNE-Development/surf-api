...
public final class Char2ShortSortedMaps {
	...
	public static class Singleton extends Char2ShortMaps.Singleton implements Char2ShortSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2ShortMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Char2ShortMaps.SynchronizedMap implements Char2ShortSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2ShortEntrySet(), sync);
			return (ObjectSortedSet<Char2ShortMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2ShortMaps.UnmodifiableMap implements Char2ShortSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2ShortEntrySet());
			return (ObjectSortedSet<Char2ShortMap.Entry>)entries;
		}
