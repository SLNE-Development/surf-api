...
public class Char2FloatRBTreeMap extends AbstractChar2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
			final Comparator<? super Char2FloatMap.Entry> comparator = (Char2FloatRBTreeMap.this.actualComparator == null ? (Comparator<Char2FloatMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2FloatMap.Entry>)(x, y) -> Char2FloatRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2FloatRBTreeMap.this.compare(k, from) >= 0) && (top || Char2FloatRBTreeMap.this.compare(k, to) < 0);
		}
