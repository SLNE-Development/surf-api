...
public final class Object2BooleanMaps {
	...
	public static class Singleton<K> extends Object2BooleanFunctions.Singleton<K> implements Object2BooleanMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2BooleanMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2BooleanFunctions.SynchronizedFunction<K> implements Object2BooleanMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2BooleanEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2BooleanFunctions.UnmodifiableFunction<K> implements Object2BooleanMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2BooleanMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2BooleanEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public boolean getOrDefault(final Object key, final boolean defaultValue) {
			return ((Object2BooleanMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Object2BooleanMap<K> unmodifiable(final Object2BooleanMap<? extends K> m) {
