 ...
 */
public class BooleanReferenceMutablePair<V> implements BooleanReferencePair<V>, java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof BooleanReferencePair) {
			return left == ((BooleanReferencePair)other).leftBoolean() && right == ((BooleanReferencePair)other).right();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Boolean.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && right == ((it.unimi.dsi.fastutil.Pair)other).right();
		}
		return false;
	}
