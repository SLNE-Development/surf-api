...
public class Long2ShortLinkedOpenHashMap extends AbstractLong2ShortSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2ShortMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Long2ShortMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractLongSortedSet {
		...
		public LongSpliterator spliterator() {
			return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ShortCollection values() {
		if (values == null) values = new AbstractShortCollection() {
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
