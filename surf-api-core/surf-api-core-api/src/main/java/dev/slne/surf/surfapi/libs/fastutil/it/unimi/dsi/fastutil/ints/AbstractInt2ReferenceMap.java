	...
	public IntSet keySet() {
		return new AbstractIntSet() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), sizeOf(AbstractInt2ReferenceMap.this), IntSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public ReferenceCollection<V> values() {
		return new AbstractReferenceCollection<V>() {
			...
			public ObjectSpliterator<V> spliterator() {
				return ObjectSpliterators.asSpliterator(iterator(), sizeOf(AbstractInt2ReferenceMap.this), ObjectSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
