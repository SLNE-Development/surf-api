	...
	*/
	...
	public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>() {
			final Comparator<? super Short2ReferenceMap.Entry<V>> comparator = (Short2ReferenceAVLTreeMap.this.actualComparator == null ? (Comparator<Short2ReferenceMap.Entry<V>>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2ReferenceMap.Entry<V>>)(x, y) -> Short2ReferenceAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2ReferenceAVLTreeMap.this.compare(k, from) >= 0) && (top || Short2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
