...
public final class Char2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Char2ObjectMaps.Singleton<V> implements Char2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Char2ObjectMaps.SynchronizedMap<V> implements Char2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Char2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Char2ObjectMaps.UnmodifiableMap<V> implements Char2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Char2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2ObjectEntrySet());
			return (ObjectSortedSet<Char2ObjectMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Char2ObjectSortedMap<V> unmodifiable(final Char2ObjectSortedMap<? extends V> m) {
