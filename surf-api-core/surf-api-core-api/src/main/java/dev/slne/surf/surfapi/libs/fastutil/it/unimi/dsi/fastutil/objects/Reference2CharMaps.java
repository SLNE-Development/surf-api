...
public final class Reference2CharMaps {
	...
	public static class EmptyMap<K> extends Reference2CharFunctions.EmptyFunction<K> implements Reference2CharMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super K, ? super Character> consumer) {
		}
	...
	public static class Singleton<K> extends Reference2CharFunctions.Singleton<K> implements Reference2CharMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractReference2CharMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2CharFunctions.SynchronizedFunction<K> implements Reference2CharMap<K>, java.io.Serializable {
		...
		public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.reference2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsent(final K key, final java.util.function.ToIntFunction<? super K> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsent(final K key, final Reference2CharFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Override
		public char merge(final K key, final char value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Character computeIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Character compute(final K key, final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Character merge(final K key, final Character value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<K> extends Reference2CharFunctions.UnmodifiableFunction<K> implements Reference2CharMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Reference2CharMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2CharEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public char getOrDefault(final Object key, final char defaultValue) {
			return ((Reference2CharMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2CharMap<K> unmodifiable(final Reference2CharMap<? extends K> m) {
