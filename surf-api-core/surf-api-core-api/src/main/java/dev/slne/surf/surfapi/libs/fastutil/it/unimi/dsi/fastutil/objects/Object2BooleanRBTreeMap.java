...
public class Object2BooleanRBTreeMap<K> extends AbstractObject2BooleanSortedMap<K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
			final Comparator<? super Object2BooleanMap.Entry<K>> comparator = (Object2BooleanRBTreeMap.this.actualComparator == null ? (Comparator<Object2BooleanMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2BooleanMap.Entry<K>>)(x, y) -> Object2BooleanRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2BooleanSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2BooleanRBTreeMap.this.compare(k, from) >= 0) && (top || Object2BooleanRBTreeMap.this.compare(k, to) < 0);
		}
