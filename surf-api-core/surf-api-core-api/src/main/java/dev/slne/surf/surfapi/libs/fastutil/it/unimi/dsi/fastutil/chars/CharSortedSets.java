...
public final class CharSortedSets {
	...
	public static class Singleton extends CharSets.Singleton implements CharSortedSet, java.io.Serializable, Cloneable {
		...
		public CharSpliterator spliterator() {
			return CharSpliterators.singleton(element, comparator);
		}
		...
		public IntSpliterator intSpliterator() {
			return IntSpliterators.singleton(element, (int left, int right) -> comparator().compare(it.unimi.dsi.fastutil.SafeMath.safeIntToChar(left), it.unimi.dsi.fastutil.SafeMath.safeIntToChar(right)));
		}
