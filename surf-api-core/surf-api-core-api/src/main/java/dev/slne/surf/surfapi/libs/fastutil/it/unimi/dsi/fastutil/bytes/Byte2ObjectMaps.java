...
public final class Byte2ObjectMaps {
	...
	public static class Singleton<V> extends Byte2ObjectFunctions.Singleton<V> implements Byte2ObjectMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractByte2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Byte2ObjectFunctions.SynchronizedFunction<V> implements Byte2ObjectMap<V>, java.io.Serializable {
		...
		public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.byte2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Byte2ObjectFunctions.UnmodifiableFunction<V> implements Byte2ObjectMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.byte2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final byte key, final V defaultValue) {
			return ((Byte2ObjectMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Byte2ObjectMap<V> unmodifiable(final Byte2ObjectMap<? extends V> m) {
