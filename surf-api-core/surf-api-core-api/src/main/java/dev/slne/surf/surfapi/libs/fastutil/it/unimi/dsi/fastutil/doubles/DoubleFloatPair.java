 ...
 */
public interface DoubleFloatPair extends it.unimi.dsi.fastutil.Pair<Double, Float> {
	/**
	 ...
	 */
	public default DoubleFloatPair left(final double l) {
	 ...
	 */
	public default DoubleFloatPair first(final double l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default DoubleFloatPair key(final double l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default DoubleFloatPair key(Double l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default DoubleFloatPair right(final float r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default DoubleFloatPair right(final Float l) {
	 ...
	 */
	public default DoubleFloatPair second(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleFloatPair second(final Float l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default DoubleFloatPair value(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleFloatPair value(final Float l) {
	 ...
	 */
	public static DoubleFloatPair of(final double left, final float right) {
	...
	public static java.util.Comparator<DoubleFloatPair> lexComparator() {
		return (x, y) -> {
