...
public final class Byte2BooleanSortedMaps {
	...
	public static class Singleton extends Byte2BooleanMaps.Singleton implements Byte2BooleanSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2BooleanMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Byte2BooleanMaps.SynchronizedMap implements Byte2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Byte2BooleanMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2BooleanMaps.UnmodifiableMap implements Byte2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2BooleanEntrySet());
			return (ObjectSortedSet<Byte2BooleanMap.Entry>)entries;
		}
