...
public class Short2ByteLinkedOpenHashMap extends AbstractShort2ByteSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2ByteMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Short2ByteMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractShortSortedSet {
		...
		public ShortSpliterator spliterator() {
			return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ByteCollection values() {
		if (values == null) values = new AbstractByteCollection() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
