 ...
 */
public class DoubleFloatMutablePair implements DoubleFloatPair, java.io.Serializable {
	 ...
	 */
	public DoubleFloatMutablePair(final double left, final float right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static DoubleFloatMutablePair of(final double left, final float right) {
	...
	@Override
	public DoubleFloatMutablePair left(final double l) {
		left = l;
		return this;
	}
	...
	@Override
	public DoubleFloatMutablePair right(final float r) {
		right = r;
		return this;
	}
