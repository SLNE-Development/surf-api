...
public final class Int2CharMaps {
	...
	public static class EmptyMap extends Int2CharFunctions.EmptyFunction implements Int2CharMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Character> consumer) {
		}
	...
	public static class Singleton extends Int2CharFunctions.Singleton implements Int2CharMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractInt2CharMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2CharFunctions.SynchronizedFunction implements Int2CharMap, java.io.Serializable {
		...
		public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.int2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Character> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsent(final int key, final Int2CharFunction mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character merge(final Integer key, final Character value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Int2CharFunctions.UnmodifiableFunction implements Int2CharMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.int2CharEntrySet());
			return entries;
		}
