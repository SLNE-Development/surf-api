...
@CanBeSpawned
public interface PacketFireworkRocket extends PacketEntity<PacketFireworkRocket>, Shootable, Spawnable {
    ...
    /**
     * Entity ID of the entity wich used the firework (for elytra boosting) or {@code -1} if not present
     *
    ...
    /**
     * Sets the Entity ID of the entity wich used the firework (for elytra boosting) or {@code -1} if not present
     *
