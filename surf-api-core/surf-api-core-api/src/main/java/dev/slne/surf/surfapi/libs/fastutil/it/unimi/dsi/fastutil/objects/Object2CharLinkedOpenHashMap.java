...
public class Object2CharLinkedOpenHashMap<K> extends AbstractObject2CharSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2CharMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Object2CharMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public CharCollection values() {
		if (values == null) values = new AbstractCharCollection() {
			...
			public CharSpliterator spliterator() {
				return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
