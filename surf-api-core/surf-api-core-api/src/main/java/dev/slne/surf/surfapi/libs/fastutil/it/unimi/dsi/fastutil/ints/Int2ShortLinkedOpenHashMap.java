...
public class Int2ShortLinkedOpenHashMap extends AbstractInt2ShortSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2ShortMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Int2ShortMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractIntSortedSet {
		...
		public IntSpliterator spliterator() {
			return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ShortCollection values() {
		if (values == null) values = new AbstractShortCollection() {
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
