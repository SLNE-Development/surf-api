 ...
 */
public class LongFloatImmutablePair implements LongFloatPair, java.io.Serializable {
	 ...
	 */
	public LongFloatImmutablePair(final long left, final float right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static LongFloatImmutablePair of(final long left, final float right) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof LongFloatPair) {
			return left == ((LongFloatPair)other).leftLong() && right == ((LongFloatPair)other).rightFloat();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Long.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && java.util.Objects.equals(Float.valueOf(right), ((it.unimi.dsi.fastutil.Pair)other).right());
		}
		return false;
	}
