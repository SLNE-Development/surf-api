 ...
 */
public class LongCharImmutablePair implements LongCharPair, java.io.Serializable {
	 ...
	 */
	public LongCharImmutablePair(final long left, final char right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static LongCharImmutablePair of(final long left, final char right) {
