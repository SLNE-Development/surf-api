	...
	*/
	...
	public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2LongMap.Entry>() {
			final Comparator<? super Float2LongMap.Entry> comparator = (Float2LongAVLTreeMap.this.actualComparator == null ? (Comparator<Float2LongMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2LongMap.Entry>)(x, y) -> Float2LongAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2LongAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2LongAVLTreeMap.this.compare(k, to) < 0);
		}
