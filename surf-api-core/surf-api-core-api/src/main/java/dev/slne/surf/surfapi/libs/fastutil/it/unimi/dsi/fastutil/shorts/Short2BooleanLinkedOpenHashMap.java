...
public class Short2BooleanLinkedOpenHashMap extends AbstractShort2BooleanSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2BooleanMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Short2BooleanMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractShortSortedSet {
		...
		public ShortSpliterator spliterator() {
			return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public BooleanCollection values() {
		if (values == null) values = new AbstractBooleanCollection() {
			...
			public BooleanSpliterator spliterator() {
				return BooleanSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
