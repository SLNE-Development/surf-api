 ...
 */
public interface ObjectLongPair<K> extends it.unimi.dsi.fastutil.Pair<K, Long> {
	/**
	 ...
	 */
	public default ObjectLongPair<K> right(final long r) {
	...
	@Deprecated
	@Override
	public default ObjectLongPair<K> right(final Long l) {
	 ...
	 */
	public default ObjectLongPair<K> second(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectLongPair<K> second(final Long l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ObjectLongPair<K> value(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectLongPair<K> value(final Long l) {
	 ...
	 */
	public static <K> ObjectLongPair<K> of(final K left, final long right) {
	...
	public static <K> java.util.Comparator<ObjectLongPair<K>> lexComparator() {
		return (x, y) -> {
