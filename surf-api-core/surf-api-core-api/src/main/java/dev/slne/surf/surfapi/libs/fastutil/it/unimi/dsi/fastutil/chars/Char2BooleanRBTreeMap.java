...
public class Char2BooleanRBTreeMap extends AbstractChar2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>() {
			final Comparator<? super Char2BooleanMap.Entry> comparator = (Char2BooleanRBTreeMap.this.actualComparator == null ? (Comparator<Char2BooleanMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2BooleanMap.Entry>)(x, y) -> Char2BooleanRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2BooleanRBTreeMap.this.compare(k, from) >= 0) && (top || Char2BooleanRBTreeMap.this.compare(k, to) < 0);
		}
