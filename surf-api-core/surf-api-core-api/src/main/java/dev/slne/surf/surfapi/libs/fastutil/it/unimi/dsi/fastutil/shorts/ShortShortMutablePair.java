 ...
 */
public class ShortShortMutablePair implements ShortShortPair, java.io.Serializable {
	 ...
	 */
	public ShortShortMutablePair(final short left, final short right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static ShortShortMutablePair of(final short left, final short right) {
	...
	@Override
	public ShortShortMutablePair left(final short l) {
		left = l;
		return this;
	}
	...
	@Override
	public ShortShortMutablePair right(final short r) {
		right = r;
		return this;
	}
