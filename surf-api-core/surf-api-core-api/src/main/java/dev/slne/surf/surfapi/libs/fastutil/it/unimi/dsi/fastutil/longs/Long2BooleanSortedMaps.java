...
public final class Long2BooleanSortedMaps {
	...
	public static class Singleton extends Long2BooleanMaps.Singleton implements Long2BooleanSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2BooleanMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Long2BooleanMaps.SynchronizedMap implements Long2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Long2BooleanMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2BooleanMaps.UnmodifiableMap implements Long2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2BooleanEntrySet());
			return (ObjectSortedSet<Long2BooleanMap.Entry>)entries;
		}
