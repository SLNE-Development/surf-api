	...
	public ReferenceSet<K> keySet() {
		return new AbstractReferenceSet<K>() {
			...
			public ObjectSpliterator<K> spliterator() {
				return ObjectSpliterators.asSpliterator(iterator(), sizeOf(AbstractReference2ByteMap.this), ObjectSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public ByteCollection values() {
		return new AbstractByteCollection() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), sizeOf(AbstractReference2ByteMap.this), ByteSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
