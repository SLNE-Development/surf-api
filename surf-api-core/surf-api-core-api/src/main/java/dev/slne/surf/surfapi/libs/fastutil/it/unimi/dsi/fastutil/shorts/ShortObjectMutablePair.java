 ...
 */
public class ShortObjectMutablePair<V> implements ShortObjectPair<V>, java.io.Serializable {
	 ...
	 */
	public ShortObjectMutablePair(final short left, final V right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <V> ShortObjectMutablePair<V> of(final short left, final V right) {
	...
	@Override
	public ShortObjectMutablePair<V> left(final short l) {
		left = l;
		return this;
	}
	...
	@Override
	public ShortObjectMutablePair<V> right(final V r) {
		right = r;
		return this;
	}
