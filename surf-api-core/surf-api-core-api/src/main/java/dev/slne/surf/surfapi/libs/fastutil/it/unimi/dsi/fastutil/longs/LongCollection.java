...
public interface LongCollection extends Collection<Long>, LongIterable {
	...
	default LongSpliterator spliterator() {
		return LongSpliterators.asSpliterator(iterator(), sizeOf(this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	}
	...
	default boolean removeIf(final java.util.function.Predicate<? super Long> filter) {
		return removeIf(filter instanceof java.util.function.LongPredicate ? ((java.util.function.LongPredicate)filter) : (java.util.function.LongPredicate)key -> filter.test(Long.valueOf(key)));
	}
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Long> stream() {
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Long> parallelStream() {
	 ...
	 * @see java.util.stream.IntStream
	 */
	default java.util.stream.LongStream longParallelStream() {
