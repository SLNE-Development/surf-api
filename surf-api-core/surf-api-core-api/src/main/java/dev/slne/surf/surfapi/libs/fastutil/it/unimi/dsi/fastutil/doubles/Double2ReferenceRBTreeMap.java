...
public class Double2ReferenceRBTreeMap<V> extends AbstractDouble2ReferenceSortedMap<V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2ReferenceMap.Entry<V>>() {
			final Comparator<? super Double2ReferenceMap.Entry<V>> comparator = (Double2ReferenceRBTreeMap.this.actualComparator == null ? (Comparator<Double2ReferenceMap.Entry<V>>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2ReferenceMap.Entry<V>>)(x, y) -> Double2ReferenceRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ReferenceRBTreeMap.this.compare(k, from) >= 0) && (top || Double2ReferenceRBTreeMap.this.compare(k, to) < 0);
		}
