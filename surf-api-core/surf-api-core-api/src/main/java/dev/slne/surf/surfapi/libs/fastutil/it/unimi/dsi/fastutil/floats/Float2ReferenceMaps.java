...
public final class Float2ReferenceMaps {
	...
	public static class EmptyMap<V> extends Float2ReferenceFunctions.EmptyFunction<V> implements Float2ReferenceMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super V> consumer) {
		}
	...
	public static class Singleton<V> extends Float2ReferenceFunctions.Singleton<V> implements Float2ReferenceMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Float2ReferenceFunctions.SynchronizedFunction<V> implements Float2ReferenceMap<V>, java.io.Serializable {
		...
		public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.float2ReferenceEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public V computeIfAbsent(final float key, final java.util.function.DoubleFunction<? extends V> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<V> extends Float2ReferenceFunctions.UnmodifiableFunction<V> implements Float2ReferenceMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Float2ReferenceMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2ReferenceEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final float key, final V defaultValue) {
			return ((Float2ReferenceMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Float2ReferenceMap<V> unmodifiable(final Float2ReferenceMap<? extends V> m) {
