 ...
 */
public class ShortLongImmutablePair implements ShortLongPair, java.io.Serializable {
	 ...
	 */
	public ShortLongImmutablePair(final short left, final long right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static ShortLongImmutablePair of(final short left, final long right) {
