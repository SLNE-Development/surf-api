 ...
 */
public class LongByteImmutablePair implements LongBytePair, java.io.Serializable {
	 ...
	 */
	public LongByteImmutablePair(final long left, final byte right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static LongByteImmutablePair of(final long left, final byte right) {
