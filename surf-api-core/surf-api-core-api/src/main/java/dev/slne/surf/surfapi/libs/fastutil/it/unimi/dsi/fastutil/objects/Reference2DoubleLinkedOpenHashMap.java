...
public class Reference2DoubleLinkedOpenHashMap<K> extends AbstractReference2DoubleSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2DoubleMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Reference2DoubleMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public DoubleCollection values() {
		if (values == null) values = new AbstractDoubleCollection() {
			...
			public DoubleSpliterator spliterator() {
				return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
