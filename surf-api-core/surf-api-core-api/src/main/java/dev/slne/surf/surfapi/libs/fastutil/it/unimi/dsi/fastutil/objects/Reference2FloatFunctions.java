...
public final class Reference2FloatFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2FloatFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2FloatFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public float getOrDefault(final Object k, final float defaultValue) {
			return ((Reference2FloatFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2FloatFunction<K> unmodifiable(final Reference2FloatFunction<? extends K> f) {
	...
	public static <K> Reference2FloatFunction<K> primitive(final java.util.function.Function<? super K, ? extends Float> f) {
		...
		if (f instanceof java.util.function.ToDoubleFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(((java.util.function.ToDoubleFunction<K>)f).applyAsDouble((K)(key)));
