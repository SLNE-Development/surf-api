	...
	*/
	...
	public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() {
			final Comparator<? super Long2ShortMap.Entry> comparator = (Long2ShortAVLTreeMap.this.actualComparator == null ? (Comparator<Long2ShortMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2ShortMap.Entry>)(x, y) -> Long2ShortAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ShortAVLTreeMap.this.compare(k, from) >= 0) && (top || Long2ShortAVLTreeMap.this.compare(k, to) < 0);
		}
