...
public final class Float2FloatMaps {
	...
	public static class Singleton extends Float2FloatFunctions.Singleton implements Float2FloatMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2FloatFunctions.SynchronizedFunction implements Float2FloatMap, java.io.Serializable {
		...
		public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.float2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Float> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Float2FloatFunctions.UnmodifiableFunction implements Float2FloatMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2FloatEntrySet());
			return entries;
		}
