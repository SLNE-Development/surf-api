...
public class Int2ByteRBTreeMap extends AbstractInt2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
			final Comparator<? super Int2ByteMap.Entry> comparator = (Int2ByteRBTreeMap.this.actualComparator == null ? (Comparator<Int2ByteMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2ByteMap.Entry>)(x, y) -> Int2ByteRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ByteRBTreeMap.this.compare(k, from) >= 0) && (top || Int2ByteRBTreeMap.this.compare(k, to) < 0);
		}
