...
public class Short2LongRBTreeMap extends AbstractShort2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() {
			final Comparator<? super Short2LongMap.Entry> comparator = (Short2LongRBTreeMap.this.actualComparator == null ? (Comparator<Short2LongMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2LongMap.Entry>)(x, y) -> Short2LongRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2LongRBTreeMap.this.compare(k, from) >= 0) && (top || Short2LongRBTreeMap.this.compare(k, to) < 0);
		}
