...
public final class Int2BooleanMaps {
	...
	public static class Singleton extends Int2BooleanFunctions.Singleton implements Int2BooleanMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractInt2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2BooleanFunctions.SynchronizedFunction implements Int2BooleanMap, java.io.Serializable {
		...
		public ObjectSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.int2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Boolean> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsent(final int key, final Int2BooleanFunction mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Boolean computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Boolean compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Boolean merge(final Integer key, final Boolean value, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Int2BooleanFunctions.UnmodifiableFunction implements Int2BooleanMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.int2BooleanEntrySet());
			return entries;
		}
