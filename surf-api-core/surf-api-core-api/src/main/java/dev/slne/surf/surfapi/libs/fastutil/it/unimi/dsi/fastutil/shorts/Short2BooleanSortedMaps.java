...
public final class Short2BooleanSortedMaps {
	...
	public static class Singleton extends Short2BooleanMaps.Singleton implements Short2BooleanSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2BooleanMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Short2BooleanMaps.SynchronizedMap implements Short2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Short2BooleanMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2BooleanMaps.UnmodifiableMap implements Short2BooleanSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2BooleanEntrySet());
			return (ObjectSortedSet<Short2BooleanMap.Entry>)entries;
		}
