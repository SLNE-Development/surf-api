...
public abstract class AbstractFloat2LongMap extends AbstractFloat2LongFunction implements Float2LongMap, java.io.Serializable {
	 ...
	 */
	@Override
	public final long mergeLong(final float key, final long value, final it.unimi.dsi.fastutil.longs.LongBinaryOperator remappingFunction) {
	...
	public FloatSet keySet() {
		return new AbstractFloatSet() {
			...
			public FloatSpliterator spliterator() {
				return FloatSpliterators.asSpliterator(iterator(), sizeOf(AbstractFloat2LongMap.this), FloatSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public LongCollection values() {
		return new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), sizeOf(AbstractFloat2LongMap.this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
