...
public interface Reference2DoubleMap<K> extends Reference2DoubleFunction<K>, Map<K, Double> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super Double> consumer) {
		final ObjectSet<Reference2DoubleMap.Entry<K>> entrySet = reference2DoubleEntrySet();
		final Consumer<Reference2DoubleMap.Entry<K>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), Double.valueOf(entry.getDoubleValue()));
