...
public final class Reference2IntFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2IntFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2IntFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public int getOrDefault(final Object k, final int defaultValue) {
			return ((Reference2IntFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2IntFunction<K> unmodifiable(final Reference2IntFunction<? extends K> f) {
