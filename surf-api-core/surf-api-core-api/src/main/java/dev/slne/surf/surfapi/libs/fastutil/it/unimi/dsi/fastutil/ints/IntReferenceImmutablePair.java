 ...
 */
public class IntReferenceImmutablePair<V> implements IntReferencePair<V>, java.io.Serializable {
	 ...
	 */
	public IntReferenceImmutablePair(final int left, final V right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <V> IntReferenceImmutablePair<V> of(final int left, final V right) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof IntReferencePair) {
			return left == ((IntReferencePair)other).leftInt() && right == ((IntReferencePair)other).right();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Integer.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && right == ((it.unimi.dsi.fastutil.Pair)other).right();
		}
		return false;
	}
