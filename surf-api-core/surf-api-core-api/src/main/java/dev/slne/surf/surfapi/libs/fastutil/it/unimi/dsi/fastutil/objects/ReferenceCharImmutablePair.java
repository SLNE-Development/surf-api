 ...
 */
public class ReferenceCharImmutablePair<K> implements ReferenceCharPair<K>, java.io.Serializable {
	 ...
	 */
	public ReferenceCharImmutablePair(final K left, final char right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ReferenceCharImmutablePair<K> of(final K left, final char right) {
