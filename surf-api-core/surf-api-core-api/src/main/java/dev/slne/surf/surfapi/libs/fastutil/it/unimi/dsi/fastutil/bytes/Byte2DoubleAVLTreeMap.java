	...
	*/
	...
	public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>() {
			final Comparator<? super Byte2DoubleMap.Entry> comparator = (Byte2DoubleAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2DoubleMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2DoubleMap.Entry>)(x, y) -> Byte2DoubleAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2DoubleAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
