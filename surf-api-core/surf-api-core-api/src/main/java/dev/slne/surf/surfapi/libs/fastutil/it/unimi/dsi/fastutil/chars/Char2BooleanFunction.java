/*
	...
	*/
package dev.slne.surf.surfapi.libs.fastutil.it.unimi.dsi.fastutil.chars;
...
public interface Char2BooleanFunction extends Function<Character, Boolean>, java.util.function.IntPredicate {
	...
	default it.unimi.dsi.fastutil.chars.Char2ByteFunction andThenByte(it.unimi.dsi.fastutil.booleans.Boolean2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2CharFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2ShortFunction andThenShort(it.unimi.dsi.fastutil.booleans.Boolean2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2BooleanFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2CharFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2IntFunction andThenInt(it.unimi.dsi.fastutil.booleans.Boolean2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2BooleanFunction composeInt(it.unimi.dsi.fastutil.ints.Int2CharFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2LongFunction andThenLong(it.unimi.dsi.fastutil.booleans.Boolean2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2BooleanFunction composeLong(it.unimi.dsi.fastutil.longs.Long2CharFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2CharFunction andThenChar(it.unimi.dsi.fastutil.booleans.Boolean2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2BooleanFunction composeChar(it.unimi.dsi.fastutil.chars.Char2CharFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2FloatFunction andThenFloat(it.unimi.dsi.fastutil.booleans.Boolean2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2BooleanFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2CharFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.booleans.Boolean2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2BooleanFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2CharFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.chars.Char2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.booleans.Boolean2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2BooleanFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2CharFunction<? super T> before) {
		return k -> get(before.getChar(k));
	}

	default <T> it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.booleans.Boolean2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2BooleanFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2CharFunction<? super T> before) {
		return k -> get(before.getChar(k));
	}
}
