...
public final class Object2ByteMaps {
	...
	public static class Singleton<K> extends Object2ByteFunctions.Singleton<K> implements Object2ByteMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2ByteMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2ByteFunctions.SynchronizedFunction<K> implements Object2ByteMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2ByteEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2ByteFunctions.UnmodifiableFunction<K> implements Object2ByteMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2ByteMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2ByteEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public byte getOrDefault(final Object key, final byte defaultValue) {
			return ((Object2ByteMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Object2ByteMap<K> unmodifiable(final Object2ByteMap<? extends K> m) {
