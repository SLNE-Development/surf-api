...
public final class Long2ByteFunctions {
	...
	public static Long2ByteFunction primitive(final java.util.function.Function<? super Long, ? extends Byte> f) {
		...
		if (f instanceof java.util.function.LongToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToByte(((java.util.function.LongToIntFunction)f).applyAsInt(key));
