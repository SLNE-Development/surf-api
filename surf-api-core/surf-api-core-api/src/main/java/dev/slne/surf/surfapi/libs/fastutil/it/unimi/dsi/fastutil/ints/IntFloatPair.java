 ...
 */
public interface IntFloatPair extends it.unimi.dsi.fastutil.Pair<Integer, Float> {
	/**
	 ...
	 */
	public default IntFloatPair left(final int l) {
	...
	@Deprecated
	@Override
	public default IntFloatPair left(final Integer l) {
	 ...
	 */
	public default IntFloatPair first(final int l) {
		return left(l);
	}
	...
	@Deprecated
	@Override
	public default IntFloatPair first(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default IntFloatPair key(final int l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default IntFloatPair key(Integer l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default IntFloatPair right(final float r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default IntFloatPair right(final Float l) {
	 ...
	 */
	public default IntFloatPair second(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default IntFloatPair second(final Float l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default IntFloatPair value(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default IntFloatPair value(final Float l) {
	 ...
	 */
	public static IntFloatPair of(final int left, final float right) {
	...
	public static java.util.Comparator<IntFloatPair> lexComparator() {
		return (x, y) -> {
