	...
	*/
	...
	public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
			final Comparator<? super Short2CharMap.Entry> comparator = (Short2CharAVLTreeMap.this.actualComparator == null ? (Comparator<Short2CharMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2CharMap.Entry>)(x, y) -> Short2CharAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2CharAVLTreeMap.this.compare(k, from) >= 0) && (top || Short2CharAVLTreeMap.this.compare(k, to) < 0);
		}
