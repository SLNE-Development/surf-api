...
public final class GameEvent {
    ...
    /**
     * Displays message 'block.minecraft.spawn.not_valid' (You have no home bed or charged respawn anchor,
     * or it was obstructed) to the player.
     */
    @ValueCanBeNull
    @Range(from = 0L, to = 0L)
    ...
    /**
     * Note: Seems to change both sky color and lighting (same as Rain level change, but doesn't start rain).
     ...
     * Sent by the server after the level is cleared on the client and is being re-sent (either during the first,
     * or subsequent reconfigurations).
     */
    @Range(from = 0L, to = 0L)
