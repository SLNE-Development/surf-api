 ...
 */
public class FloatFloatMutablePair implements FloatFloatPair, java.io.Serializable {
	 ...
	 */
	public FloatFloatMutablePair(final float left, final float right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static FloatFloatMutablePair of(final float left, final float right) {
	...
	@Override
	public FloatFloatMutablePair left(final float l) {
		left = l;
		return this;
	}
	...
	@Override
	public FloatFloatMutablePair right(final float r) {
		right = r;
		return this;
	}
