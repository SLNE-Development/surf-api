...
public final class Object2ReferenceSortedMaps {
	...
	public static class Singleton<K, V> extends Object2ReferenceMaps.Singleton<K, V> implements Object2ReferenceSortedMap<K, V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K, V> extends Object2ReferenceMaps.SynchronizedMap<K, V> implements Object2ReferenceSortedMap<K, V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K, V> extends Object2ReferenceMaps.UnmodifiableMap<K, V> implements Object2ReferenceSortedMap<K, V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Object2ReferenceSortedMap<K, ? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2ReferenceEntrySet());
			return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)entries;
		}
	 ...
	 */
	public static <K, V> Object2ReferenceSortedMap<K, V> unmodifiable(final Object2ReferenceSortedMap<K, ? extends V> m) {
