...
public final class Reference2LongMaps {
	...
	public static class Singleton<K> extends Reference2LongFunctions.Singleton<K> implements Reference2LongMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractReference2LongMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2LongFunctions.SynchronizedFunction<K> implements Reference2LongMap<K>, java.io.Serializable {
		...
		public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.reference2LongEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Reference2LongFunctions.UnmodifiableFunction<K> implements Reference2LongMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Reference2LongMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2LongEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public long getOrDefault(final Object key, final long defaultValue) {
			return ((Reference2LongMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2LongMap<K> unmodifiable(final Reference2LongMap<? extends K> m) {
