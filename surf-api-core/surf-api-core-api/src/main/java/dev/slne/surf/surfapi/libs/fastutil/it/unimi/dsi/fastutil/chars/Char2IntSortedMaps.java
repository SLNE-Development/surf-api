...
public final class Char2IntSortedMaps {
	...
	public static class Singleton extends Char2IntMaps.Singleton implements Char2IntSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2IntMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Char2IntMaps.SynchronizedMap implements Char2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2IntEntrySet(), sync);
			return (ObjectSortedSet<Char2IntMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2IntMaps.UnmodifiableMap implements Char2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2IntEntrySet());
			return (ObjectSortedSet<Char2IntMap.Entry>)entries;
		}
