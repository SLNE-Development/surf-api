	...
	public ShortSet keySet() {
		return new AbstractShortSet() {
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), sizeOf(AbstractShort2ObjectMap.this), ShortSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public ObjectCollection<V> values() {
		return new AbstractObjectCollection<V>() {
			...
			public ObjectSpliterator<V> spliterator() {
				return ObjectSpliterators.asSpliterator(iterator(), sizeOf(AbstractShort2ObjectMap.this), ObjectSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
