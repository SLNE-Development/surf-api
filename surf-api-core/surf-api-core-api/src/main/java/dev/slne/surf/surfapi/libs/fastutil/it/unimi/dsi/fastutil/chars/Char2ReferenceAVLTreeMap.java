	...
	*/
	...
	public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>() {
			final Comparator<? super Char2ReferenceMap.Entry<V>> comparator = (Char2ReferenceAVLTreeMap.this.actualComparator == null ? (Comparator<Char2ReferenceMap.Entry<V>>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2ReferenceMap.Entry<V>>)(x, y) -> Char2ReferenceAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2ReferenceAVLTreeMap.this.compare(k, from) >= 0) && (top || Char2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
