...
public interface Boolean2DoubleFunction extends Function<Boolean, Double> {
	...
	default it.unimi.dsi.fastutil.booleans.Boolean2ByteFunction andThenByte(it.unimi.dsi.fastutil.doubles.Double2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2ShortFunction andThenShort(it.unimi.dsi.fastutil.doubles.Double2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2DoubleFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2IntFunction andThenInt(it.unimi.dsi.fastutil.doubles.Double2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction composeInt(it.unimi.dsi.fastutil.ints.Int2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2LongFunction andThenLong(it.unimi.dsi.fastutil.doubles.Double2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2DoubleFunction composeLong(it.unimi.dsi.fastutil.longs.Long2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2CharFunction andThenChar(it.unimi.dsi.fastutil.doubles.Double2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2DoubleFunction composeChar(it.unimi.dsi.fastutil.chars.Char2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2FloatFunction andThenFloat(it.unimi.dsi.fastutil.doubles.Double2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2DoubleFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.doubles.Double2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2DoubleFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.booleans.Boolean2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2DoubleFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2BooleanFunction<? super T> before) {
		return k -> get(before.getBoolean(k));
	}

	default <T> it.unimi.dsi.fastutil.booleans.Boolean2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2BooleanFunction<? super T> before) {
		return k -> get(before.getBoolean(k));
	}
}
