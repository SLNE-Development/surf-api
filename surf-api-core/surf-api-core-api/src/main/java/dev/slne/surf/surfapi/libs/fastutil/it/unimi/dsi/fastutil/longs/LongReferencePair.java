 ...
 */
public interface LongReferencePair<V> extends it.unimi.dsi.fastutil.Pair<Long, V> {
	/**
	 ...
	 */
	public default LongReferencePair<V> left(final long l) {
	 ...
	 */
	public default LongReferencePair<V> first(final long l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default LongReferencePair<V> key(final long l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default LongReferencePair<V> key(Long l) {
	 ...
	 */
	public static <V> LongReferencePair<V> of(final long left, final V right) {
