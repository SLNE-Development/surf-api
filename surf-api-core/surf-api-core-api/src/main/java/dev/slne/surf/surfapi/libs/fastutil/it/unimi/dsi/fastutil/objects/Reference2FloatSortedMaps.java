...
public final class Reference2FloatSortedMaps {
	...
	public static class Singleton<K> extends Reference2FloatMaps.Singleton<K> implements Reference2FloatSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2FloatMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Reference2FloatMaps.SynchronizedMap<K> implements Reference2FloatSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.reference2FloatEntrySet(), sync);
			return (ObjectSortedSet<Reference2FloatMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2FloatMaps.UnmodifiableMap<K> implements Reference2FloatSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.reference2FloatEntrySet());
			return (ObjectSortedSet<Reference2FloatMap.Entry<K>>)entries;
		}
