...
public class Double2ShortRBTreeMap extends AbstractDouble2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
			final Comparator<? super Double2ShortMap.Entry> comparator = (Double2ShortRBTreeMap.this.actualComparator == null ? (Comparator<Double2ShortMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2ShortMap.Entry>)(x, y) -> Double2ShortRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ShortRBTreeMap.this.compare(k, from) >= 0) && (top || Double2ShortRBTreeMap.this.compare(k, to) < 0);
		}
