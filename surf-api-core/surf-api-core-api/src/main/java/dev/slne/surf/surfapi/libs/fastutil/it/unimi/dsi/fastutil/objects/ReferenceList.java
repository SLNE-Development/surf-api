...
public interface ReferenceList<K> extends List<K>, ReferenceCollection<K> {
	...
	default boolean addAll(int index, ReferenceList<? extends K> l) {
		return addAll(index, (ReferenceCollection<? extends K>)l);
	}
	 ...
	 */
	public static <K> ReferenceList<K> of(final K e) {
	 ...
	 */
	public static <K> ReferenceList<K> of(final K e0, final K e1) {
	 ...
	 */
	public static <K> ReferenceList<K> of(final K e0, final K e1, final K e2) {
	...
	@SafeVarargs
	public static <K> ReferenceList<K> of(final K... a) {
		switch (a.length) {
		case 0:
			return of();
		case 1:
