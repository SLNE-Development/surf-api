	...
	*/
	...
	public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2ReferenceMap.Entry<V>>() {
			final Comparator<? super Double2ReferenceMap.Entry<V>> comparator = (Double2ReferenceAVLTreeMap.this.actualComparator == null ? (Comparator<Double2ReferenceMap.Entry<V>>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2ReferenceMap.Entry<V>>)(x, y) -> Double2ReferenceAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ReferenceAVLTreeMap.this.compare(k, from) >= 0) && (top || Double2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
