...
public final class Byte2BooleanMaps {
	...
	public static class EmptyMap extends Byte2BooleanFunctions.EmptyFunction implements Byte2BooleanMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Byte, ? super Boolean> consumer) {
		}
	...
	public static class Singleton extends Byte2BooleanFunctions.Singleton implements Byte2BooleanMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractByte2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Byte2BooleanFunctions.SynchronizedFunction implements Byte2BooleanMap, java.io.Serializable {
		...
		public ObjectSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.byte2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Byte, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final byte key, final java.util.function.IntFunction<? extends Boolean> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Byte2BooleanFunctions.UnmodifiableFunction implements Byte2BooleanMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.byte2BooleanEntrySet());
			return entries;
		}
