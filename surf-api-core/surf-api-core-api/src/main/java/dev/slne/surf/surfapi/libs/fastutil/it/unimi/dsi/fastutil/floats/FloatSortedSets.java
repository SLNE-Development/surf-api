...
public final class FloatSortedSets {
	...
	public static class Singleton extends FloatSets.Singleton implements FloatSortedSet, java.io.Serializable, Cloneable {
		...
		public FloatSpliterator spliterator() {
			return FloatSpliterators.singleton(element, comparator);
		}
		...
		public DoubleSpliterator doubleSpliterator() {
			return DoubleSpliterators.singleton(element, (double left, double right) -> comparator().compare(it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(left), it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(right)));
		}
