...
public final class Byte2ObjectFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractByte2ObjectFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Byte2ObjectFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final byte k, final V defaultValue) {
			return ((Byte2ObjectFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Byte2ObjectFunction<V> unmodifiable(final Byte2ObjectFunction<? extends V> f) {
