...
public class Object2ReferenceRBTreeMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
			final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator = (Object2ReferenceRBTreeMap.this.actualComparator == null ? (Comparator<Object2ReferenceMap.Entry<K, V>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2ReferenceMap.Entry<K, V>>)(x, y) -> Object2ReferenceRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2ReferenceSortedMap<K, V> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2ReferenceRBTreeMap.this.compare(k, from) >= 0) && (top || Object2ReferenceRBTreeMap.this.compare(k, to) < 0);
		}
