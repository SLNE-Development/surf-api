...
public class Char2BooleanLinkedOpenHashMap extends AbstractChar2BooleanSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2BooleanMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Char2BooleanMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractCharSortedSet {
		...
		public CharSpliterator spliterator() {
			return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public BooleanCollection values() {
		if (values == null) values = new AbstractBooleanCollection() {
			...
			public BooleanSpliterator spliterator() {
				return BooleanSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
