 ...
 */
public interface FloatBytePair extends it.unimi.dsi.fastutil.Pair<Float, Byte> {
	/**
	 ...
	 */
	public default FloatBytePair left(final float l) {
	 ...
	 */
	public default FloatBytePair first(final float l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default FloatBytePair key(final float l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default FloatBytePair key(Float l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default FloatBytePair right(final byte r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default FloatBytePair right(final Byte l) {
	 ...
	 */
	public default FloatBytePair second(final byte r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatBytePair second(final Byte l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default FloatBytePair value(final byte r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatBytePair value(final Byte l) {
	 ...
	 */
	public static FloatBytePair of(final float left, final byte right) {
	...
	public static java.util.Comparator<FloatBytePair> lexComparator() {
		return (x, y) -> {
