...
public interface IntIntSortedPair extends IntIntPair, it.unimi.dsi.fastutil.SortedPair<Integer>, java.io.Serializable {
	/**
	 ...
	 *           implementation.
	 */
	public static IntIntSortedPair of(final int left, final int right) {
