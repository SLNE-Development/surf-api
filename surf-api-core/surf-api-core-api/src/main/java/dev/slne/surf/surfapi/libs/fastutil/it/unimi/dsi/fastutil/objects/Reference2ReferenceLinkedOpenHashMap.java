...
public class Reference2ReferenceLinkedOpenHashMap<K, V> extends AbstractReference2ReferenceSortedMap<K, V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> implements FastSortedEntrySet<K, V> {
		...
		public ObjectSpliterator<Reference2ReferenceMap.Entry<K, V>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
