...
public class Int2CharLinkedOpenHashMap extends AbstractInt2CharSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2CharMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Int2CharMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractIntSortedSet {
		...
		public IntSpliterator spliterator() {
			return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public CharCollection values() {
		if (values == null) values = new AbstractCharCollection() {
			...
			public CharSpliterator spliterator() {
				return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
