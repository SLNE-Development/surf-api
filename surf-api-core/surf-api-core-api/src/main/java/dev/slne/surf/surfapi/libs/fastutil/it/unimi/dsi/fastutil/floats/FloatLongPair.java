 ...
 */
public interface FloatLongPair extends it.unimi.dsi.fastutil.Pair<Float, Long> {
	/**
	 ...
	 */
	public default FloatLongPair left(final float l) {
	 ...
	 */
	public default FloatLongPair first(final float l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default FloatLongPair key(final float l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default FloatLongPair key(Float l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default FloatLongPair right(final long r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default FloatLongPair right(final Long l) {
	 ...
	 */
	public default FloatLongPair second(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatLongPair second(final Long l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default FloatLongPair value(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatLongPair value(final Long l) {
	 ...
	 */
	public static FloatLongPair of(final float left, final long right) {
	...
	public static java.util.Comparator<FloatLongPair> lexComparator() {
		return (x, y) -> {
