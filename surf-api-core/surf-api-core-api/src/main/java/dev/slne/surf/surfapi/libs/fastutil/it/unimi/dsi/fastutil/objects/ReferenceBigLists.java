...
public final class ReferenceBigLists {
	...
	public static class UnmodifiableBigList<K> extends ReferenceCollections.UnmodifiableCollection<K> implements ReferenceBigList<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final ReferenceBigList<? extends K> list; // Due to the large number of methods that are not in
															// COLLECTION, this is worth caching.

		protected UnmodifiableBigList(final ReferenceBigList<? extends K> l) {
			super(l);
			this.list = l;
		}
	 ...
	 */
	public static <K> ReferenceBigList<K> unmodifiable(final ReferenceBigList<? extends K> l) {
