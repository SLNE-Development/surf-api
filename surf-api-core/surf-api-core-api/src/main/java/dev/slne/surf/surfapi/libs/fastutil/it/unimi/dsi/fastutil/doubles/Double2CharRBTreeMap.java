...
public class Double2CharRBTreeMap extends AbstractDouble2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2CharMap.Entry>() {
			final Comparator<? super Double2CharMap.Entry> comparator = (Double2CharRBTreeMap.this.actualComparator == null ? (Comparator<Double2CharMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2CharMap.Entry>)(x, y) -> Double2CharRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2CharRBTreeMap.this.compare(k, from) >= 0) && (top || Double2CharRBTreeMap.this.compare(k, to) < 0);
		}
