	...
	private final class EntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements FastEntrySet {
		...
		public ObjectIterator<Float2FloatMap.Entry> iterator() {
			return new ObjectIterator<Float2FloatMap.Entry>() {
				...
				public void forEachRemaining(final Consumer<? super Float2FloatMap.Entry> action) {
		...
		final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2FloatMap.Entry> implements ObjectSpliterator<Float2FloatMap.Entry> {
		...
		public void forEach(final Consumer<? super Float2FloatMap.Entry> action) {
			// Hoist containing class field ref into local
		...
		public void fastForEach(final Consumer<? super Float2FloatMap.Entry> action) {
			final BasicEntry entry = new BasicEntry();
			// Hoist containing class field ref into local
			for (int i = 0, max = size; i < max; ++i) {
				entry.key = key[i];
