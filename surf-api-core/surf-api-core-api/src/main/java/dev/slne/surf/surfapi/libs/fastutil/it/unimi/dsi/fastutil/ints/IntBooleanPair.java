 ...
 */
public interface IntBooleanPair extends it.unimi.dsi.fastutil.Pair<Integer, Boolean> {
	/**
	 ...
	 */
	public default IntBooleanPair left(final int l) {
	...
	@Deprecated
	@Override
	public default IntBooleanPair left(final Integer l) {
	 ...
	 */
	public default IntBooleanPair first(final int l) {
		return left(l);
	}
	...
	@Deprecated
	@Override
	public default IntBooleanPair first(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default IntBooleanPair key(final int l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default IntBooleanPair key(Integer l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default IntBooleanPair right(final boolean r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default IntBooleanPair right(final Boolean l) {
	 ...
	 */
	public default IntBooleanPair second(final boolean r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default IntBooleanPair second(final Boolean l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default IntBooleanPair value(final boolean r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default IntBooleanPair value(final Boolean l) {
	 ...
	 */
	public static IntBooleanPair of(final int left, final boolean right) {
	...
	public static java.util.Comparator<IntBooleanPair> lexComparator() {
		return (x, y) -> {
