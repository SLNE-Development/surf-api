...
public final class Double2FloatFunctions {
	...
	public static Double2FloatFunction primitive(final java.util.function.Function<? super Double, ? extends Float> f) {
		...
		if (f instanceof java.util.function.DoubleUnaryOperator) return key -> it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(((java.util.function.DoubleUnaryOperator)f).applyAsDouble(key));
