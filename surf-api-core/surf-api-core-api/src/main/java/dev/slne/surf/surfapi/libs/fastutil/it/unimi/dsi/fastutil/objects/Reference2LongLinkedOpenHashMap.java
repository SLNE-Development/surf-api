...
public class Reference2LongLinkedOpenHashMap<K> extends AbstractReference2LongSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2LongMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Reference2LongMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public LongCollection values() {
		if (values == null) values = new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
