...
public interface PacketPhantom extends PacketFlying<PacketPhantom>, Spawnable {
   ...
   * @apiNote You should consider using {@link #hitbox(double)} instead as it is more simple to
   * use.
   */
  @ApiStatus.Obsolete
  void size(int size);
   ...
   * <p>
   * This method will automatically calculate the size of the phantom with the formula from
   * {@link #size()}.
   * </p>
   * <br>
   * <b>Example:</b>
