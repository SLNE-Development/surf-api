...
public final class Double2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Double2ReferenceMaps.Singleton<V> implements Double2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Double2ReferenceMaps.SynchronizedMap<V> implements Double2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Double2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Double2ReferenceMaps.UnmodifiableMap<V> implements Double2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Double2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2ReferenceEntrySet());
			return (ObjectSortedSet<Double2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Double2ReferenceSortedMap<V> unmodifiable(final Double2ReferenceSortedMap<? extends V> m) {
