...
public class Long2FloatRBTreeMap extends AbstractLong2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
			final Comparator<? super Long2FloatMap.Entry> comparator = (Long2FloatRBTreeMap.this.actualComparator == null ? (Comparator<Long2FloatMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2FloatMap.Entry>)(x, y) -> Long2FloatRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2FloatRBTreeMap.this.compare(k, from) >= 0) && (top || Long2FloatRBTreeMap.this.compare(k, to) < 0);
		}
