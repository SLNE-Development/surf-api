 ...
 */
public interface DoubleCharPair extends it.unimi.dsi.fastutil.Pair<Double, Character> {
	/**
	 ...
	 */
	public default DoubleCharPair left(final double l) {
	 ...
	 */
	public default DoubleCharPair first(final double l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default DoubleCharPair key(final double l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default DoubleCharPair key(Double l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default DoubleCharPair right(final char r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default DoubleCharPair right(final Character l) {
	 ...
	 */
	public default DoubleCharPair second(final char r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleCharPair second(final Character l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default DoubleCharPair value(final char r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleCharPair value(final Character l) {
	 ...
	 */
	public static DoubleCharPair of(final double left, final char right) {
	...
	public static java.util.Comparator<DoubleCharPair> lexComparator() {
		return (x, y) -> {
