...
public final class Long2ByteSortedMaps {
	...
	public static class Singleton extends Long2ByteMaps.Singleton implements Long2ByteSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2ByteMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Long2ByteMaps.SynchronizedMap implements Long2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2ByteEntrySet(), sync);
			return (ObjectSortedSet<Long2ByteMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2ByteMaps.UnmodifiableMap implements Long2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2ByteEntrySet());
			return (ObjectSortedSet<Long2ByteMap.Entry>)entries;
		}
