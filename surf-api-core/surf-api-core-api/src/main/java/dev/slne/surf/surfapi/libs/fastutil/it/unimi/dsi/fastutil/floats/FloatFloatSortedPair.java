...
public interface FloatFloatSortedPair extends FloatFloatPair, it.unimi.dsi.fastutil.SortedPair<Float>, java.io.Serializable {
	/**
	 ...
	 *           implementation.
	 */
	public static FloatFloatSortedPair of(final float left, final float right) {
	 ...
	 */
	default boolean contains(final float e) {
