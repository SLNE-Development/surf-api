...
public class Float2FloatRBTreeMap extends AbstractFloat2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
			final Comparator<? super Float2FloatMap.Entry> comparator = (Float2FloatRBTreeMap.this.actualComparator == null ? (Comparator<Float2FloatMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2FloatMap.Entry>)(x, y) -> Float2FloatRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2FloatRBTreeMap.this.compare(k, from) >= 0) && (top || Float2FloatRBTreeMap.this.compare(k, to) < 0);
		}
