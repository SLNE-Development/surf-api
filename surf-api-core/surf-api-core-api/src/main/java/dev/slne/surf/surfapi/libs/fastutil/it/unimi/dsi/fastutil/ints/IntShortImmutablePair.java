 ...
 */
public class IntShortImmutablePair implements IntShortPair, java.io.Serializable {
	 ...
	 */
	public IntShortImmutablePair(final int left, final short right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static IntShortImmutablePair of(final int left, final short right) {
