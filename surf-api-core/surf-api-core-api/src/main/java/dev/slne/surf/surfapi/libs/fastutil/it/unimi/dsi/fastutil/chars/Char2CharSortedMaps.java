...
public final class Char2CharSortedMaps {
	...
	public static class Singleton extends Char2CharMaps.Singleton implements Char2CharSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2CharMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Char2CharMaps.SynchronizedMap implements Char2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2CharEntrySet(), sync);
			return (ObjectSortedSet<Char2CharMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2CharMaps.UnmodifiableMap implements Char2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2CharEntrySet());
			return (ObjectSortedSet<Char2CharMap.Entry>)entries;
		}
