 ...
 */
public class DoubleReferenceImmutablePair<V> implements DoubleReferencePair<V>, java.io.Serializable {
	 ...
	 */
	public DoubleReferenceImmutablePair(final double left, final V right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <V> DoubleReferenceImmutablePair<V> of(final double left, final V right) {
