...
public final class Float2ShortSortedMaps {
	...
	public static class Singleton extends Float2ShortMaps.Singleton implements Float2ShortSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2ShortMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Float2ShortMaps.SynchronizedMap implements Float2ShortSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2ShortEntrySet(), sync);
			return (ObjectSortedSet<Float2ShortMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2ShortMaps.UnmodifiableMap implements Float2ShortSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2ShortEntrySet());
			return (ObjectSortedSet<Float2ShortMap.Entry>)entries;
		}
