...
@CanBeSpawned
public interface PacketFurnaceMinecart extends
    PacketAbstractMinecartContainer<PacketFurnaceMinecart>, Spawnable {
  ...
  /**
   * @param hasFuel                   true if the furnace minecart has fuel
   * @param updateDisplayedBlockState true if the displayed block state should be updated (normale
   *                                  furnace / lit furnace)
   */
