 ...
 */
public class ShortIntImmutablePair implements ShortIntPair, java.io.Serializable {
	 ...
	 */
	public ShortIntImmutablePair(final short left, final int right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static ShortIntImmutablePair of(final short left, final int right) {
