...
public final class Short2ShortMaps {
	...
	public static class Singleton extends Short2ShortFunctions.Singleton implements Short2ShortMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2ShortFunctions.SynchronizedFunction implements Short2ShortMap, java.io.Serializable {
		...
		public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Short> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Short2ShortFunctions.UnmodifiableFunction implements Short2ShortMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2ShortEntrySet());
			return entries;
		}
