...
public class Char2ShortRBTreeMap extends AbstractChar2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
			final Comparator<? super Char2ShortMap.Entry> comparator = (Char2ShortRBTreeMap.this.actualComparator == null ? (Comparator<Char2ShortMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2ShortMap.Entry>)(x, y) -> Char2ShortRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2ShortRBTreeMap.this.compare(k, from) >= 0) && (top || Char2ShortRBTreeMap.this.compare(k, to) < 0);
		}
