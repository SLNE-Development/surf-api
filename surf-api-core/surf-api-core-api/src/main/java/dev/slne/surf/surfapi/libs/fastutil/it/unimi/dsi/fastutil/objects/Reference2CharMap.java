...
public interface Reference2CharMap<K> extends Reference2CharFunction<K>, Map<K, Character> {
	...
	// Defaultable methods
	@Override
	default void forEach(final java.util.function.BiConsumer<? super K, ? super Character> consumer) {
		final ObjectSet<Reference2CharMap.Entry<K>> entrySet = reference2CharEntrySet();
		final Consumer<Reference2CharMap.Entry<K>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), Character.valueOf(entry.getCharValue()));
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final K key, final java.util.function.ToIntFunction<? super K> mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final K key, final Reference2CharFunction<? super K> mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final char v = getChar(key), drv = defaultReturnValue();
		if (v != drv || containsKey(key)) return v;
	 ...
	 * @since 8.0.0
	 */
	default char merge(final K key, final char value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
	 ...
	 * @since 8.5.0
	 */
	default char mergeChar(final K key, final char value, final it.unimi.dsi.fastutil.chars.CharBinaryOperator remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = getChar(key), drv = defaultReturnValue();
	 ...
	 *           this overhead.
	 */
	default char mergeChar(final K key, final char value, final java.util.function.IntBinaryOperator remappingFunction) {
