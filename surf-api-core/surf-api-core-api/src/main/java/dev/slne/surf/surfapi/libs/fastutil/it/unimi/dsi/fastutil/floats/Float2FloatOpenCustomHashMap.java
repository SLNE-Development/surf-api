...
public class Float2FloatOpenCustomHashMap extends AbstractFloat2FloatMap implements java.io.Serializable, Cloneable, Hash {
	...
	public float addTo(final float k, final float incr) {
		...
		if ((strategy.equals((k), (0)))) {
			...
			if (!(Float.floatToIntBits(curr = key[pos = (it.unimi.dsi.fastutil.HashCommon.mix(strategy.hashCode(k))) & mask]) == 0)) {
				...
				while (!(Float.floatToIntBits(curr = key[pos = (pos + 1) & mask]) == 0)) if ((strategy.equals((curr), (k)))) return addToValue(pos, incr);
			}
		}
		key[pos] = k;
	...
	private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
		...
		boolean mustReturnNull = Float2FloatOpenCustomHashMap.this.containsNullKey;
