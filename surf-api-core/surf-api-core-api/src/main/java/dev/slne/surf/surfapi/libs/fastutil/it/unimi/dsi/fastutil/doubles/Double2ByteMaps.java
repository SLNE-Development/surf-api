...
public final class Double2ByteMaps {
	...
	public static class Singleton extends Double2ByteFunctions.Singleton implements Double2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractDouble2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2ByteFunctions.SynchronizedFunction implements Double2ByteMap, java.io.Serializable {
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Double, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final double key, final java.util.function.DoubleFunction<? extends Byte> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Double2ByteFunctions.UnmodifiableFunction implements Double2ByteMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.double2ByteEntrySet());
			return entries;
		}
