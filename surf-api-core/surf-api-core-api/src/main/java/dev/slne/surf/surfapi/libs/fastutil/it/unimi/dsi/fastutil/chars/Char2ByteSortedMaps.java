...
public final class Char2ByteSortedMaps {
	...
	public static class Singleton extends Char2ByteMaps.Singleton implements Char2ByteSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2ByteMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Char2ByteMaps.SynchronizedMap implements Char2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2ByteEntrySet(), sync);
			return (ObjectSortedSet<Char2ByteMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2ByteMaps.UnmodifiableMap implements Char2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2ByteEntrySet());
			return (ObjectSortedSet<Char2ByteMap.Entry>)entries;
		}
