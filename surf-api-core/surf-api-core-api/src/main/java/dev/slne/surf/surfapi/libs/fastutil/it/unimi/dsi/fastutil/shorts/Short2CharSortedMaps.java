...
public final class Short2CharSortedMaps {
	...
	public static class Singleton extends Short2CharMaps.Singleton implements Short2CharSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2CharMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Short2CharMaps.SynchronizedMap implements Short2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2CharEntrySet(), sync);
			return (ObjectSortedSet<Short2CharMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2CharMaps.UnmodifiableMap implements Short2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2CharEntrySet());
			return (ObjectSortedSet<Short2CharMap.Entry>)entries;
		}
