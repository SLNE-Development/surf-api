...
public class Long2ReferenceLinkedOpenHashMap<V> extends AbstractLong2ReferenceSortedMap<V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>> implements FastSortedEntrySet<V> {
		...
		public ObjectSpliterator<Long2ReferenceMap.Entry<V>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractLongSortedSet {
		...
		public LongSpliterator spliterator() {
			return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
