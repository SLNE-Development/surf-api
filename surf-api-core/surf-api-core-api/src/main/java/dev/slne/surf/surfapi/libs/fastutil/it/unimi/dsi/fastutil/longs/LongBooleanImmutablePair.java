 ...
 */
public class LongBooleanImmutablePair implements LongBooleanPair, java.io.Serializable {
	 ...
	 */
	public LongBooleanImmutablePair(final long left, final boolean right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static LongBooleanImmutablePair of(final long left, final boolean right) {
