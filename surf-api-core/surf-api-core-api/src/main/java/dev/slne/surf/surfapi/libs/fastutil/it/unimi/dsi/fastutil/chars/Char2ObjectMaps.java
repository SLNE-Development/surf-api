...
public final class Char2ObjectMaps {
	...
	public static class Singleton<V> extends Char2ObjectFunctions.Singleton<V> implements Char2ObjectMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractChar2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Char2ObjectFunctions.SynchronizedFunction<V> implements Char2ObjectMap<V>, java.io.Serializable {
		...
		public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.char2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Char2ObjectFunctions.UnmodifiableFunction<V> implements Char2ObjectMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Char2ObjectMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.char2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final char key, final V defaultValue) {
			return ((Char2ObjectMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Char2ObjectMap<V> unmodifiable(final Char2ObjectMap<? extends V> m) {
