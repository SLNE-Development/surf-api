...
public final class ReferenceCollections {
	...
	static class SynchronizedCollection<K> implements ReferenceCollection<K>, java.io.Serializable {
	...
	static class UnmodifiableCollection<K> implements ReferenceCollection<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final ReferenceCollection<? extends K> collection;

		protected UnmodifiableCollection(final ReferenceCollection<? extends K> c) {
			this.collection = Objects.requireNonNull(c);
		}
	 ...
	 */
	public static <K> ReferenceCollection<K> unmodifiable(final ReferenceCollection<? extends K> c) {
