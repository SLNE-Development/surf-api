...
public class Long2ReferenceRBTreeMap<V> extends AbstractLong2ReferenceSortedMap<V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() {
			final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = (Long2ReferenceRBTreeMap.this.actualComparator == null ? (Comparator<Long2ReferenceMap.Entry<V>>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2ReferenceMap.Entry<V>>)(x, y) -> Long2ReferenceRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ReferenceRBTreeMap.this.compare(k, from) >= 0) && (top || Long2ReferenceRBTreeMap.this.compare(k, to) < 0);
		}
