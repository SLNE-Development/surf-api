	...
	*/
	...
	public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() {
			final Comparator<? super Float2ShortMap.Entry> comparator = (Float2ShortAVLTreeMap.this.actualComparator == null ? (Comparator<Float2ShortMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2ShortMap.Entry>)(x, y) -> Float2ShortAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2ShortAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2ShortAVLTreeMap.this.compare(k, to) < 0);
		}
