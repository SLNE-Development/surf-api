...
public final class Byte2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Byte2ReferenceMaps.Singleton<V> implements Byte2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Byte2ReferenceMaps.SynchronizedMap<V> implements Byte2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Byte2ReferenceMaps.UnmodifiableMap<V> implements Byte2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Byte2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2ReferenceEntrySet());
			return (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Byte2ReferenceSortedMap<V> unmodifiable(final Byte2ReferenceSortedMap<? extends V> m) {
