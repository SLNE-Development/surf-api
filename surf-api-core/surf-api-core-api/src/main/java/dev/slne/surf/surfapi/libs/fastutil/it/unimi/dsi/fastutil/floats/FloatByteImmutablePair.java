 ...
 */
public class FloatByteImmutablePair implements FloatBytePair, java.io.Serializable {
	 ...
	 */
	public FloatByteImmutablePair(final float left, final byte right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static FloatByteImmutablePair of(final float left, final byte right) {
