 ...
 */
public class ReferenceShortImmutablePair<K> implements ReferenceShortPair<K>, java.io.Serializable {
	 ...
	 */
	public ReferenceShortImmutablePair(final K left, final short right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ReferenceShortImmutablePair<K> of(final K left, final short right) {
