	...
	*/
	...
	public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>() {
			final Comparator<? super Byte2FloatMap.Entry> comparator = (Byte2FloatAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2FloatMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2FloatMap.Entry>)(x, y) -> Byte2FloatAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2FloatAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
