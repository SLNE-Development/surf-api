...
public class Int2CharRBTreeMap extends AbstractInt2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
			final Comparator<? super Int2CharMap.Entry> comparator = (Int2CharRBTreeMap.this.actualComparator == null ? (Comparator<Int2CharMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2CharMap.Entry>)(x, y) -> Int2CharRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2CharRBTreeMap.this.compare(k, from) >= 0) && (top || Int2CharRBTreeMap.this.compare(k, to) < 0);
		}
