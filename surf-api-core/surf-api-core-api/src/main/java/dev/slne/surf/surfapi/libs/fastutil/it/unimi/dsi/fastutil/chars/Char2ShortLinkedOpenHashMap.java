...
public class Char2ShortLinkedOpenHashMap extends AbstractChar2ShortSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2ShortMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Char2ShortMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractCharSortedSet {
		...
		public CharSpliterator spliterator() {
			return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ShortCollection values() {
		if (values == null) values = new AbstractShortCollection() {
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
