 ...
 */
public interface ReferenceBytePair<K> extends it.unimi.dsi.fastutil.Pair<K, Byte> {
	/**
	 ...
	 */
	public default ReferenceBytePair<K> right(final byte r) {
	...
	@Deprecated
	@Override
	public default ReferenceBytePair<K> right(final Byte l) {
	 ...
	 */
	public default ReferenceBytePair<K> second(final byte r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ReferenceBytePair<K> second(final Byte l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ReferenceBytePair<K> value(final byte r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ReferenceBytePair<K> value(final Byte l) {
	 ...
	 */
	public static <K> ReferenceBytePair<K> of(final K left, final byte right) {
