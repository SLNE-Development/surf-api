 ...
 */
public interface ObjectShortPair<K> extends it.unimi.dsi.fastutil.Pair<K, Short> {
	/**
	 ...
	 */
	public default ObjectShortPair<K> right(final short r) {
	...
	@Deprecated
	@Override
	public default ObjectShortPair<K> right(final Short l) {
	 ...
	 */
	public default ObjectShortPair<K> second(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectShortPair<K> second(final Short l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ObjectShortPair<K> value(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectShortPair<K> value(final Short l) {
	 ...
	 */
	public static <K> ObjectShortPair<K> of(final K left, final short right) {
	...
	public static <K> java.util.Comparator<ObjectShortPair<K>> lexComparator() {
		return (x, y) -> {
