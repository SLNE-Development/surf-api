...
public final class Int2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractInt2ReferenceFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Int2ReferenceFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final int k, final V defaultValue) {
			return ((Int2ReferenceFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Int2ReferenceFunction<V> unmodifiable(final Int2ReferenceFunction<? extends V> f) {
