...
public abstract class AbstractChar2IntMap extends AbstractChar2IntFunction implements Char2IntMap, java.io.Serializable {
	 ...
	 */
	@Override
	public final int mergeInt(final char key, final int value, final it.unimi.dsi.fastutil.ints.IntBinaryOperator remappingFunction) {
	...
	public CharSet keySet() {
		return new AbstractCharSet() {
			...
			public CharSpliterator spliterator() {
				return CharSpliterators.asSpliterator(iterator(), sizeOf(AbstractChar2IntMap.this), CharSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public IntCollection values() {
		return new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), sizeOf(AbstractChar2IntMap.this), IntSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
