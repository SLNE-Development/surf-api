...
public final class Char2DoubleSortedMaps {
	...
	public static class Singleton extends Char2DoubleMaps.Singleton implements Char2DoubleSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2DoubleMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Char2DoubleMaps.SynchronizedMap implements Char2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Char2DoubleMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2DoubleMaps.UnmodifiableMap implements Char2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2DoubleEntrySet());
			return (ObjectSortedSet<Char2DoubleMap.Entry>)entries;
		}
