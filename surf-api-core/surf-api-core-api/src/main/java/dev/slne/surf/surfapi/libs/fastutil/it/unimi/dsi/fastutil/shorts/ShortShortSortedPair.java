...
public interface ShortShortSortedPair extends ShortShortPair, it.unimi.dsi.fastutil.SortedPair<Short>, java.io.Serializable {
	/**
	 ...
	 *           implementation.
	 */
	public static ShortShortSortedPair of(final short left, final short right) {
