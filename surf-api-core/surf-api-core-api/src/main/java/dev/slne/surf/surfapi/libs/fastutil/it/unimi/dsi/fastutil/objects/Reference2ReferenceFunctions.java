...
public final class Reference2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<K, V> extends AbstractReference2ReferenceFunction<K, V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2ReferenceFunction<? extends K, ? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final Object k, final V defaultValue) {
			return ((Reference2ReferenceFunction<K, V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K, V> Reference2ReferenceFunction<K, V> unmodifiable(final Reference2ReferenceFunction<? extends K, ? extends V> f) {
