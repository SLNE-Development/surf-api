...
public final class Byte2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractByte2ReferenceFunction<V> implements java.io.Serializable {
		...
		public V getOrDefault(final byte k, final V defaultValue) {
			return ((Byte2ReferenceFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Byte2ReferenceFunction<V> unmodifiable(final Byte2ReferenceFunction<? extends V> f) {
