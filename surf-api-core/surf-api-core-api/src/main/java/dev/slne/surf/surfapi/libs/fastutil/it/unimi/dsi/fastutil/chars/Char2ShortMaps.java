...
public final class Char2ShortMaps {
	...
	public static class EmptyMap extends Char2ShortFunctions.EmptyFunction implements Char2ShortMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Short> consumer) {
		}
	...
	public static class Singleton extends Char2ShortFunctions.Singleton implements Char2ShortMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractChar2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2ShortFunctions.SynchronizedFunction implements Char2ShortMap, java.io.Serializable {
		...
		public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.char2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final char key, final java.util.function.IntFunction<? extends Short> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsent(final char key, final Char2ShortFunction mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Short computeIfPresent(final Character key, final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Short compute(final Character key, final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Short merge(final Character key, final Short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Char2ShortFunctions.UnmodifiableFunction implements Char2ShortMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.char2ShortEntrySet());
			return entries;
		}
