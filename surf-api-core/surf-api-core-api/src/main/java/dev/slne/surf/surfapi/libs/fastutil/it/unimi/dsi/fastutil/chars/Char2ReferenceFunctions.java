...
public final class Char2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractChar2ReferenceFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Char2ReferenceFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final char k, final V defaultValue) {
			return ((Char2ReferenceFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Char2ReferenceFunction<V> unmodifiable(final Char2ReferenceFunction<? extends V> f) {
