...
public final class Reference2ObjectMaps {
	...
	public static class Singleton<K, V> extends Reference2ObjectFunctions.Singleton<K, V> implements Reference2ObjectMap<K, V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractReference2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K, V> extends Reference2ObjectFunctions.SynchronizedFunction<K, V> implements Reference2ObjectMap<K, V>, java.io.Serializable {
		...
		public ObjectSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.reference2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K, V> extends Reference2ObjectFunctions.UnmodifiableFunction<K, V> implements Reference2ObjectMap<K, V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Reference2ObjectMap<? extends K, ? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final Object key, final V defaultValue) {
			return ((Reference2ObjectMap<K, V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K, V> Reference2ObjectMap<K, V> unmodifiable(final Reference2ObjectMap<? extends K, ? extends V> m) {
