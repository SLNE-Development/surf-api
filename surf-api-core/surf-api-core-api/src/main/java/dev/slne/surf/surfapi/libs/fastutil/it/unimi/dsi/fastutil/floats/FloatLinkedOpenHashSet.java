...
public class FloatLinkedOpenHashSet extends AbstractFloatSortedSet implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public static FloatLinkedOpenHashSet of(final float e) {
		FloatLinkedOpenHashSet result = new FloatLinkedOpenHashSet(1, DEFAULT_LOAD_FACTOR);
		result.add(e);
		return result;
	}
	 ...
	 */
	public static FloatLinkedOpenHashSet of(final float e0, final float e1) {
		FloatLinkedOpenHashSet result = new FloatLinkedOpenHashSet(2, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
	 ...
	 * @throws IllegalArgumentException if there were duplicate entries.
	 */
	public static FloatLinkedOpenHashSet of(final float e0, final float e1, final float e2) {
		FloatLinkedOpenHashSet result = new FloatLinkedOpenHashSet(3, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
			throw new IllegalArgumentException("Duplicate element: " + e1);
		}
	...
	public static FloatLinkedOpenHashSet of(final float... a) {
		FloatLinkedOpenHashSet result = new FloatLinkedOpenHashSet(a.length, DEFAULT_LOAD_FACTOR);
		for (float element : a) {
