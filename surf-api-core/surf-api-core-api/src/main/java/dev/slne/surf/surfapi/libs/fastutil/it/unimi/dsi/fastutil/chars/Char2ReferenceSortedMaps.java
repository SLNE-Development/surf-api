...
public final class Char2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Char2ReferenceMaps.Singleton<V> implements Char2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractChar2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Char2ReferenceMaps.SynchronizedMap<V> implements Char2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.char2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Char2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Char2ReferenceMaps.UnmodifiableMap<V> implements Char2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Char2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.char2ReferenceEntrySet());
			return (ObjectSortedSet<Char2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Char2ReferenceSortedMap<V> unmodifiable(final Char2ReferenceSortedMap<? extends V> m) {
