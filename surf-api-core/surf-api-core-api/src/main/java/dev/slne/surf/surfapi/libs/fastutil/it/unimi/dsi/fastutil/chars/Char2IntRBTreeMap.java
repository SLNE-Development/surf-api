...
public class Char2IntRBTreeMap extends AbstractChar2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
			final Comparator<? super Char2IntMap.Entry> comparator = (Char2IntRBTreeMap.this.actualComparator == null ? (Comparator<Char2IntMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2IntMap.Entry>)(x, y) -> Char2IntRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2IntRBTreeMap.this.compare(k, from) >= 0) && (top || Char2IntRBTreeMap.this.compare(k, to) < 0);
		}
