 ...
 */
public class ReferenceObjectImmutablePair<K, V> implements ReferenceObjectPair<K, V>, java.io.Serializable {
	 ...
	 */
	public ReferenceObjectImmutablePair(final K left, final V right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K, V> ReferenceObjectImmutablePair<K, V> of(final K left, final V right) {
