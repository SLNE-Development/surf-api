...
public final class Float2LongMaps {
	...
	public static class EmptyMap extends Float2LongFunctions.EmptyFunction implements Float2LongMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super Long> consumer) {
		}
	...
	public static class Singleton extends Float2LongFunctions.Singleton implements Float2LongMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Float2LongMap.Entry> float2LongEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2LongFunctions.SynchronizedFunction implements Float2LongMap, java.io.Serializable {
		...
		public ObjectSet<Float2LongMap.Entry> float2LongEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.float2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Long> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Float2LongFunctions.UnmodifiableFunction implements Float2LongMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Float2LongMap.Entry> float2LongEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2LongEntrySet());
			return entries;
		}
