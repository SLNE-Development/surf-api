...
public class Byte2ByteRBTreeMap extends AbstractByte2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
			final Comparator<? super Byte2ByteMap.Entry> comparator = (Byte2ByteRBTreeMap.this.actualComparator == null ? (Comparator<Byte2ByteMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2ByteMap.Entry>)(x, y) -> Byte2ByteRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2ByteRBTreeMap.this.compare(k, from) >= 0) && (top || Byte2ByteRBTreeMap.this.compare(k, to) < 0);
		}
