...
public interface BooleanSet extends BooleanCollection, Set<Boolean> {
	...
	default BooleanSpliterator spliterator() {
		return BooleanSpliterators.asSpliterator(iterator(), sizeOf(this), BooleanSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	}
	...
	public static BooleanSet of(boolean... a) {
		...
		BooleanSet innerSet = a.length <= BooleanSets.ARRAY_SET_CUTOFF ? new BooleanArraySet(a.length) : new BooleanOpenHashSet(a.length);
