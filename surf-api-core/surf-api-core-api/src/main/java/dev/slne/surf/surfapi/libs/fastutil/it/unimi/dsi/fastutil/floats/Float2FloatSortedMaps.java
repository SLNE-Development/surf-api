...
public final class Float2FloatSortedMaps {
	...
	public static class Singleton extends Float2FloatMaps.Singleton implements Float2FloatSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2FloatMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Float2FloatMaps.SynchronizedMap implements Float2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2FloatEntrySet(), sync);
			return (ObjectSortedSet<Float2FloatMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2FloatMaps.UnmodifiableMap implements Float2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2FloatEntrySet());
			return (ObjectSortedSet<Float2FloatMap.Entry>)entries;
		}
