...
public final class Double2CharSortedMaps {
	...
	public static class Singleton extends Double2CharMaps.Singleton implements Double2CharSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2CharMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Double2CharMaps.SynchronizedMap implements Double2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2CharEntrySet(), sync);
			return (ObjectSortedSet<Double2CharMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2CharMaps.UnmodifiableMap implements Double2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2CharEntrySet());
			return (ObjectSortedSet<Double2CharMap.Entry>)entries;
		}
