 ...
 */
public interface IntShortPair extends it.unimi.dsi.fastutil.Pair<Integer, Short> {
	/**
	 ...
	 */
	public default IntShortPair left(final int l) {
	...
	@Deprecated
	@Override
	public default IntShortPair left(final Integer l) {
	 ...
	 */
	public default IntShortPair first(final int l) {
		return left(l);
	}
	...
	@Deprecated
	@Override
	public default IntShortPair first(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default IntShortPair key(final int l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default IntShortPair key(Integer l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default IntShortPair right(final short r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default IntShortPair right(final Short l) {
	 ...
	 */
	public default IntShortPair second(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default IntShortPair second(final Short l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default IntShortPair value(final short r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default IntShortPair value(final Short l) {
	 ...
	 */
	public static IntShortPair of(final int left, final short right) {
	...
	public static java.util.Comparator<IntShortPair> lexComparator() {
		return (x, y) -> {
