...
public final class Float2ByteSortedMaps {
	...
	public static class Singleton extends Float2ByteMaps.Singleton implements Float2ByteSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2ByteMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Float2ByteMaps.SynchronizedMap implements Float2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2ByteEntrySet(), sync);
			return (ObjectSortedSet<Float2ByteMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2ByteMaps.UnmodifiableMap implements Float2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2ByteEntrySet());
			return (ObjectSortedSet<Float2ByteMap.Entry>)entries;
		}
