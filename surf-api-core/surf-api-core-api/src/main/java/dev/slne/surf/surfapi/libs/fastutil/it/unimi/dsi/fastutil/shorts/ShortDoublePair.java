 ...
 */
public interface ShortDoublePair extends it.unimi.dsi.fastutil.Pair<Short, Double> {
	/**
	 ...
	 */
	public default ShortDoublePair left(final short l) {
	 ...
	 */
	public default ShortDoublePair first(final short l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default ShortDoublePair key(final short l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default ShortDoublePair key(Short l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default ShortDoublePair right(final double r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default ShortDoublePair right(final Double l) {
	 ...
	 */
	public default ShortDoublePair second(final double r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortDoublePair second(final Double l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ShortDoublePair value(final double r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortDoublePair value(final Double l) {
	 ...
	 */
	public static ShortDoublePair of(final short left, final double right) {
	...
	public static java.util.Comparator<ShortDoublePair> lexComparator() {
		return (x, y) -> {
