...
public class Double2ByteRBTreeMap extends AbstractDouble2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() {
			final Comparator<? super Double2ByteMap.Entry> comparator = (Double2ByteRBTreeMap.this.actualComparator == null ? (Comparator<Double2ByteMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2ByteMap.Entry>)(x, y) -> Double2ByteRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ByteRBTreeMap.this.compare(k, from) >= 0) && (top || Double2ByteRBTreeMap.this.compare(k, to) < 0);
		}
