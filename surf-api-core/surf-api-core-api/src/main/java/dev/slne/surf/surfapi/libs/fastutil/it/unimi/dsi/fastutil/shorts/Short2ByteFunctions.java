...
public final class Short2ByteFunctions {
	...
	public static Short2ByteFunction primitive(final java.util.function.Function<? super Short, ? extends Byte> f) {
		...
		if (f instanceof java.util.function.IntUnaryOperator) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToByte(((java.util.function.IntUnaryOperator)f).applyAsInt(key));
