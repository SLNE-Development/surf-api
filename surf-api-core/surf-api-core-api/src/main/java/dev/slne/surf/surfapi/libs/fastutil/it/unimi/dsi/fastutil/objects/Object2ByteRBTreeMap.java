...
public class Object2ByteRBTreeMap<K> extends AbstractObject2ByteSortedMap<K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
			final Comparator<? super Object2ByteMap.Entry<K>> comparator = (Object2ByteRBTreeMap.this.actualComparator == null ? (Comparator<Object2ByteMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2ByteMap.Entry<K>>)(x, y) -> Object2ByteRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2ByteSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2ByteRBTreeMap.this.compare(k, from) >= 0) && (top || Object2ByteRBTreeMap.this.compare(k, to) < 0);
		}
