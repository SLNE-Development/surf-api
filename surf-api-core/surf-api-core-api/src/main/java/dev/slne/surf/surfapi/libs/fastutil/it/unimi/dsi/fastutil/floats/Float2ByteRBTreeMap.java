...
public class Float2ByteRBTreeMap extends AbstractFloat2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
			final Comparator<? super Float2ByteMap.Entry> comparator = (Float2ByteRBTreeMap.this.actualComparator == null ? (Comparator<Float2ByteMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2ByteMap.Entry>)(x, y) -> Float2ByteRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2ByteRBTreeMap.this.compare(k, from) >= 0) && (top || Float2ByteRBTreeMap.this.compare(k, to) < 0);
		}
