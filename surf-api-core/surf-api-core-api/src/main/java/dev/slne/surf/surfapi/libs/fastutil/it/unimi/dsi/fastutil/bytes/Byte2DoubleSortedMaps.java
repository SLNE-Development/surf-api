...
public final class Byte2DoubleSortedMaps {
	...
	public static class Singleton extends Byte2DoubleMaps.Singleton implements Byte2DoubleSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2DoubleMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Byte2DoubleMaps.SynchronizedMap implements Byte2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Byte2DoubleMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2DoubleMaps.UnmodifiableMap implements Byte2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2DoubleEntrySet());
			return (ObjectSortedSet<Byte2DoubleMap.Entry>)entries;
		}
