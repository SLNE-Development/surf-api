...
public final class Object2CharMaps {
	...
	public static class Singleton<K> extends Object2CharFunctions.Singleton<K> implements Object2CharMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2CharMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2CharFunctions.SynchronizedFunction<K> implements Object2CharMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public char computeIfAbsent(final K key, final Object2CharFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2CharFunctions.UnmodifiableFunction<K> implements Object2CharMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2CharMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2CharEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public char getOrDefault(final Object key, final char defaultValue) {
			return ((Object2CharMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Object2CharMap<K> unmodifiable(final Object2CharMap<? extends K> m) {
