...
public final class Reference2BooleanSortedMaps {
	...
	public static class Singleton<K> extends Reference2BooleanMaps.Singleton<K> implements Reference2BooleanSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2BooleanMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Reference2BooleanMaps.SynchronizedMap<K> implements Reference2BooleanSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.reference2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Reference2BooleanMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2BooleanMaps.UnmodifiableMap<K> implements Reference2BooleanSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.reference2BooleanEntrySet());
			return (ObjectSortedSet<Reference2BooleanMap.Entry<K>>)entries;
		}
