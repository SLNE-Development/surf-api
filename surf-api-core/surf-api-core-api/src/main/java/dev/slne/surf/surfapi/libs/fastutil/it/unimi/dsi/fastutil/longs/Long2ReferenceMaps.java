...
public final class Long2ReferenceMaps {
	...
	public static class Singleton<V> extends Long2ReferenceFunctions.Singleton<V> implements Long2ReferenceMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractLong2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Long2ReferenceFunctions.SynchronizedFunction<V> implements Long2ReferenceMap<V>, java.io.Serializable {
		...
		public ObjectSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.long2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Long2ReferenceFunctions.UnmodifiableFunction<V> implements Long2ReferenceMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.long2ReferenceEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final long key, final V defaultValue) {
			return ((Long2ReferenceMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Long2ReferenceMap<V> unmodifiable(final Long2ReferenceMap<? extends V> m) {
