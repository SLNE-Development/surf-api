 ...
 */
public class ByteCharImmutablePair implements ByteCharPair, java.io.Serializable {
	 ...
	 */
	public ByteCharImmutablePair(final byte left, final char right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static ByteCharImmutablePair of(final byte left, final char right) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof ByteCharPair) {
			return left == ((ByteCharPair)other).leftByte() && right == ((ByteCharPair)other).rightChar();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Byte.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && java.util.Objects.equals(Character.valueOf(right), ((it.unimi.dsi.fastutil.Pair)other).right());
		}
		return false;
	}
