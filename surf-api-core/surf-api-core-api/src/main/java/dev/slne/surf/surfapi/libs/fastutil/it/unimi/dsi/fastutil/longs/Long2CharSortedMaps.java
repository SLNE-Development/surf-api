...
public final class Long2CharSortedMaps {
	...
	public static class Singleton extends Long2CharMaps.Singleton implements Long2CharSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2CharMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Long2CharMaps.SynchronizedMap implements Long2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2CharEntrySet(), sync);
			return (ObjectSortedSet<Long2CharMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2CharMaps.UnmodifiableMap implements Long2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2CharEntrySet());
			return (ObjectSortedSet<Long2CharMap.Entry>)entries;
		}
