...
public class Float2ObjectRBTreeMap<V> extends AbstractFloat2ObjectSortedMap<V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>() {
			final Comparator<? super Float2ObjectMap.Entry<V>> comparator = (Float2ObjectRBTreeMap.this.actualComparator == null ? (Comparator<Float2ObjectMap.Entry<V>>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2ObjectMap.Entry<V>>)(x, y) -> Float2ObjectRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2ObjectRBTreeMap.this.compare(k, from) >= 0) && (top || Float2ObjectRBTreeMap.this.compare(k, to) < 0);
		}
