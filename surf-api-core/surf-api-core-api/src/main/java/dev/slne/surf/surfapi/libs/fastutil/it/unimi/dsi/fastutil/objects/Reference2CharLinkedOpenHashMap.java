...
public class Reference2CharLinkedOpenHashMap<K> extends AbstractReference2CharSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2CharMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Reference2CharMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public CharCollection values() {
		if (values == null) values = new AbstractCharCollection() {
			...
			public CharSpliterator spliterator() {
				return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
