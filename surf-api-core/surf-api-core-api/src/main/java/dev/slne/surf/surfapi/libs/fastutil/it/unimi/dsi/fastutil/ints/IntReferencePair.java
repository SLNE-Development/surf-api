 ...
 */
public interface IntReferencePair<V> extends it.unimi.dsi.fastutil.Pair<Integer, V> {
	/**
	 ...
	 */
	public default IntReferencePair<V> left(final int l) {
	...
	@Deprecated
	@Override
	public default IntReferencePair<V> left(final Integer l) {
	 ...
	 */
	public default IntReferencePair<V> first(final int l) {
		return left(l);
	}
	...
	@Deprecated
	@Override
	public default IntReferencePair<V> first(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default IntReferencePair<V> key(final int l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default IntReferencePair<V> key(Integer l) {
	 ...
	 */
	public static <V> IntReferencePair<V> of(final int left, final V right) {
