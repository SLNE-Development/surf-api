	...
	public ByteSet keySet() {
		return new AbstractByteSet() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), sizeOf(AbstractByte2ReferenceMap.this), ByteSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public ReferenceCollection<V> values() {
		return new AbstractReferenceCollection<V>() {
			...
			public ObjectSpliterator<V> spliterator() {
				return ObjectSpliterators.asSpliterator(iterator(), sizeOf(AbstractByte2ReferenceMap.this), ObjectSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
