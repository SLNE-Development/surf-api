...
public final class Short2BooleanMaps {
	...
	public static class EmptyMap extends Short2BooleanFunctions.EmptyFunction implements Short2BooleanMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Boolean> consumer) {
		}
	...
	public static class Singleton extends Short2BooleanFunctions.Singleton implements Short2BooleanMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2BooleanFunctions.SynchronizedFunction implements Short2BooleanMap, java.io.Serializable {
		...
		public ObjectSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Boolean> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Short2BooleanFunctions.UnmodifiableFunction implements Short2BooleanMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2BooleanEntrySet());
			return entries;
		}
