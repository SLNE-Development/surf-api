 ...
 */
public interface FloatObjectPair<V> extends it.unimi.dsi.fastutil.Pair<Float, V> {
	/**
	 ...
	 */
	public default FloatObjectPair<V> left(final float l) {
	 ...
	 */
	public default FloatObjectPair<V> first(final float l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default FloatObjectPair<V> key(final float l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default FloatObjectPair<V> key(Float l) {
	 ...
	 */
	public static <V> FloatObjectPair<V> of(final float left, final V right) {
	...
	public static <V> java.util.Comparator<FloatObjectPair<V>> lexComparator() {
		return (x, y) -> {
