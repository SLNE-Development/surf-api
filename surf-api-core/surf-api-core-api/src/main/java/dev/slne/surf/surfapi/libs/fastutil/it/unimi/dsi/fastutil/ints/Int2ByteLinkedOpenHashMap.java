...
public class Int2ByteLinkedOpenHashMap extends AbstractInt2ByteSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2ByteMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Int2ByteMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractIntSortedSet {
		...
		public IntSpliterator spliterator() {
			return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ByteCollection values() {
		if (values == null) values = new AbstractByteCollection() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
