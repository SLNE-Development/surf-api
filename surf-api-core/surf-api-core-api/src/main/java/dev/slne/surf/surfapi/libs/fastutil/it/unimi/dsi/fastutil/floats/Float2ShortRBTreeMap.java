...
public class Float2ShortRBTreeMap extends AbstractFloat2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() {
			final Comparator<? super Float2ShortMap.Entry> comparator = (Float2ShortRBTreeMap.this.actualComparator == null ? (Comparator<Float2ShortMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2ShortMap.Entry>)(x, y) -> Float2ShortRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2ShortRBTreeMap.this.compare(k, from) >= 0) && (top || Float2ShortRBTreeMap.this.compare(k, to) < 0);
		}
