...
public interface Object2ByteMap<K> extends Object2ByteFunction<K>, Map<K, Byte> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super Byte> consumer) {
		final ObjectSet<Object2ByteMap.Entry<K>> entrySet = object2ByteEntrySet();
		final Consumer<Object2ByteMap.Entry<K>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), Byte.valueOf(entry.getByteValue()));
	 ...
	 * @since 8.0.0
	 */
	default byte computeIfAbsent(final K key, final Object2ByteFunction<? super K> mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final byte v = getByte(key), drv = defaultReturnValue();
		if (v != drv || containsKey(key)) return v;
