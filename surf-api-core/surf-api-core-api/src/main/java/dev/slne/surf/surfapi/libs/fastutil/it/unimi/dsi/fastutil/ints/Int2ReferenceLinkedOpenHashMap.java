...
public class Int2ReferenceLinkedOpenHashMap<V> extends AbstractInt2ReferenceSortedMap<V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>> implements FastSortedEntrySet<V> {
		...
		public ObjectSpliterator<Int2ReferenceMap.Entry<V>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractIntSortedSet {
		...
		public IntSpliterator spliterator() {
			return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
