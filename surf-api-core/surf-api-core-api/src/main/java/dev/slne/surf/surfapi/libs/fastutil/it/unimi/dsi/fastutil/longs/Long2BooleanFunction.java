/*
	...
	*/
package dev.slne.surf.surfapi.libs.fastutil.it.unimi.dsi.fastutil.longs;
...
public interface Long2BooleanFunction extends Function<Long, Boolean>, java.util.function.LongPredicate {
	...
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction andThenByte(it.unimi.dsi.fastutil.booleans.Boolean2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ShortFunction andThenShort(it.unimi.dsi.fastutil.booleans.Boolean2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2BooleanFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThenInt(it.unimi.dsi.fastutil.booleans.Boolean2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2BooleanFunction composeInt(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2LongFunction andThenLong(it.unimi.dsi.fastutil.booleans.Boolean2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2BooleanFunction composeLong(it.unimi.dsi.fastutil.longs.Long2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2CharFunction andThenChar(it.unimi.dsi.fastutil.booleans.Boolean2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2BooleanFunction composeChar(it.unimi.dsi.fastutil.chars.Char2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2FloatFunction andThenFloat(it.unimi.dsi.fastutil.booleans.Boolean2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2BooleanFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.booleans.Boolean2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2BooleanFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2LongFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.longs.Long2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.booleans.Boolean2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2BooleanFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2LongFunction<? super T> before) {
		return k -> get(before.getLong(k));
	}

	default <T> it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.booleans.Boolean2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2BooleanFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2LongFunction<? super T> before) {
		return k -> get(before.getLong(k));
	}
}
