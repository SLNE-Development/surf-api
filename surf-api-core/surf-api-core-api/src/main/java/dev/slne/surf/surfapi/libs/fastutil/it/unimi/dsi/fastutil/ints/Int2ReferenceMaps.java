...
public final class Int2ReferenceMaps {
	...
	public static class Singleton<V> extends Int2ReferenceFunctions.Singleton<V> implements Int2ReferenceMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractInt2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Int2ReferenceFunctions.SynchronizedFunction<V> implements Int2ReferenceMap<V>, java.io.Serializable {
		...
		public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.int2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Int2ReferenceFunctions.UnmodifiableFunction<V> implements Int2ReferenceMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.int2ReferenceEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final int key, final V defaultValue) {
			return ((Int2ReferenceMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Int2ReferenceMap<V> unmodifiable(final Int2ReferenceMap<? extends V> m) {
