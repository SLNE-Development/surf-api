...
public final class Int2ByteSortedMaps {
	...
	public static class Singleton extends Int2ByteMaps.Singleton implements Int2ByteSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2ByteMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2ByteMaps.SynchronizedMap implements Int2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2ByteEntrySet(), sync);
			return (ObjectSortedSet<Int2ByteMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2ByteMaps.UnmodifiableMap implements Int2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2ByteEntrySet());
			return (ObjectSortedSet<Int2ByteMap.Entry>)entries;
		}
