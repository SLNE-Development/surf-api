...
public final class Short2FloatFunctions {
	...
	public static Short2FloatFunction primitive(final java.util.function.Function<? super Short, ? extends Float> f) {
		...
		if (f instanceof java.util.function.IntToDoubleFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(((java.util.function.IntToDoubleFunction)f).applyAsDouble(key));
