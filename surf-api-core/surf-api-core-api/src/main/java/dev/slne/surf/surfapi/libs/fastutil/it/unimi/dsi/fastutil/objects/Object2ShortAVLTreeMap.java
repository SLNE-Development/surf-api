	...
	*/
	...
	public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
			final Comparator<? super Object2ShortMap.Entry<K>> comparator = (Object2ShortAVLTreeMap.this.actualComparator == null ? (Comparator<Object2ShortMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2ShortMap.Entry<K>>)(x, y) -> Object2ShortAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2ShortSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2ShortAVLTreeMap.this.compare(k, from) >= 0) && (top || Object2ShortAVLTreeMap.this.compare(k, to) < 0);
		}
