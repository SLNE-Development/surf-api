...
public final class Byte2LongSortedMaps {
	...
	public static class Singleton extends Byte2LongMaps.Singleton implements Byte2LongSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractByte2LongMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Byte2LongMaps.SynchronizedMap implements Byte2LongSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.byte2LongEntrySet(), sync);
			return (ObjectSortedSet<Byte2LongMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2LongMaps.UnmodifiableMap implements Byte2LongSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.byte2LongEntrySet());
			return (ObjectSortedSet<Byte2LongMap.Entry>)entries;
		}
