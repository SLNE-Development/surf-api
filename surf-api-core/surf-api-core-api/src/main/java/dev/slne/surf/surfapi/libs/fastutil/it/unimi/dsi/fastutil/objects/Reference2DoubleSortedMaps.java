...
public final class Reference2DoubleSortedMaps {
	...
	public static class Singleton<K> extends Reference2DoubleMaps.Singleton<K> implements Reference2DoubleSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2DoubleMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Reference2DoubleMaps.SynchronizedMap<K> implements Reference2DoubleSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.reference2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Reference2DoubleMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2DoubleMaps.UnmodifiableMap<K> implements Reference2DoubleSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.reference2DoubleEntrySet());
			return (ObjectSortedSet<Reference2DoubleMap.Entry<K>>)entries;
		}
