	...
	*/
	...
	public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2CharMap.Entry>() {
			final Comparator<? super Float2CharMap.Entry> comparator = (Float2CharAVLTreeMap.this.actualComparator == null ? (Comparator<Float2CharMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2CharMap.Entry>)(x, y) -> Float2CharAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
			...
			public boolean remove(final Object o) {
				...
				if (!(e.getValue() instanceof Character)) return false;
				final Entry f = findKey(((Float)(e.getKey())).floatValue());
	...
	private final class Submap extends AbstractFloat2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2CharAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2CharAVLTreeMap.this.compare(k, to) < 0);
		}
