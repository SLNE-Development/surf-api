...
public class Float2ByteLinkedOpenHashMap extends AbstractFloat2ByteSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2ByteMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Float2ByteMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractFloatSortedSet {
		...
		public FloatSpliterator spliterator() {
			return FloatSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	 ...
	 */
	private final class ValueIterator extends MapIterator<ByteConsumer> implements ByteListIterator {
		@Override
	...
	public ByteCollection values() {
		if (values == null) values = new AbstractByteCollection() {
			private static final int SPLITERATOR_CHARACTERISTICS = ByteSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.ORDERED;
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Float2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
