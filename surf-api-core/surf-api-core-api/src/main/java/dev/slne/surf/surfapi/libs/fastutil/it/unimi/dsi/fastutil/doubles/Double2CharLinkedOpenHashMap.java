...
public class Double2CharLinkedOpenHashMap extends AbstractDouble2CharSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Double2CharMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Double2CharMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Double2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractDoubleSortedSet {
		...
		public DoubleSpliterator spliterator() {
			return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Double2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public CharCollection values() {
		if (values == null) values = new AbstractCharCollection() {
			...
			public CharSpliterator spliterator() {
				return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Double2CharLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
