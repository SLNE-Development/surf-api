 ...
 */
public class ReferenceBooleanMutablePair<K> implements ReferenceBooleanPair<K>, java.io.Serializable {
	 ...
	 */
	public ReferenceBooleanMutablePair(final K left, final boolean right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ReferenceBooleanMutablePair<K> of(final K left, final boolean right) {
	...
	@Override
	public ReferenceBooleanMutablePair<K> left(final K l) {
		left = l;
		return this;
	}
	...
	@Override
	public ReferenceBooleanMutablePair<K> right(final boolean r) {
		right = r;
		return this;
	}
