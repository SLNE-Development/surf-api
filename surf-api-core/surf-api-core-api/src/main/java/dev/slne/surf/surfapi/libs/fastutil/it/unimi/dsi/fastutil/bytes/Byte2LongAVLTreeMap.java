	...
	*/
	...
	public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() {
			final Comparator<? super Byte2LongMap.Entry> comparator = (Byte2LongAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2LongMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2LongMap.Entry>)(x, y) -> Byte2LongAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2LongAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2LongAVLTreeMap.this.compare(k, to) < 0);
		}
