...
public class Long2CharRBTreeMap extends AbstractLong2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2CharMap.Entry>() {
			final Comparator<? super Long2CharMap.Entry> comparator = (Long2CharRBTreeMap.this.actualComparator == null ? (Comparator<Long2CharMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2CharMap.Entry>)(x, y) -> Long2CharRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2CharRBTreeMap.this.compare(k, from) >= 0) && (top || Long2CharRBTreeMap.this.compare(k, to) < 0);
		}
