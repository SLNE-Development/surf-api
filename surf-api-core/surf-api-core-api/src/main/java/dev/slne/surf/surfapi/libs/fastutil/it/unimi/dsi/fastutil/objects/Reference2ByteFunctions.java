...
public final class Reference2ByteFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2ByteFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2ByteFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public byte getOrDefault(final Object k, final byte defaultValue) {
			return ((Reference2ByteFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2ByteFunction<K> unmodifiable(final Reference2ByteFunction<? extends K> f) {
	...
	public static <K> Reference2ByteFunction<K> primitive(final java.util.function.Function<? super K, ? extends Byte> f) {
		...
		if (f instanceof java.util.function.ToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToByte(((java.util.function.ToIntFunction<K>)f).applyAsInt((K)(key)));
