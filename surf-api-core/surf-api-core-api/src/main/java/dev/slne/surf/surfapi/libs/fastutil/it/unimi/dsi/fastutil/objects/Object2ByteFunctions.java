...
public final class Object2ByteFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2ByteFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Object2ByteFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public byte getOrDefault(final Object k, final byte defaultValue) {
			return ((Object2ByteFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Object2ByteFunction<K> unmodifiable(final Object2ByteFunction<? extends K> f) {
