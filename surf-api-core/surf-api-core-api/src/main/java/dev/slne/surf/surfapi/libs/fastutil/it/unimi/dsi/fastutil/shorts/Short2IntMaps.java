...
public final class Short2IntMaps {
	...
	public static class EmptyMap extends Short2IntFunctions.EmptyFunction implements Short2IntMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Integer> consumer) {
		}
	...
	public static class Singleton extends Short2IntFunctions.Singleton implements Short2IntMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2IntFunctions.SynchronizedFunction implements Short2IntMap, java.io.Serializable {
		...
		public ObjectSet<Short2IntMap.Entry> short2IntEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Integer> mappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Short key, final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer compute(final Short key, final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer merge(final Short key, final Integer value, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2IntFunctions.UnmodifiableFunction implements Short2IntMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2IntEntrySet());
			return entries;
		}
