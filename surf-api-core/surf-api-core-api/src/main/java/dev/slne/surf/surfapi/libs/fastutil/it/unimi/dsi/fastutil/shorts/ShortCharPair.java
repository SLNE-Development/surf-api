 ...
 */
public interface ShortCharPair extends it.unimi.dsi.fastutil.Pair<Short, Character> {
	/**
	 ...
	 */
	public default ShortCharPair left(final short l) {
	 ...
	 */
	public default ShortCharPair first(final short l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default ShortCharPair key(final short l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default ShortCharPair key(Short l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default ShortCharPair right(final char r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default ShortCharPair right(final Character l) {
	 ...
	 */
	public default ShortCharPair second(final char r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortCharPair second(final Character l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ShortCharPair value(final char r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortCharPair value(final Character l) {
	 ...
	 */
	public static ShortCharPair of(final short left, final char right) {
	...
	public static java.util.Comparator<ShortCharPair> lexComparator() {
		return (x, y) -> {
