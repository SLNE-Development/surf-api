...
public class Object2ShortLinkedOpenHashMap<K> extends AbstractObject2ShortSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ShortMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Object2ShortMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ShortCollection values() {
		if (values == null) values = new AbstractShortCollection() {
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2ShortLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
