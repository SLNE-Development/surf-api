 ...
 */
public interface ShortLongPair extends it.unimi.dsi.fastutil.Pair<Short, Long> {
	/**
	 ...
	 */
	public default ShortLongPair left(final short l) {
	 ...
	 */
	public default ShortLongPair first(final short l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default ShortLongPair key(final short l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default ShortLongPair key(Short l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default ShortLongPair right(final long r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default ShortLongPair right(final Long l) {
	 ...
	 */
	public default ShortLongPair second(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortLongPair second(final Long l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ShortLongPair value(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortLongPair value(final Long l) {
	 ...
	 */
	public static ShortLongPair of(final short left, final long right) {
	...
	public static java.util.Comparator<ShortLongPair> lexComparator() {
		return (x, y) -> {
