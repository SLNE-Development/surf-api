...
public final class Long2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Long2ReferenceMaps.Singleton<V> implements Long2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Long2ReferenceMaps.SynchronizedMap<V> implements Long2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Long2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Long2ReferenceMaps.UnmodifiableMap<V> implements Long2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Long2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2ReferenceEntrySet());
			return (ObjectSortedSet<Long2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Long2ReferenceSortedMap<V> unmodifiable(final Long2ReferenceSortedMap<? extends V> m) {
