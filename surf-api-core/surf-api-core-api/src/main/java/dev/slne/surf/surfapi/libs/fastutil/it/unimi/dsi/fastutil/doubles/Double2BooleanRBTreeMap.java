...
public class Double2BooleanRBTreeMap extends AbstractDouble2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>() {
			final Comparator<? super Double2BooleanMap.Entry> comparator = (Double2BooleanRBTreeMap.this.actualComparator == null ? (Comparator<Double2BooleanMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2BooleanMap.Entry>)(x, y) -> Double2BooleanRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2BooleanRBTreeMap.this.compare(k, from) >= 0) && (top || Double2BooleanRBTreeMap.this.compare(k, to) < 0);
		}
