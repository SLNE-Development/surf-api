...
@CanBeSpawned
public interface PacketCommandBlockMinecart extends
    PacketAbstractMinecart<PacketCommandBlockMinecart>, Spawnable {
  ...
  /**
   * Gets the command that this CommandBlock will run when powered. This will never return null.  If
   * the CommandBlock does not have a command, an empty String will be returned instead.
   *
  ...
  /**
   * Sets the command that this CommandBlock will run when powered. Setting the command to null is
   * the same as setting it to an empty String.
   *
