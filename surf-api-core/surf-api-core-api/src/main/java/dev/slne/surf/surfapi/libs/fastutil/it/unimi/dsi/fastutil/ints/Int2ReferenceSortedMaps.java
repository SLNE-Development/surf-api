...
public final class Int2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Int2ReferenceMaps.Singleton<V> implements Int2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Int2ReferenceMaps.SynchronizedMap<V> implements Int2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Int2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Int2ReferenceMaps.UnmodifiableMap<V> implements Int2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Int2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2ReferenceEntrySet());
			return (ObjectSortedSet<Int2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Int2ReferenceSortedMap<V> unmodifiable(final Int2ReferenceSortedMap<? extends V> m) {
