...
public final class Byte2ReferenceMaps {
	...
	public static class Singleton<V> extends Byte2ReferenceFunctions.Singleton<V> implements Byte2ReferenceMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractByte2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Byte2ReferenceFunctions.SynchronizedFunction<V> implements Byte2ReferenceMap<V>, java.io.Serializable {
		...
		public ObjectSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.byte2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Byte2ReferenceFunctions.UnmodifiableFunction<V> implements Byte2ReferenceMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Byte2ReferenceMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.byte2ReferenceEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final byte key, final V defaultValue) {
			return ((Byte2ReferenceMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Byte2ReferenceMap<V> unmodifiable(final Byte2ReferenceMap<? extends V> m) {
