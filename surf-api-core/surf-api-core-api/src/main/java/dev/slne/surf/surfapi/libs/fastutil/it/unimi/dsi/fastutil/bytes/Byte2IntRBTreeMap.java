...
public class Byte2IntRBTreeMap extends AbstractByte2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
			final Comparator<? super Byte2IntMap.Entry> comparator = (Byte2IntRBTreeMap.this.actualComparator == null ? (Comparator<Byte2IntMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2IntMap.Entry>)(x, y) -> Byte2IntRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2IntRBTreeMap.this.compare(k, from) >= 0) && (top || Byte2IntRBTreeMap.this.compare(k, to) < 0);
		}
