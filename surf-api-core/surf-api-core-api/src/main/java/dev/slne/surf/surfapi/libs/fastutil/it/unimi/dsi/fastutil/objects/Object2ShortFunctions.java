...
public final class Object2ShortFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2ShortFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Object2ShortFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public short getOrDefault(final Object k, final short defaultValue) {
			return ((Object2ShortFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Object2ShortFunction<K> unmodifiable(final Object2ShortFunction<? extends K> f) {
