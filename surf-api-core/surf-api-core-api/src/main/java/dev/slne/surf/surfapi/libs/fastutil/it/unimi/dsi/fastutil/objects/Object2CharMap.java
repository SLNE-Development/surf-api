...
public interface Object2CharMap<K> extends Object2CharFunction<K>, Map<K, Character> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super Character> consumer) {
		final ObjectSet<Object2CharMap.Entry<K>> entrySet = object2CharEntrySet();
		final Consumer<Object2CharMap.Entry<K>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), Character.valueOf(entry.getCharValue()));
