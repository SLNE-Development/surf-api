...
public final class Long2ShortFunctions {
	...
	public static Long2ShortFunction primitive(final java.util.function.Function<? super Long, ? extends Short> f) {
		...
		if (f instanceof java.util.function.LongToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.LongToIntFunction)f).applyAsInt(key));
