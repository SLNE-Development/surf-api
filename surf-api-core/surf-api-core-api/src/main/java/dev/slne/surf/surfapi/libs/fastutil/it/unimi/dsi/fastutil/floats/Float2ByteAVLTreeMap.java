	...
	*/
	...
	public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
			final Comparator<? super Float2ByteMap.Entry> comparator = (Float2ByteAVLTreeMap.this.actualComparator == null ? (Comparator<Float2ByteMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2ByteMap.Entry>)(x, y) -> Float2ByteAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
			...
			public boolean remove(final Object o) {
				...
				if (!(e.getValue() instanceof Byte)) return false;
				final Entry f = findKey(((Float)(e.getKey())).floatValue());
	...
	private final class Submap extends AbstractFloat2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2ByteAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2ByteAVLTreeMap.this.compare(k, to) < 0);
		}
