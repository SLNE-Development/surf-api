...
import static it.unimi.dsi.fastutil.shorts.ShortArrayFrontCodedList.count;
import static it.unimi.dsi.fastutil.shorts.ShortArrayFrontCodedList.readInt;
import static it.unimi.dsi.fastutil.shorts.ShortArrayFrontCodedList.writeInt;
...
public class ShortArrayFrontCodedBigList extends AbstractObjectBigList<short[]> implements Serializable, Cloneable, RandomAccess {
	 ...
	 */
	public ShortArrayFrontCodedBigList(final Iterator<short[]> arrays, final int ratio) {
	 ...
	 * @param ratio the desired ratio.
	 */
	public ShortArrayFrontCodedBigList(final Collection<short[]> c, final int ratio) {
	 ...
	 */
	private int extract(final long index, final short a[], final int offset, final int length) {
	 ...
	 */
	public short[] getArray(final long index) {
		ensureRestrictedIndex(index);
	 ...
	 */
	public int get(final long index, final short[] a, final int offset, final int length) {
		ensureRestrictedIndex(index);
	 ...
	 *         otherwise, the number of remaining elements with the sign changed.
	 */
	public int get(final long index, final short[] a) {
	...
	public void dump(java.io.DataOutputStream array, java.io.DataOutputStream pointers) throws java.io.IOException {
		for (short[] s : this.array) for (short e : s) array.writeShort(e);
