...
public final class Reference2ShortFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2ShortFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2ShortFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public short getOrDefault(final Object k, final short defaultValue) {
			return ((Reference2ShortFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2ShortFunction<K> unmodifiable(final Reference2ShortFunction<? extends K> f) {
	...
	public static <K> Reference2ShortFunction<K> primitive(final java.util.function.Function<? super K, ? extends Short> f) {
		...
		if (f instanceof java.util.function.ToIntFunction) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.ToIntFunction<K>)f).applyAsInt((K)(key)));
