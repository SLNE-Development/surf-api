...
public final class Object2ByteSortedMaps {
	...
	public static class Singleton<K> extends Object2ByteMaps.Singleton<K> implements Object2ByteSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2ByteMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Object2ByteMaps.SynchronizedMap<K> implements Object2ByteSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2ByteEntrySet(), sync);
			return (ObjectSortedSet<Object2ByteMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2ByteMaps.UnmodifiableMap<K> implements Object2ByteSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2ByteEntrySet());
			return (ObjectSortedSet<Object2ByteMap.Entry<K>>)entries;
		}
