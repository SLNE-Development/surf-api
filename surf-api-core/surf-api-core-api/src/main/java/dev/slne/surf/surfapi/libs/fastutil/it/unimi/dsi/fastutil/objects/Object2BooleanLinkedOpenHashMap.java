...
public class Object2BooleanLinkedOpenHashMap<K> extends AbstractObject2BooleanSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2BooleanMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Object2BooleanMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public BooleanCollection values() {
		if (values == null) values = new AbstractBooleanCollection() {
			...
			public BooleanSpliterator spliterator() {
				return BooleanSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2BooleanLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
