...
public final class Float2ObjectMaps {
	...
	public static class Singleton<V> extends Float2ObjectFunctions.Singleton<V> implements Float2ObjectMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Float2ObjectFunctions.SynchronizedFunction<V> implements Float2ObjectMap<V>, java.io.Serializable {
		...
		public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.float2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Float2ObjectFunctions.UnmodifiableFunction<V> implements Float2ObjectMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Float2ObjectMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final float key, final V defaultValue) {
			return ((Float2ObjectMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Float2ObjectMap<V> unmodifiable(final Float2ObjectMap<? extends V> m) {
