...
public final class Reference2DoubleFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2DoubleFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Reference2DoubleFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public double getOrDefault(final Object k, final double defaultValue) {
			return ((Reference2DoubleFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Reference2DoubleFunction<K> unmodifiable(final Reference2DoubleFunction<? extends K> f) {
