...
public class Short2BooleanRBTreeMap extends AbstractShort2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
			final Comparator<? super Short2BooleanMap.Entry> comparator = (Short2BooleanRBTreeMap.this.actualComparator == null ? (Comparator<Short2BooleanMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2BooleanMap.Entry>)(x, y) -> Short2BooleanRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2BooleanRBTreeMap.this.compare(k, from) >= 0) && (top || Short2BooleanRBTreeMap.this.compare(k, to) < 0);
		}
