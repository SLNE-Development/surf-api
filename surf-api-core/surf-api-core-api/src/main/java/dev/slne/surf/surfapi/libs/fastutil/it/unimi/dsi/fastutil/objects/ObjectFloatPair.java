 ...
 */
public interface ObjectFloatPair<K> extends it.unimi.dsi.fastutil.Pair<K, Float> {
	/**
	 ...
	 */
	public default ObjectFloatPair<K> right(final float r) {
	...
	@Deprecated
	@Override
	public default ObjectFloatPair<K> right(final Float l) {
	 ...
	 */
	public default ObjectFloatPair<K> second(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectFloatPair<K> second(final Float l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ObjectFloatPair<K> value(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectFloatPair<K> value(final Float l) {
	 ...
	 */
	public static <K> ObjectFloatPair<K> of(final K left, final float right) {
	...
	public static <K> java.util.Comparator<ObjectFloatPair<K>> lexComparator() {
		return (x, y) -> {
