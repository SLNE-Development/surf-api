 ...
 */
public interface FloatIntPair extends it.unimi.dsi.fastutil.Pair<Float, Integer> {
	/**
	 ...
	 */
	public default FloatIntPair left(final float l) {
	 ...
	 */
	public default FloatIntPair first(final float l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default FloatIntPair key(final float l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default FloatIntPair key(Float l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default FloatIntPair right(final int r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default FloatIntPair right(final Integer l) {
	 ...
	 */
	public default FloatIntPair second(final int r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatIntPair second(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default FloatIntPair value(final int r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default FloatIntPair value(final Integer l) {
	 ...
	 */
	public static FloatIntPair of(final float left, final int right) {
	...
	public static java.util.Comparator<FloatIntPair> lexComparator() {
		return (x, y) -> {
