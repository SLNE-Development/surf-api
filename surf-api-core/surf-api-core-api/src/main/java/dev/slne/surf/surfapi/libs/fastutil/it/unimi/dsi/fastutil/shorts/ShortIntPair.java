 ...
 */
public interface ShortIntPair extends it.unimi.dsi.fastutil.Pair<Short, Integer> {
	/**
	 ...
	 */
	public default ShortIntPair left(final short l) {
	 ...
	 */
	public default ShortIntPair first(final short l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default ShortIntPair key(final short l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default ShortIntPair key(Short l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default ShortIntPair right(final int r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default ShortIntPair right(final Integer l) {
	 ...
	 */
	public default ShortIntPair second(final int r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortIntPair second(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ShortIntPair value(final int r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ShortIntPair value(final Integer l) {
	 ...
	 */
	public static ShortIntPair of(final short left, final int right) {
	...
	public static java.util.Comparator<ShortIntPair> lexComparator() {
		return (x, y) -> {
