...
public final class Byte2ByteMaps {
	...
	public static class EmptyMap extends Byte2ByteFunctions.EmptyFunction implements Byte2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Byte, ? super Byte> consumer) {
		}
	...
	public static class Singleton extends Byte2ByteFunctions.Singleton implements Byte2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractByte2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Byte2ByteFunctions.SynchronizedFunction implements Byte2ByteMap, java.io.Serializable {
		...
		public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.byte2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final byte key, final java.util.function.IntFunction<? extends Byte> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Byte2ByteFunctions.UnmodifiableFunction implements Byte2ByteMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.byte2ByteEntrySet());
			return entries;
		}
