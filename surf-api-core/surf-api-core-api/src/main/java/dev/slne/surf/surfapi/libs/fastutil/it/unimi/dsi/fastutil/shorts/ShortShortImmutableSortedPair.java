...
public class ShortShortImmutableSortedPair extends ShortShortImmutablePair implements ShortShortSortedPair, java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof ShortShortSortedPair) {
			return left == ((ShortShortSortedPair)other).leftShort() && right == ((ShortShortSortedPair)other).rightShort();
		}
		if (other instanceof it.unimi.dsi.fastutil.SortedPair) {
			return java.util.Objects.equals(Short.valueOf(left), ((it.unimi.dsi.fastutil.SortedPair)other).left()) && java.util.Objects.equals(Short.valueOf(right), ((it.unimi.dsi.fastutil.SortedPair)other).right());
		}
		return false;
	}
