...
public final class Object2FloatSortedMaps {
	...
	public static class Singleton<K> extends Object2FloatMaps.Singleton<K> implements Object2FloatSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2FloatMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Object2FloatMaps.SynchronizedMap<K> implements Object2FloatSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2FloatEntrySet(), sync);
			return (ObjectSortedSet<Object2FloatMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2FloatMaps.UnmodifiableMap<K> implements Object2FloatSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2FloatEntrySet());
			return (ObjectSortedSet<Object2FloatMap.Entry<K>>)entries;
		}
