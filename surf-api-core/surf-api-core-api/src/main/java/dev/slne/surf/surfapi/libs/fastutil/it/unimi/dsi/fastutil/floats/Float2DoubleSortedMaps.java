...
public final class Float2DoubleSortedMaps {
	...
	public static class Singleton extends Float2DoubleMaps.Singleton implements Float2DoubleSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2DoubleMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Float2DoubleMaps.SynchronizedMap implements Float2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Float2DoubleMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2DoubleMaps.UnmodifiableMap implements Float2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2DoubleEntrySet());
			return (ObjectSortedSet<Float2DoubleMap.Entry>)entries;
		}
