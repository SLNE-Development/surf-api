 ...
 * It provides methods to complete the result and to register callback that will be executed when the result is complete.
 *
...
public class Result<T> {
     ...
     * Sets the value of the result to the specified value and invokes the registered callback, if any.
     *
