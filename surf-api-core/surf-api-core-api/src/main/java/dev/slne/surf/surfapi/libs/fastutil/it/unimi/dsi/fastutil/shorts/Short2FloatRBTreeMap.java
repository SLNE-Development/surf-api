...
public class Short2FloatRBTreeMap extends AbstractShort2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
			final Comparator<? super Short2FloatMap.Entry> comparator = (Short2FloatRBTreeMap.this.actualComparator == null ? (Comparator<Short2FloatMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2FloatMap.Entry>)(x, y) -> Short2FloatRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2FloatRBTreeMap.this.compare(k, from) >= 0) && (top || Short2FloatRBTreeMap.this.compare(k, to) < 0);
		}
