...
public final class Float2ObjectFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractFloat2ObjectFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Float2ObjectFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final float k, final V defaultValue) {
			return ((Float2ObjectFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Float2ObjectFunction<V> unmodifiable(final Float2ObjectFunction<? extends V> f) {
