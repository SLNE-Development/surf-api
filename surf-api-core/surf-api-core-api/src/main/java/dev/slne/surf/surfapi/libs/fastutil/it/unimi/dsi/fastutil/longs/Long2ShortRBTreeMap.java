...
public class Long2ShortRBTreeMap extends AbstractLong2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() {
			final Comparator<? super Long2ShortMap.Entry> comparator = (Long2ShortRBTreeMap.this.actualComparator == null ? (Comparator<Long2ShortMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2ShortMap.Entry>)(x, y) -> Long2ShortRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ShortRBTreeMap.this.compare(k, from) >= 0) && (top || Long2ShortRBTreeMap.this.compare(k, to) < 0);
		}
