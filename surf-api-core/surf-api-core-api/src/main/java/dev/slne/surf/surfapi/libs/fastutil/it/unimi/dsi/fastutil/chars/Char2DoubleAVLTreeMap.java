	...
	*/
	...
	public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>() {
			final Comparator<? super Char2DoubleMap.Entry> comparator = (Char2DoubleAVLTreeMap.this.actualComparator == null ? (Comparator<Char2DoubleMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2DoubleMap.Entry>)(x, y) -> Char2DoubleAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
	...
	private final class Submap extends AbstractChar2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2DoubleAVLTreeMap.this.compare(k, from) >= 0) && (top || Char2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
