 ...
 */
public interface ReferenceFloatPair<K> extends it.unimi.dsi.fastutil.Pair<K, Float> {
	/**
	 ...
	 */
	public default ReferenceFloatPair<K> right(final float r) {
	...
	@Deprecated
	@Override
	public default ReferenceFloatPair<K> right(final Float l) {
	 ...
	 */
	public default ReferenceFloatPair<K> second(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ReferenceFloatPair<K> second(final Float l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ReferenceFloatPair<K> value(final float r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ReferenceFloatPair<K> value(final Float l) {
	 ...
	 */
	public static <K> ReferenceFloatPair<K> of(final K left, final float right) {
