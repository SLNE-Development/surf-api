	...
	*/
	...
	public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() {
			final Comparator<? super Float2ReferenceMap.Entry<V>> comparator = (Float2ReferenceAVLTreeMap.this.actualComparator == null ? (Comparator<Float2ReferenceMap.Entry<V>>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2ReferenceMap.Entry<V>>)(x, y) -> Float2ReferenceAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2ReferenceAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
