...
public final class Float2ByteMaps {
	...
	public static class EmptyMap extends Float2ByteFunctions.EmptyFunction implements Float2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super Byte> consumer) {
		}
	...
	public static class Singleton extends Float2ByteFunctions.Singleton implements Float2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2ByteFunctions.SynchronizedFunction implements Float2ByteMap, java.io.Serializable {
		...
		public ObjectSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.float2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Float, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Byte> mappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Float key, final java.util.function.Function<? super Float, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Float2ByteFunctions.UnmodifiableFunction implements Float2ByteMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2ByteEntrySet());
			return entries;
		}
