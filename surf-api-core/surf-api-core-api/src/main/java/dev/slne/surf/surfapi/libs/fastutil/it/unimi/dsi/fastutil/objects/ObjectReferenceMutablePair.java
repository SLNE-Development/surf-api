 ...
 */
public class ObjectReferenceMutablePair<K, V> implements ObjectReferencePair<K, V>, java.io.Serializable {
	 ...
	 */
	public ObjectReferenceMutablePair(final K left, final V right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K, V> ObjectReferenceMutablePair<K, V> of(final K left, final V right) {
	...
	@Override
	public ObjectReferenceMutablePair<K, V> left(final K l) {
		left = l;
		return this;
	}
	...
	@Override
	public ObjectReferenceMutablePair<K, V> right(final V r) {
		right = r;
		return this;
	}
