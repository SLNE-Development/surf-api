...
public final class Object2FloatMaps {
	...
	public static class Singleton<K> extends Object2FloatFunctions.Singleton<K> implements Object2FloatMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2FloatMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2FloatFunctions.SynchronizedFunction<K> implements Object2FloatMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public float computeIfAbsent(final K key, final Object2FloatFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2FloatFunctions.UnmodifiableFunction<K> implements Object2FloatMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2FloatMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2FloatEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public float getOrDefault(final Object key, final float defaultValue) {
			return ((Object2FloatMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Object2FloatMap<K> unmodifiable(final Object2FloatMap<? extends K> m) {
