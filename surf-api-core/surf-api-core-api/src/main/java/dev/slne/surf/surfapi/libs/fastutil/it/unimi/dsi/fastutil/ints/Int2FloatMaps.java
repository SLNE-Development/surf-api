...
public final class Int2FloatMaps {
	...
	public static class EmptyMap extends Int2FloatFunctions.EmptyFunction implements Int2FloatMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Float> consumer) {
		}
	...
	public static class Singleton extends Int2FloatFunctions.Singleton implements Int2FloatMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractInt2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2FloatFunctions.SynchronizedFunction implements Int2FloatMap, java.io.Serializable {
		...
		public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.int2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Float> mappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Float computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Float compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Float merge(final Integer key, final Float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Int2FloatFunctions.UnmodifiableFunction implements Int2FloatMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.int2FloatEntrySet());
			return entries;
		}
