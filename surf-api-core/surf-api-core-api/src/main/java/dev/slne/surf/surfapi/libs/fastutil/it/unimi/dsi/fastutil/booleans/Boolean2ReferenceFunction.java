/*
	...
	*/
package dev.slne.surf.surfapi.libs.fastutil.it.unimi.dsi.fastutil.booleans;
...
public interface Boolean2ReferenceFunction<V> extends Function<Boolean, V> {
	 ...
	 */
	default V put(final boolean key, final V value) {
	 ...
	 * @since 8.5.0
	 */
	default V getOrDefault(final boolean key, final V defaultValue) {
		final V v;
	 ...
	 */
	default V remove(final boolean key) {
		throw new UnsupportedOperationException();
	}
	...
	default it.unimi.dsi.fastutil.booleans.Boolean2ByteFunction andThenByte(it.unimi.dsi.fastutil.objects.Reference2ByteFunction<V> after) {
		return k -> after.getByte(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<V> composeByte(it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2ShortFunction andThenShort(it.unimi.dsi.fastutil.objects.Reference2ShortFunction<V> after) {
		return k -> after.getShort(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<V> composeShort(it.unimi.dsi.fastutil.shorts.Short2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2IntFunction andThenInt(it.unimi.dsi.fastutil.objects.Reference2IntFunction<V> after) {
		return k -> after.getInt(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<V> composeInt(it.unimi.dsi.fastutil.ints.Int2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2LongFunction andThenLong(it.unimi.dsi.fastutil.objects.Reference2LongFunction<V> after) {
		return k -> after.getLong(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<V> composeLong(it.unimi.dsi.fastutil.longs.Long2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2CharFunction andThenChar(it.unimi.dsi.fastutil.objects.Reference2CharFunction<V> after) {
		return k -> after.getChar(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<V> composeChar(it.unimi.dsi.fastutil.chars.Char2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2FloatFunction andThenFloat(it.unimi.dsi.fastutil.objects.Reference2FloatFunction<V> after) {
		return k -> after.getFloat(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<V> composeFloat(it.unimi.dsi.fastutil.floats.Float2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.booleans.Boolean2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<V> after) {
		return k -> after.getDouble(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<V> composeDouble(it.unimi.dsi.fastutil.doubles.Double2BooleanFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.booleans.Boolean2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<? super V, ? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<T, V> composeObject(it.unimi.dsi.fastutil.objects.Object2BooleanFunction<? super T> before) {
		return k -> get(before.getBoolean(k));
	}

	default <T> it.unimi.dsi.fastutil.booleans.Boolean2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<? super V, ? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<T, V> composeReference(it.unimi.dsi.fastutil.objects.Reference2BooleanFunction<? super T> before) {
		return k -> get(before.getBoolean(k));
	}
}
