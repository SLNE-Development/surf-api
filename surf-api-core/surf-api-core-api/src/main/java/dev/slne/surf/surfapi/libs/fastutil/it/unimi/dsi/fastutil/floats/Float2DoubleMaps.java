...
public final class Float2DoubleMaps {
	...
	public static class Singleton extends Float2DoubleFunctions.Singleton implements Float2DoubleMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2DoubleMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2DoubleFunctions.SynchronizedFunction implements Float2DoubleMap, java.io.Serializable {
		...
		public ObjectSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.float2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Float, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Double> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Float2DoubleFunctions.UnmodifiableFunction implements Float2DoubleMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2DoubleEntrySet());
			return entries;
		}
