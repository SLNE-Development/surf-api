...
public abstract class AbstractFloat2IntMap extends AbstractFloat2IntFunction implements Float2IntMap, java.io.Serializable {
	 ...
	 */
	@Override
	public final int mergeInt(final float key, final int value, final it.unimi.dsi.fastutil.ints.IntBinaryOperator remappingFunction) {
	...
	public FloatSet keySet() {
		return new AbstractFloatSet() {
			...
			public FloatSpliterator spliterator() {
				return FloatSpliterators.asSpliterator(iterator(), sizeOf(AbstractFloat2IntMap.this), FloatSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public IntCollection values() {
		return new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), sizeOf(AbstractFloat2IntMap.this), IntSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
