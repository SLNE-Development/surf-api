...
public final class Short2ShortFunctions {
	...
	public static Short2ShortFunction primitive(final java.util.function.Function<? super Short, ? extends Short> f) {
		...
		if (f instanceof java.util.function.IntUnaryOperator) return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.IntUnaryOperator)f).applyAsInt(key));
