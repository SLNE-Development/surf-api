	...
	*/
	...
	public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
			final Comparator<? super Int2BooleanMap.Entry> comparator = (Int2BooleanAVLTreeMap.this.actualComparator == null ? (Comparator<Int2BooleanMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2BooleanMap.Entry>)(x, y) -> Int2BooleanAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2BooleanAVLTreeMap.this.compare(k, from) >= 0) && (top || Int2BooleanAVLTreeMap.this.compare(k, to) < 0);
		}
