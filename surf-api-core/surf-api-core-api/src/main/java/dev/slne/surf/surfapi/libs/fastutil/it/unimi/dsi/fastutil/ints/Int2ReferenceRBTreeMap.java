...
public class Int2ReferenceRBTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() {
			final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = (Int2ReferenceRBTreeMap.this.actualComparator == null ? (Comparator<Int2ReferenceMap.Entry<V>>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2ReferenceMap.Entry<V>>)(x, y) -> Int2ReferenceRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ReferenceRBTreeMap.this.compare(k, from) >= 0) && (top || Int2ReferenceRBTreeMap.this.compare(k, to) < 0);
		}
