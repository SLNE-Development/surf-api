...
public final class Short2ReferenceFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractShort2ReferenceFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Short2ReferenceFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final short k, final V defaultValue) {
			return ((Short2ReferenceFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Short2ReferenceFunction<V> unmodifiable(final Short2ReferenceFunction<? extends V> f) {
