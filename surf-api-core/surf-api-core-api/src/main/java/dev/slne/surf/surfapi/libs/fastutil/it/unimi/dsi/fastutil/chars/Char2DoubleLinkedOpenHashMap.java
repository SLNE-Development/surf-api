...
public class Char2DoubleLinkedOpenHashMap extends AbstractChar2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2DoubleMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Char2DoubleMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractCharSortedSet {
		...
		public CharSpliterator spliterator() {
			return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public DoubleCollection values() {
		if (values == null) values = new AbstractDoubleCollection() {
			...
			public DoubleSpliterator spliterator() {
				return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
