...
public interface Reference2ObjectMap<K, V> extends Reference2ObjectFunction<K, V>, Map<K, V> {
	...
	default void forEach(final java.util.function.BiConsumer<? super K, ? super V> consumer) {
		final ObjectSet<Reference2ObjectMap.Entry<K, V>> entrySet = reference2ObjectEntrySet();
		final Consumer<Reference2ObjectMap.Entry<K, V>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), (entry.getValue()));
	 ...
	 * @since 8.0.0
	 */
	default V computeIfAbsent(final K key, final Reference2ObjectFunction<? super K, ? extends V> mappingFunction) {
	 ...
	 */
	@Deprecated
	default V computeObjectIfAbsentPartial(final K key, final Reference2ObjectFunction<? super K, ? extends V> mappingFunction) {
