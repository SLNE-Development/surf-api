...
public final class Object2FloatFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2FloatFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Object2FloatFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public float getOrDefault(final Object k, final float defaultValue) {
			return ((Object2FloatFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Object2FloatFunction<K> unmodifiable(final Object2FloatFunction<? extends K> f) {
