	...
	*/
	...
	public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() {
			final Comparator<? super Float2IntMap.Entry> comparator = (Float2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Float2IntMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2IntMap.Entry>)(x, y) -> Float2IntAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2IntAVLTreeMap.this.compare(k, from) >= 0) && (top || Float2IntAVLTreeMap.this.compare(k, to) < 0);
		}
