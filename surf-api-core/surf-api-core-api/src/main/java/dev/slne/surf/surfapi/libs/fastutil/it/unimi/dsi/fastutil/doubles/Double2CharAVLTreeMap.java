	...
	*/
	...
	public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2CharMap.Entry>() {
			final Comparator<? super Double2CharMap.Entry> comparator = (Double2CharAVLTreeMap.this.actualComparator == null ? (Comparator<Double2CharMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2CharMap.Entry>)(x, y) -> Double2CharAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2CharAVLTreeMap.this.compare(k, from) >= 0) && (top || Double2CharAVLTreeMap.this.compare(k, to) < 0);
		}
