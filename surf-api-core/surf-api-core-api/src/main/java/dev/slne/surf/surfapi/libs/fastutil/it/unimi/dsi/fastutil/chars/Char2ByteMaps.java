...
public final class Char2ByteMaps {
	...
	public static class EmptyMap extends Char2ByteFunctions.EmptyFunction implements Char2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Byte> consumer) {
		}
	...
	public static class Singleton extends Char2ByteFunctions.Singleton implements Char2ByteMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractChar2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2ByteFunctions.SynchronizedFunction implements Char2ByteMap, java.io.Serializable {
		...
		public ObjectSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.char2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final char key, final java.util.function.IntFunction<? extends Byte> mappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Byte computeIfPresent(final Character key, final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Byte compute(final Character key, final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Byte merge(final Character key, final Byte value, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Char2ByteFunctions.UnmodifiableFunction implements Char2ByteMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.char2ByteEntrySet());
			return entries;
		}
