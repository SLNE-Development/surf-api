...
public final class Short2ByteSortedMaps {
	...
	public static class Singleton extends Short2ByteMaps.Singleton implements Short2ByteSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2ByteMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Short2ByteMaps.SynchronizedMap implements Short2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2ByteEntrySet(), sync);
			return (ObjectSortedSet<Short2ByteMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2ByteMaps.UnmodifiableMap implements Short2ByteSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2ByteEntrySet());
			return (ObjectSortedSet<Short2ByteMap.Entry>)entries;
		}
