 ...
 */
public interface LongBooleanPair extends it.unimi.dsi.fastutil.Pair<Long, Boolean> {
	/**
	 ...
	 */
	public default LongBooleanPair left(final long l) {
	 ...
	 */
	public default LongBooleanPair first(final long l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default LongBooleanPair key(final long l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default LongBooleanPair key(Long l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default LongBooleanPair right(final boolean r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default LongBooleanPair right(final Boolean l) {
	 ...
	 */
	public default LongBooleanPair second(final boolean r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default LongBooleanPair second(final Boolean l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default LongBooleanPair value(final boolean r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default LongBooleanPair value(final Boolean l) {
	 ...
	 */
	public static LongBooleanPair of(final long left, final boolean right) {
	...
	public static java.util.Comparator<LongBooleanPair> lexComparator() {
		return (x, y) -> {
