...
public abstract class AbstractByte2LongMap extends AbstractByte2LongFunction implements Byte2LongMap, java.io.Serializable {
	 ...
	 */
	@Override
	public final long mergeLong(final byte key, final long value, final it.unimi.dsi.fastutil.longs.LongBinaryOperator remappingFunction) {
	...
	public ByteSet keySet() {
		return new AbstractByteSet() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), sizeOf(AbstractByte2LongMap.this), ByteSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public LongCollection values() {
		return new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), sizeOf(AbstractByte2LongMap.this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
