...
public final class Reference2ReferenceMaps {
	...
	public static class Singleton<K, V> extends Reference2ReferenceFunctions.Singleton<K, V> implements Reference2ReferenceMap<K, V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractReference2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K, V> extends Reference2ReferenceFunctions.SynchronizedFunction<K, V> implements Reference2ReferenceMap<K, V>, java.io.Serializable {
		...
		public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.reference2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K, V> extends Reference2ReferenceFunctions.UnmodifiableFunction<K, V> implements Reference2ReferenceMap<K, V>, java.io.Serializable {
		...
		@Override
		public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2ReferenceEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final Object key, final V defaultValue) {
			return ((Reference2ReferenceMap<K, V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K, V> Reference2ReferenceMap<K, V> unmodifiable(final Reference2ReferenceMap<? extends K, ? extends V> m) {
