/*
	...
	*/
package dev.slne.surf.surfapi.libs.fastutil.it.unimi.dsi.fastutil.objects;
...
public interface Reference2BooleanFunction<K> extends Function<K, Boolean>, java.util.function.Predicate<K> {
	...
	default it.unimi.dsi.fastutil.objects.Reference2ByteFunction<K> andThenByte(it.unimi.dsi.fastutil.booleans.Boolean2ByteFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2BooleanFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2ShortFunction<K> andThenShort(it.unimi.dsi.fastutil.booleans.Boolean2ShortFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2BooleanFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2IntFunction<K> andThenInt(it.unimi.dsi.fastutil.booleans.Boolean2IntFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2BooleanFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2LongFunction<K> andThenLong(it.unimi.dsi.fastutil.booleans.Boolean2LongFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2BooleanFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2CharFunction<K> andThenChar(it.unimi.dsi.fastutil.booleans.Boolean2CharFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2BooleanFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2FloatFunction<K> andThenFloat(it.unimi.dsi.fastutil.booleans.Boolean2FloatFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2BooleanFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<K> andThenDouble(it.unimi.dsi.fastutil.booleans.Boolean2DoubleFunction after) {
		return k -> after.get(getBoolean(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2BooleanFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<K> before) {
		return k -> getBoolean(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<K, T> andThenObject(it.unimi.dsi.fastutil.booleans.Boolean2ObjectFunction<? extends T> after) {
		return k -> after.get(getBoolean(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2BooleanFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<? super T, ? extends K> before) {
		return k -> getBoolean(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<K, T> andThenReference(it.unimi.dsi.fastutil.booleans.Boolean2ReferenceFunction<? extends T> after) {
		return k -> after.get(getBoolean(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2BooleanFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<? super T, ? extends K> before) {
		return k -> getBoolean(before.get(k));
	}
}
