/*
	...
	*/
package dev.slne.surf.surfapi.libs.fastutil.it.unimi.dsi.fastutil.doubles;
...
public interface Double2ObjectFunction<V> extends Function<Double, V>, java.util.function.DoubleFunction<V> {
	...
	default it.unimi.dsi.fastutil.doubles.Double2ByteFunction andThenByte(it.unimi.dsi.fastutil.objects.Object2ByteFunction<V> after) {
		return k -> after.getByte(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction<V> composeByte(it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ShortFunction andThenShort(it.unimi.dsi.fastutil.objects.Object2ShortFunction<V> after) {
		return k -> after.getShort(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<V> composeShort(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2IntFunction andThenInt(it.unimi.dsi.fastutil.objects.Object2IntFunction<V> after) {
		return k -> after.getInt(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2ObjectFunction<V> composeInt(it.unimi.dsi.fastutil.ints.Int2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2LongFunction andThenLong(it.unimi.dsi.fastutil.objects.Object2LongFunction<V> after) {
		return k -> after.getLong(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ObjectFunction<V> composeLong(it.unimi.dsi.fastutil.longs.Long2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction andThenChar(it.unimi.dsi.fastutil.objects.Object2CharFunction<V> after) {
		return k -> after.getChar(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2ObjectFunction<V> composeChar(it.unimi.dsi.fastutil.chars.Char2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction andThenFloat(it.unimi.dsi.fastutil.objects.Object2FloatFunction<V> after) {
		return k -> after.getFloat(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2ObjectFunction<V> composeFloat(it.unimi.dsi.fastutil.floats.Float2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<V> after) {
		return k -> after.getDouble(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<V> composeDouble(it.unimi.dsi.fastutil.doubles.Double2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.objects.Object2ObjectFunction<? super V, ? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ObjectFunction<T, V> composeObject(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<? super V, ? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<T, V> composeReference(it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}
}
