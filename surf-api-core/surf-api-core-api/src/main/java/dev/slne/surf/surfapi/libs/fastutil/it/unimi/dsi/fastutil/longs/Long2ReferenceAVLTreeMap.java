	...
	*/
	...
	public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() {
			final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = (Long2ReferenceAVLTreeMap.this.actualComparator == null ? (Comparator<Long2ReferenceMap.Entry<V>>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2ReferenceMap.Entry<V>>)(x, y) -> Long2ReferenceAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ReferenceAVLTreeMap.this.compare(k, from) >= 0) && (top || Long2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
