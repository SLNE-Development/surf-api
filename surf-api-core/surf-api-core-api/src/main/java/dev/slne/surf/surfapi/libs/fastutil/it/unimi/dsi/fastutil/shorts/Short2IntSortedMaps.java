...
public final class Short2IntSortedMaps {
	...
	public static class Singleton extends Short2IntMaps.Singleton implements Short2IntSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2IntMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Short2IntMaps.SynchronizedMap implements Short2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2IntEntrySet(), sync);
			return (ObjectSortedSet<Short2IntMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2IntMaps.UnmodifiableMap implements Short2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2IntEntrySet());
			return (ObjectSortedSet<Short2IntMap.Entry>)entries;
		}
