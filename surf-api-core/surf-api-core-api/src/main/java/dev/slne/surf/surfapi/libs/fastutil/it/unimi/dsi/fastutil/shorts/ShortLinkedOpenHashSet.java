...
public class ShortLinkedOpenHashSet extends AbstractShortSortedSet implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public static ShortLinkedOpenHashSet of(final short e) {
		ShortLinkedOpenHashSet result = new ShortLinkedOpenHashSet(1, DEFAULT_LOAD_FACTOR);
		result.add(e);
		return result;
	}
	 ...
	 */
	public static ShortLinkedOpenHashSet of(final short e0, final short e1) {
		ShortLinkedOpenHashSet result = new ShortLinkedOpenHashSet(2, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
	 ...
	 * @throws IllegalArgumentException if there were duplicate entries.
	 */
	public static ShortLinkedOpenHashSet of(final short e0, final short e1, final short e2) {
		ShortLinkedOpenHashSet result = new ShortLinkedOpenHashSet(3, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
			throw new IllegalArgumentException("Duplicate element: " + e1);
		}
	...
	public static ShortLinkedOpenHashSet of(final short... a) {
		ShortLinkedOpenHashSet result = new ShortLinkedOpenHashSet(a.length, DEFAULT_LOAD_FACTOR);
		for (short element : a) {
	...
	public ShortSpliterator spliterator() {
		return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(this), SPLITERATOR_CHARACTERISTICS);
	}
