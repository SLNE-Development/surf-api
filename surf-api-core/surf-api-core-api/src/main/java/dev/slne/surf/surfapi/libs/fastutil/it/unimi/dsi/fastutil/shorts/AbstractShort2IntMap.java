...
public abstract class AbstractShort2IntMap extends AbstractShort2IntFunction implements Short2IntMap, java.io.Serializable {
	 ...
	 */
	@Override
	public final int mergeInt(final short key, final int value, final it.unimi.dsi.fastutil.ints.IntBinaryOperator remappingFunction) {
	...
	public ShortSet keySet() {
		return new AbstractShortSet() {
			...
			public ShortSpliterator spliterator() {
				return ShortSpliterators.asSpliterator(iterator(), sizeOf(AbstractShort2IntMap.this), ShortSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public IntCollection values() {
		return new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), sizeOf(AbstractShort2IntMap.this), IntSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
