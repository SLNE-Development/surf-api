...
public class Int2ShortRBTreeMap extends AbstractInt2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>() {
			final Comparator<? super Int2ShortMap.Entry> comparator = (Int2ShortRBTreeMap.this.actualComparator == null ? (Comparator<Int2ShortMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2ShortMap.Entry>)(x, y) -> Int2ShortRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ShortRBTreeMap.this.compare(k, from) >= 0) && (top || Int2ShortRBTreeMap.this.compare(k, to) < 0);
		}
