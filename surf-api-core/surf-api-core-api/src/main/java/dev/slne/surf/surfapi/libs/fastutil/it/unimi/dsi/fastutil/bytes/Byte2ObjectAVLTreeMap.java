	...
	*/
	...
	public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>() {
			final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = (Byte2ObjectAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2ObjectMap.Entry<V>>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2ObjectMap.Entry<V>>)(x, y) -> Byte2ObjectAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2ObjectAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
