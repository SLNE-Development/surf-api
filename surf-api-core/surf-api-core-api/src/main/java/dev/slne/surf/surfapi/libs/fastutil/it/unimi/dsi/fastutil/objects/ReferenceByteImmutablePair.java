 ...
 */
public class ReferenceByteImmutablePair<K> implements ReferenceBytePair<K>, java.io.Serializable {
	 ...
	 */
	public ReferenceByteImmutablePair(final K left, final byte right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ReferenceByteImmutablePair<K> of(final K left, final byte right) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof ReferenceBytePair) {
			return left == ((ReferenceBytePair)other).left() && right == ((ReferenceBytePair)other).rightByte();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return left == ((it.unimi.dsi.fastutil.Pair)other).left() && java.util.Objects.equals(Byte.valueOf(right), ((it.unimi.dsi.fastutil.Pair)other).right());
		}
		return false;
	}
