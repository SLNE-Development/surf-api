	...
	*/
	...
	public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() {
			final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator = (Byte2ReferenceAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2ReferenceMap.Entry<V>>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2ReferenceMap.Entry<V>>)(x, y) -> Byte2ReferenceAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2ReferenceAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
