...
public interface PacketAbstractMinecart<Impl extends PacketAbstractMinecart<Impl>> extends PacketEntity<Impl>, SpawnVelocity {
     ...
     * This function will return air if the minecart has no display block.
     *
