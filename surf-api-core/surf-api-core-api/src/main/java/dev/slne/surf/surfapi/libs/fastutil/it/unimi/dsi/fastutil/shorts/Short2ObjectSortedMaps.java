...
public final class Short2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Short2ObjectMaps.Singleton<V> implements Short2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Short2ObjectMaps.SynchronizedMap<V> implements Short2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Short2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Short2ObjectMaps.UnmodifiableMap<V> implements Short2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Short2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2ObjectEntrySet());
			return (ObjectSortedSet<Short2ObjectMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Short2ObjectSortedMap<V> unmodifiable(final Short2ObjectSortedMap<? extends V> m) {
