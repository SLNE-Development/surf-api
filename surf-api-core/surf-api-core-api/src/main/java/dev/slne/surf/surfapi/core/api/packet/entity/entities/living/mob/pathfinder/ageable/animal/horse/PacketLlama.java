 ...
 */
@CanBeSpawned
public interface PacketLlama<Impl extends PacketLlama<Impl>> extends PacketChestedHorse<Impl>,
    Spawnable {
  ...
  /**
   * Gets the llama's strength. A higher strength llama will have more inventory slots and be more
   * threatening to entities.
   *
  ...
  /**
   * Sets the llama's strength. A higher strength llama will have more inventory slots and be more
   * threatening to entities. Inventory slots are equal to strength * 3.
   *
