...
public final class Short2ObjectMaps {
	...
	public static class Singleton<V> extends Short2ObjectFunctions.Singleton<V> implements Short2ObjectMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Short2ObjectFunctions.SynchronizedFunction<V> implements Short2ObjectMap<V>, java.io.Serializable {
		...
		public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Short2ObjectFunctions.UnmodifiableFunction<V> implements Short2ObjectMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Short2ObjectMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final short key, final V defaultValue) {
			return ((Short2ObjectMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Short2ObjectMap<V> unmodifiable(final Short2ObjectMap<? extends V> m) {
