...
public class Char2LongLinkedOpenHashMap extends AbstractChar2LongSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2LongMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Char2LongMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractCharSortedSet {
		...
		public CharSpliterator spliterator() {
			return CharSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public LongCollection values() {
		if (values == null) values = new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Char2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
