...
public final class Char2ObjectFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractChar2ObjectFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Char2ObjectFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final char k, final V defaultValue) {
			return ((Char2ObjectFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Char2ObjectFunction<V> unmodifiable(final Char2ObjectFunction<? extends V> f) {
