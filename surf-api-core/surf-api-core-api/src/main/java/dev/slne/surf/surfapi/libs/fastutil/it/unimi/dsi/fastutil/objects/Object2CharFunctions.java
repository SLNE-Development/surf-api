...
public final class Object2CharFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2CharFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Object2CharFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public char getOrDefault(final Object k, final char defaultValue) {
			return ((Object2CharFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Object2CharFunction<K> unmodifiable(final Object2CharFunction<? extends K> f) {
