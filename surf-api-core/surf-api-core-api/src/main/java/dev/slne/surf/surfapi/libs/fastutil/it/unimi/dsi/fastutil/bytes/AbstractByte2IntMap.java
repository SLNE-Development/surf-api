	...
	public ByteSet keySet() {
		return new AbstractByteSet() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), sizeOf(AbstractByte2IntMap.this), ByteSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public IntCollection values() {
		return new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), sizeOf(AbstractByte2IntMap.this), IntSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
