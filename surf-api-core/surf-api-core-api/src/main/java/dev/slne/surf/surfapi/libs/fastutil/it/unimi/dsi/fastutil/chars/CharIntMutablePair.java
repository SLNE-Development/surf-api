...
public class CharIntMutablePair implements CharIntPair, java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof CharIntPair) {
			return left == ((CharIntPair)other).leftChar() && right == ((CharIntPair)other).rightInt();
		}
		if (other instanceof it.unimi.dsi.fastutil.Pair) {
			return java.util.Objects.equals(Character.valueOf(left), ((it.unimi.dsi.fastutil.Pair)other).left()) && java.util.Objects.equals(Integer.valueOf(right), ((it.unimi.dsi.fastutil.Pair)other).right());
		}
		return false;
	}
