...
public class Float2IntRBTreeMap extends AbstractFloat2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() {
			final Comparator<? super Float2IntMap.Entry> comparator = (Float2IntRBTreeMap.this.actualComparator == null ? (Comparator<Float2IntMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2IntMap.Entry>)(x, y) -> Float2IntRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2IntRBTreeMap.this.compare(k, from) >= 0) && (top || Float2IntRBTreeMap.this.compare(k, to) < 0);
		}
