 ...
 */
public interface DoubleReferencePair<V> extends it.unimi.dsi.fastutil.Pair<Double, V> {
	/**
	 ...
	 */
	public default DoubleReferencePair<V> left(final double l) {
	 ...
	 */
	public default DoubleReferencePair<V> first(final double l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default DoubleReferencePair<V> key(final double l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default DoubleReferencePair<V> key(Double l) {
	 ...
	 */
	public static <V> DoubleReferencePair<V> of(final double left, final V right) {
