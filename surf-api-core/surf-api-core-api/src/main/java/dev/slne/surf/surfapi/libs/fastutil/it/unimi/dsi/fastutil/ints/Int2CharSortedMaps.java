...
public final class Int2CharSortedMaps {
	...
	public static class Singleton extends Int2CharMaps.Singleton implements Int2CharSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2CharMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2CharMaps.SynchronizedMap implements Int2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2CharEntrySet(), sync);
			return (ObjectSortedSet<Int2CharMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2CharMaps.UnmodifiableMap implements Int2CharSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2CharEntrySet());
			return (ObjectSortedSet<Int2CharMap.Entry>)entries;
		}
