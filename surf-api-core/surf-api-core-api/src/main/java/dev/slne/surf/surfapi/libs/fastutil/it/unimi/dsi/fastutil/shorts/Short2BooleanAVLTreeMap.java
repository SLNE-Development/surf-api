	...
	*/
	...
	public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
			final Comparator<? super Short2BooleanMap.Entry> comparator = (Short2BooleanAVLTreeMap.this.actualComparator == null ? (Comparator<Short2BooleanMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2BooleanMap.Entry>)(x, y) -> Short2BooleanAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
			...
			public boolean contains(final Object o) {
				...
				if (!(e.getKey() instanceof Short)) return false;
			...
			public boolean remove(final Object o) {
				...
				if (!(e.getValue() instanceof Boolean)) return false;
				final Entry f = findKey(((Short)(e.getKey())).shortValue());
	...
	private final class Submap extends AbstractShort2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2BooleanAVLTreeMap.this.compare(k, from) >= 0) && (top || Short2BooleanAVLTreeMap.this.compare(k, to) < 0);
		}
