 ...
 */
public class FloatIntImmutablePair implements FloatIntPair, java.io.Serializable {
	 ...
	 */
	public FloatIntImmutablePair(final float left, final int right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static FloatIntImmutablePair of(final float left, final int right) {
