...
public class Short2ReferenceLinkedOpenHashMap<V> extends AbstractShort2ReferenceSortedMap<V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>> implements FastSortedEntrySet<V> {
		...
		public ObjectSpliterator<Short2ReferenceMap.Entry<V>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractShortSortedSet {
		...
		public ShortSpliterator spliterator() {
			return ShortSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Short2ReferenceLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
