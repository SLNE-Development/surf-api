	...
	*/
	...
	public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() {
			final Comparator<? super Short2IntMap.Entry> comparator = (Short2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Short2IntMap.Entry>)(x, y) -> (Short.compare((x.getShortKey()), (y.getShortKey()))) : (Comparator<Short2IntMap.Entry>)(x, y) -> Short2IntAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey()));
	...
	private final class Submap extends AbstractShort2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final short k) {
			return (bottom || Short2IntAVLTreeMap.this.compare(k, from) >= 0) && (top || Short2IntAVLTreeMap.this.compare(k, to) < 0);
		}
