	...
	*/
	...
	public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>() {
			final Comparator<? super Int2ShortMap.Entry> comparator = (Int2ShortAVLTreeMap.this.actualComparator == null ? (Comparator<Int2ShortMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2ShortMap.Entry>)(x, y) -> Int2ShortAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ShortAVLTreeMap.this.compare(k, from) >= 0) && (top || Int2ShortAVLTreeMap.this.compare(k, to) < 0);
		}
