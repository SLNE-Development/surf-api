...
public class Float2CharRBTreeMap extends AbstractFloat2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Float2CharMap.Entry>() {
			final Comparator<? super Float2CharMap.Entry> comparator = (Float2CharRBTreeMap.this.actualComparator == null ? (Comparator<Float2CharMap.Entry>)(x, y) -> (Float.compare((x.getFloatKey()), (y.getFloatKey()))) : (Comparator<Float2CharMap.Entry>)(x, y) -> Float2CharRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey()));
	...
	private final class Submap extends AbstractFloat2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2CharRBTreeMap.this.compare(k, from) >= 0) && (top || Float2CharRBTreeMap.this.compare(k, to) < 0);
		}
