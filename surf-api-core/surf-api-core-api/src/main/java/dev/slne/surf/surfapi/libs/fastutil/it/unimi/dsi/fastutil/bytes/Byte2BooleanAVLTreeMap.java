	...
	*/
	...
	public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>() {
			final Comparator<? super Byte2BooleanMap.Entry> comparator = (Byte2BooleanAVLTreeMap.this.actualComparator == null ? (Comparator<Byte2BooleanMap.Entry>)(x, y) -> (Byte.compare((x.getByteKey()), (y.getByteKey()))) : (Comparator<Byte2BooleanMap.Entry>)(x, y) -> Byte2BooleanAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey()));
	...
	private final class Submap extends AbstractByte2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2BooleanAVLTreeMap.this.compare(k, from) >= 0) && (top || Byte2BooleanAVLTreeMap.this.compare(k, to) < 0);
		}
