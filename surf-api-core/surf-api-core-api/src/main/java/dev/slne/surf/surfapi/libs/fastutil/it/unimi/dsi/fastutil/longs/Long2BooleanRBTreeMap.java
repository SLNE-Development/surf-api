...
public class Long2BooleanRBTreeMap extends AbstractLong2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>() {
			final Comparator<? super Long2BooleanMap.Entry> comparator = (Long2BooleanRBTreeMap.this.actualComparator == null ? (Comparator<Long2BooleanMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2BooleanMap.Entry>)(x, y) -> Long2BooleanRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2BooleanRBTreeMap.this.compare(k, from) >= 0) && (top || Long2BooleanRBTreeMap.this.compare(k, to) < 0);
		}
