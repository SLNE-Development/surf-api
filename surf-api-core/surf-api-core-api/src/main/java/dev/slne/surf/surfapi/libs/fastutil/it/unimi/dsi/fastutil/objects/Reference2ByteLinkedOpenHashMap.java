...
public class Reference2ByteLinkedOpenHashMap<K> extends AbstractReference2ByteSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ByteMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Reference2ByteMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public ByteCollection values() {
		if (values == null) values = new AbstractByteCollection() {
			...
			public ByteSpliterator spliterator() {
				return ByteSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Reference2ByteLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
