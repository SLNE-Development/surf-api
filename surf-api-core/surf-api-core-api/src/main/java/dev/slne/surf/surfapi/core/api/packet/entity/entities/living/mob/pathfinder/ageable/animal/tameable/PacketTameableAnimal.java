...
public interface PacketTameableAnimal<Impl extends PacketTameableAnimal<Impl>> extends PacketAnimal<Impl> {
    ...
    /**
     * Sets if this has been tamed. Not necessary if the method {@link #ownerUuid(UUID)} has
