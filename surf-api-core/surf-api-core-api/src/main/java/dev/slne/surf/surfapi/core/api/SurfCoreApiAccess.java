...
/**
 * The SurfCoreApiAccess class provides a static access point to the SurfCoreApi instance. It allows
 * setting and retrieving the SurfCoreApi instance.
 */
...
public class SurfCoreApiAccess {
  ...
  /**
   * This variable holds the instance of the SurfCoreApi. It is a private static variable with a
   * single instance that can be accessed through the SurfCoreApiAccess class.
   */
