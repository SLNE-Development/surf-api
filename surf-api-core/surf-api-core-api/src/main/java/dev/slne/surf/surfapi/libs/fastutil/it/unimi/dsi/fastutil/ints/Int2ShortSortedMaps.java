...
public final class Int2ShortSortedMaps {
	...
	public static class Singleton extends Int2ShortMaps.Singleton implements Int2ShortSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2ShortMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2ShortMaps.SynchronizedMap implements Int2ShortSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2ShortEntrySet(), sync);
			return (ObjectSortedSet<Int2ShortMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2ShortMaps.UnmodifiableMap implements Int2ShortSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2ShortEntrySet());
			return (ObjectSortedSet<Int2ShortMap.Entry>)entries;
		}
