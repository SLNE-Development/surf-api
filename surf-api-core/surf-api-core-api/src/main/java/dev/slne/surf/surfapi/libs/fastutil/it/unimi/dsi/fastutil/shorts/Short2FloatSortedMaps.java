...
public final class Short2FloatSortedMaps {
	...
	public static class Singleton extends Short2FloatMaps.Singleton implements Short2FloatSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2FloatMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Short2FloatMaps.SynchronizedMap implements Short2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2FloatEntrySet(), sync);
			return (ObjectSortedSet<Short2FloatMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2FloatMaps.UnmodifiableMap implements Short2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2FloatEntrySet());
			return (ObjectSortedSet<Short2FloatMap.Entry>)entries;
		}
