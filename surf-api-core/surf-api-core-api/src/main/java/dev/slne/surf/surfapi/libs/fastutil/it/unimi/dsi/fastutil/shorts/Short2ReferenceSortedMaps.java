...
public final class Short2ReferenceSortedMaps {
	...
	public static class Singleton<V> extends Short2ReferenceMaps.Singleton<V> implements Short2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2ReferenceMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Short2ReferenceMaps.SynchronizedMap<V> implements Short2ReferenceSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.short2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Short2ReferenceMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Short2ReferenceMaps.UnmodifiableMap<V> implements Short2ReferenceSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Short2ReferenceSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2ReferenceEntrySet());
			return (ObjectSortedSet<Short2ReferenceMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Short2ReferenceSortedMap<V> unmodifiable(final Short2ReferenceSortedMap<? extends V> m) {
