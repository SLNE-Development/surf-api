...
public final class Char2LongMaps {
	...
	public static class EmptyMap extends Char2LongFunctions.EmptyFunction implements Char2LongMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Long> consumer) {
		}
	...
	public static class Singleton extends Char2LongFunctions.Singleton implements Char2LongMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractChar2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2LongFunctions.SynchronizedFunction implements Char2LongMap, java.io.Serializable {
		...
		public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.char2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final char key, final java.util.function.IntFunction<? extends Long> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsent(final char key, final Char2LongFunction mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Long computeIfPresent(final Character key, final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Long compute(final Character key, final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Long merge(final Character key, final Long value, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Char2LongFunctions.UnmodifiableFunction implements Char2LongMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.char2LongEntrySet());
			return entries;
		}
