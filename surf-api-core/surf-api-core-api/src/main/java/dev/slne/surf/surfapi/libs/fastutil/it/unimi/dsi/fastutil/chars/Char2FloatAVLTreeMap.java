	...
	*/
	...
	public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
			final Comparator<? super Char2FloatMap.Entry> comparator = (Char2FloatAVLTreeMap.this.actualComparator == null ? (Comparator<Char2FloatMap.Entry>)(x, y) -> (Character.compare((x.getCharKey()), (y.getCharKey()))) : (Comparator<Char2FloatMap.Entry>)(x, y) -> Char2FloatAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey()));
			...
			public boolean contains(final Object o) {
				...
				if (!(e.getKey() instanceof Character)) return false;
	...
	private final class Submap extends AbstractChar2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final char k) {
			return (bottom || Char2FloatAVLTreeMap.this.compare(k, from) >= 0) && (top || Char2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
