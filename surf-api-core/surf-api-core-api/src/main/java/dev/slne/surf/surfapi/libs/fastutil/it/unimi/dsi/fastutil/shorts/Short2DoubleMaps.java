...
public final class Short2DoubleMaps {
	...
	public static class Singleton extends Short2DoubleFunctions.Singleton implements Short2DoubleMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractShort2DoubleMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2DoubleFunctions.SynchronizedFunction implements Short2DoubleMap, java.io.Serializable {
		...
		public ObjectSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.short2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Short, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Double> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Short2DoubleFunctions.UnmodifiableFunction implements Short2DoubleMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2DoubleEntrySet());
			return entries;
		}
