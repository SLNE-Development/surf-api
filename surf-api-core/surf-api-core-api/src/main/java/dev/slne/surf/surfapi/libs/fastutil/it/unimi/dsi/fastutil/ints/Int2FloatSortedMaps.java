...
public final class Int2FloatSortedMaps {
	...
	public static class Singleton extends Int2FloatMaps.Singleton implements Int2FloatSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2FloatMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2FloatMaps.SynchronizedMap implements Int2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2FloatEntrySet(), sync);
			return (ObjectSortedSet<Int2FloatMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2FloatMaps.UnmodifiableMap implements Int2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2FloatEntrySet());
			return (ObjectSortedSet<Int2FloatMap.Entry>)entries;
		}
