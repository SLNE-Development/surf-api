...
public final class Double2FloatSortedMaps {
	...
	public static class Singleton extends Double2FloatMaps.Singleton implements Double2FloatSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2FloatMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Double2FloatMaps.SynchronizedMap implements Double2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2FloatEntrySet(), sync);
			return (ObjectSortedSet<Double2FloatMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2FloatMaps.UnmodifiableMap implements Double2FloatSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2FloatEntrySet());
			return (ObjectSortedSet<Double2FloatMap.Entry>)entries;
		}
