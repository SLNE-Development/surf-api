...
public final class ReferenceLists {
	...
	public static class UnmodifiableList<K> extends ReferenceCollections.UnmodifiableCollection<K> implements ReferenceList<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final ReferenceList<? extends K> list; // Due to the large number of methods that are not in
															// COLLECTION, this is worth caching.

		protected UnmodifiableList(final ReferenceList<? extends K> l) {
			super(l);
			this.list = l;
		}
	...
	public static class UnmodifiableRandomAccessList<K> extends UnmodifiableList<K> implements RandomAccess, java.io.Serializable {
		...
		protected UnmodifiableRandomAccessList(final ReferenceList<? extends K> l) {
			super(l);
		}
	 ...
	 */
	public static <K> ReferenceList<K> unmodifiable(final ReferenceList<? extends K> l) {
