 ...
 * [org.apache.commons.math3.random.RandomGenerator] interface.
 *
 ...
 * - The only exception is [java.util.Random], which does support setSeed
 *
 ...
 */
class Jdk2ApacheRandomGenerator(private val jdk: java.util.random.RandomGenerator) : RandomGenerator {

    /**
     * Attempts to set the random seed using an integer value.
     *
     * **Note:** This is a no-op for most JDK RandomGenerator implementations.
     * Only [java.util.Random] supports runtime reseeding. For other generators,
     ...
     *
     * **Note:** This is a no-op for most JDK RandomGenerator implementations.
     * Only [java.util.Random] supports runtime reseeding, and it will convert
     ...
     *
     * **Note:** This is a no-op for most JDK RandomGenerator implementations.
     * Only [java.util.Random] supports runtime reseeding.
     *
...
fun java.util.random.RandomGenerator?.toApache(): RandomGenerator? = this?.let(::Jdk2ApacheRandomGenerator)
