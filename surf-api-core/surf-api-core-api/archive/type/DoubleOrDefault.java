...
public final class DoubleOrDefault {
  ...
  private static final class Serializer extends ScalarSerializer<DoubleOrDefault> {
    ...
    @Override
    public DoubleOrDefault deserialize(final Type type, final Object obj)
      ...
      throw new SerializationException(
          obj + "(" + type + ") is not a double or '" + DEFAULT_VALUE + "'");
    }

    @Override
    protected Object serialize(final DoubleOrDefault item,
